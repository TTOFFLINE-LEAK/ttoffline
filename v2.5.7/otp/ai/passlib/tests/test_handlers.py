...
from otp.ai.passlib.utils.compat import irange, PY3, u, get_method_function
from otp.ai.passlib.tests.utils import TestCase, HandlerCase, skipUnless, TEST_MODE, UserHandlerMixin, EncodingHandlerMixin
UPASS_WAV = u('\\u0399\\u03c9\\u03b1\\u03bd\\u03bd\\u03b7\\u03c2')
UPASS_USD = u('\\u20AC\\u00A5$')
UPASS_TABLE = u('t\\u00e1\\u0411\\u2113\\u0259')
PASS_TABLE_UTF8 = 't\xc3\xa1\xd0\x91\xe2\x84\x93\xc9\x99'
_omitted_backend_tests = [
 'django_bcrypt', 'django_bcrypt_sha256', 'django_argon2']
...
class bigcrypt_test(HandlerCase):
    ...
    known_unidentified_hashes = [
     'qiyh4XPJGsOZ2MEAyLkfWqef8.SVpL2fvwjkAnxn8/rgTkwvrif6bjYB5cd']
...
class fshp_test(HandlerCase):
    ...
    known_correct_hashes = [
     ...
     ('test', '{FSHP1|8|4096}MTIzNDU2NzjTdHcmoXwNc0ff9+ArUHoN0CvlbPZpxFi1C6RDM/MHSA=='),
     ('OrpheanBeholderScryDoubt', '{FSHP1|8|4096}GVSUFDAjdh0vBosn1GUhzGLHP7BmkbCZVH/3TQqGIjADXpc+6NCg3g=='),
     ('ExecuteOrder66', '{FSHP3|16|8192}0aY7rZQ+/PR+Rd5/I9ssRM7cjguyT8ibypNaSp/U1uziNO3BVlg5qPUng+zHUDQC3ao/JbzOnIBUtAeWHEy7a2vZeZ7jAwyJJa2EqOsq4Io='),
     (
      UPASS_TABLE, '{FSHP1|16|16384}9v6/l3Lu/d9by5nznpOScqQo8eKu/b/CKli3RCkgYg4nRTgZu5y659YV8cCZ68UL')]
    known_unidentified_hashes = [
...
class hex_sha512_test(HandlerCase):
    ...
    known_correct_hashes = [
     ...
     (
      UPASS_TABLE, 'd91bb0a23d66dca07a1781fd63ae6a05f6919ee5fc368049f350c9f293b078a18165d66097cf0d89fdfbeed1ad6e7dba2344e57348cd6d51308c843a06f29caf')]
...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    def test_90_raw(self):
        ...
        from otp.ai.passlib.utils.compat import str_to_bascii
        lmhash = self.handler
...
class mssql2005_test(HandlerCase):
    ...
    known_alternate_hashes = [
     ('0x01005b20054332752e1bc2e7c5df0f9ebfe486e9bee063e8d3b3', '12345', '0x01005B20054332752E1BC2E7C5DF0F9EBFE486E9BEE063E8D3B3')]
    known_unidentified_hashes = [
...
class nthash_test(HandlerCase):
    ...
    known_correct_hashes = [
     ...
     ('\xc3\xbc', '8bd6e4fb88e01009818749c5443ea712'),
     ('\xc3\xbc\xc3\xbc', 'cc1260adb6985ca749f150c7e0b22063'),
     ('\xe2\x82\xac', '030926b781938db4365d46adc7cfbcb8'),
     ('\xe2\x82\xac\xe2\x82\xac', '682467b963bb4e61943e170a04f7db46'),
...
class bsd_nthash_test(HandlerCase):
    ...
    known_correct_hashes = [
     ...
     ('\xc3\xbc', '$3$$8bd6e4fb88e01009818749c5443ea712')]
    known_unidentified_hashes = [
