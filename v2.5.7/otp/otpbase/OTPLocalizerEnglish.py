...
LeaveToPay = 'Your account has been locked due to a violation of the server rules.'
LeaveToPayYes = 'Ok'
...
CRNoConnect = 'Could not connect to %s:%s.'
CRSpace = '\n\n'
CRNoConnectTryAgainLocal = "Make sure you're running your Local Server before you connect! Try Again?"
...
CRNoDistrictsTryAgain = 'No District is available or the server is full. Try again?'
...
CRLoadingGameServices = 'Loading Game Services. Please wait...'
CRLoadingGameServicesTakingAWhile = "Loading Game Services. Remember: By default, 'start_server.bat' is ran automatically!"
CRLoadingGameServicesTakingTooLong = "Loading Game Services. Your game is taking too long to load. Please refer to 'HELP.txt' to diagnose the issue."
CRBootedReasons = {1: 'Yikes - An unexpected problem occured.  Your connection has been lost, but you should be able to connect again and go right back into Toontown.', 100: 'You have been disconnected because someone else just logged in using your account on another computer.', 
   ...
   122: 'There was an issue getting you into Toontown.  If the problem persists, please contact Toontown Offline staff on our Discord.', 
   124: 'Either your installed files are out of date, or the Mini-Server you are trying to join is out of date.  Use the launcher to download the newest version, or contact Toontown Offline staff on our Discord if the problem persists.', 
   ...
   152: 'You have been banned from this mini-server. If you have any questions please contact the mini-server host. \n\nReason for ban: \n%(name)s', 
...
SCMenuCog = 'COG SPEAK'
SCMenuChar = 'DISNEY SPEAK'
SCMenuTesting = 'COMMUNITY'
SCMenuBugs = 'BUGS'
SCMenuHello = 'HELLO'
SCMenuBye = 'GOODBYE'
...
SCMenuFourBossBattle = 'EXECUTIVE MEETING'
SCMenuFourBossBattleVP = 'V.P.'
SCMenuFourBossBattleCFO = 'C.F.O.'
SCMenuFourBossBattleCJ = 'C.J.'
SCMenuFourBossBattleCEO = 'C.E.O.'
SCMenuGolf = 'GOLF'
...
SuitBrushOffs = {'f': ["I'm late for a meeting."], 'p': [
   ...
   'ym': [
        'Yes Man says NO.'], 
   'mm': [
        "I can't manage you right now."], 
   'ds': [
        "I'm not down for that."], 
   'hh': [
        "I'm heading out of here."], 
   'cr': [
        "I've plundered around here enough already!"], 
   'tbc': [
         "Sorry, you're not cultured enough to face me yet."], 
   'bf': [
        'Kiss my bottom, Toon.'], 
   'b': [
       "It's not good for me to stay in the sun."], 
   'dt': [
        'I have to double check something with the boss.'], 
   'ac': [
        "I've got an ambulance to chase."], 
   'bs': [
        'Sorry if this seems like a stab in the back.'], 
   'sd': [
        'The doctor is out.'], 
   'le': [
        "I have to run, I've got a court case to settle."], 
   'bw': [
        'I need to fix my wig.'], 
   'sc': [
        "I'm short of work."], 
   'pp': [
        "Your time isn't worth one cent to me."], 
   'tw': [
        'Fighting you is too expensive right now.'], 
   'bc': [
        "According to my calculations, I don't have time to deal with you."], 
   'nc': [
        "I'm on my crunch break."], 
   'mb': [
        "Don't worry, I'm sure a Short Change will trickle down to you."], 
   'ls': [
        "Sorry, it's pay day."], 
   'rb': [
   ...
   'cc': [
        "I'm out of minutes."], 
   'tm': [
        "I'm out of shipments, please call back tomorrow."], 
   'nd': [
        "I need to catch up with 'The Big Cheese'."], 
   'gh': [
        'My hands need some cleaning.'], 
   'ms': [
        "I'm moving away, Toon."], 
   'tf': [
        "It's not you, it's you."], 
   'm': [
       "I'm going to mingle with someone else."], 
   'mh': [
...
SuitFaceoffTaunts = {'b': ['Would you like to make a donation?',
   ...
   'dd': [
        "Yo yo, it's your favorite Cog, Dank Downsizer.",
        'Sample Text',
        'Prepare to be noscoped.',
        "Hurry it up, I'm going to miss the premiere of Caillou II.",
        'OH YES.'], 
   'mh': [
   ...
   'sf': [
        "Yo yo, it's your favorite Cog, Smokin' Foreman.",
   ...
   'ols': [
         ...
         'EXECPTION: COULD NOT FIND "TAUNT"',
         "I'LL CHEW YOU UP AND NEVER SPIT YOU OUT",
         'OH GOOD, LUNCH TIME',
         "I'LL TEAR OFF YOUR LIMBS AND STUFF THEM DOWN YOUR THROAT"], 
   'bs': [
   ...
   'sa': [
        "You'd never hold up in a court of law.",
        'I object to your existence, Toon.',
        "I'll have you struck from the record.",
        "You look guilty. You are, aren't you?",
   ...
   'm8': [
        ...
        'I am in control.'], 
   'sm': [
        "They call me a Smokin' Foreman rip-off, but hey, I'm at least The Mr. Hollywood.",
        "Hello there, it's quite 'stormy' here, don't you think?",
        'I might be a tryhard, but I do not bite, why? Because reason.',
        'To be honest though.',
        'My helmet is the key to being functional.'], 
   'ty': [
        "I'm not a real Cog, I'm only Yagich.",
        "You should worship only the one that is higher than anyone's priority and that is me.",
        "Don't hesitate to run, I'm who you're really looking for.",
        'The world will end without me!'], 
   'cag': [
         "I'm the one and only.",
         'None of the Toons will be kidnapped after this conversation.',
         "You're lucky I'm not holding my switch right now.",
         'I always wondered how my switch could work if I pressed it.'], 
   'bfs': [
         "Let's make this quick, I have a beach to get to.",
         'FLEX.',
         "It's Shark Week.",
         'Do you lift?'], 
   'rip': [
         "I'm betting you right now, I'm a professional.",
         'Mhm.',
         'What a catch.'], 
   'pb': [
        "I'm in no hurry to puncture a Toon or two.",
        "I'll break you.",
   ...
   'ph': [
        'Orange you glad to be facing me?',
   ...
   'fts': [
         "Hi, I'm Feathers and I'm here to explain the entire Ayreon discography.",
         'A can of tuna is a good lunch.',
         'I Love Fubby...',
         'Look at all those chickens!',
         'Mothers and Cluckers of the Jury...',
         "A practicing homosexual? I don't need to practice, I'm very good at it.",
         '[ X FILES THEME ]',
         "And don't forget the CJ!",
         'And God said, "render.setLight()".',
         'Have YOU heard about video games?',
         'Birds are... Good.',
         'I would say "welcome to Jurassic Park", but uh... there\'s no other dinosaurs than me.',
         'Do you have time to talk about our Lord and Savior, Scratch the Chicken?',
         'Cherries, peaches, and raspberries are just the most LESBIAN fruits.',
         'OOH, SHE COOKIN!'], 
   'ctn': [
         'Not even The Brrrgh can sink me.',
         'I have embarked on my maiden voyage to your sadness.',
         'This battle will knot turn out well.',
         "Your puns aren't ferry impressive."]}
...
SpeedChatStaticTextToontown = {100: 'Hi!', 101: 'Heya!', 
   ...
   906: "That's not very toony!", 
   907: 'Time to make a new Toon!', 
   1000: "Let's go!", 
   1001: 'This way.', 
   1002: 'Meet here.', 
   1003: 'Follow me.', 
   ...
   1129: "Let's go to the West Wing!", 
   ...
   2400: 'Use the cannons to aim pies at the VP.', 
   2401: 'Please operate the cannons.', 
   2402: 'Use a different cannon to get a better angle.', 
   2403: "I'll stun the VP.", 
   2404: "I'll knock-back the VP.", 
   2405: 'Stun the VP while his hatch is open!', 
   2406: "Don't shoot pies at the VP yet!", 
   2407: 'Shoot pies at the VP now!', 
   2410: 'Pick up a plank to build the railroad.', 
   2411: 'Be careful! You walk slower when carrying planks.', 
   2412: 'Drop your plank to avoid getting hit!', 
   2413: "We're missing a plank over here!", 
   2414: 'Search for any planks other Toons dropped.', 
   2415: 'Disabling many goons angers the CFO.', 
   2416: 'Please disable the goons.', 
   2420: 'Lure the CJ into an object to damage him.', 
   2421: 'Lure the CJ from a distance or he will stop in his tracks!', 
   2422: 'Avoid the cannons or the CJ will trample them!', 
   2423: 'The CJ is likely to follow you the closer you are.', 
   2424: 'Coax the CJ to run into a goon to destroy it.', 
   2430: 'Use the cannons to fire yourself onto a chandelier!', 
   2431: 'Knock the chandelier into the CEO to damage him.', 
   2432: 'Slide down a chandelier faster to deal more damage.', 
   2433: 'My cannon is being controlled!', 
   2440: 'Please save the treasures.', 
   2441: 'Take the treasures.', 
   2442: 'I need treasures!', 
   2443: 'Use a cannon to Toon-Up other toons.', 
   2444: 'Fire the cannons at the goons to destroy them.', 
   2445: 'Defeat the other 3 Boss Cogs before the CEO.', 
   2446: 'Focus on the VP!', 
   2447: 'Focus on the CFO!', 
   2448: 'Focus on the CJ!', 
   ...
   5116: "Let's go to the Executive Meeting.", 
   ...
   5216: "We're going to the Executive Meeting!", 
   ...
   5401: 'Have you played an Episode yet?', 
   5402: 'Magic Words are cool!', 
   5403: 'What Magic Word do I use to do that?', 
   5404: 'This is an awesome Mini-Server!', 
   5405: 'Have you joined the Toontown Offline Discord yet?', 
   54051: 'I heard a new update is coming soon!', 
   54052: 'I hope that comes out soon!', 
   5406: "I'm stuck.", 
   5407: 'I think I found a bug.', 
   5408: 'I found a bug over here.', 
   5409: "Be careful! That's buggy.", 
   5410: 'Sorry, my game crashed.', 
   5411: 'Send in a bug report to the Toontown Offline Discord.', 
   ...
   20500: SuitFaceoffTaunts['sf'][0], 
   20501: SuitFaceoffTaunts['sf'][1], 
   20502: SuitFaceoffTaunts['sf'][2], 
   20503: SuitFaceoffTaunts['sf'][3], 
   20504: SuitFaceoffTaunts['sf'][4], 
   20510: SuitFaceoffTaunts['ols'][0], 
   20511: SuitFaceoffTaunts['ols'][1], 
   20512: SuitFaceoffTaunts['ols'][2], 
   20513: SuitFaceoffTaunts['ols'][3], 
   20514: SuitFaceoffTaunts['ols'][4], 
   20515: SuitFaceoffTaunts['ols'][5], 
   20516: SuitFaceoffTaunts['ols'][6], 
   20520: SuitFaceoffTaunts['sa'][0], 
   20521: SuitFaceoffTaunts['sa'][1], 
   20522: SuitFaceoffTaunts['sa'][2], 
   20523: SuitFaceoffTaunts['sa'][3], 
   20524: SuitFaceoffTaunts['sa'][4], 
   20530: SuitFaceoffTaunts['dd'][0], 
   20531: SuitFaceoffTaunts['dd'][1], 
   20532: SuitFaceoffTaunts['dd'][2], 
   20533: SuitFaceoffTaunts['dd'][3], 
   20534: SuitFaceoffTaunts['dd'][4], 
   20535: SuitFaceoffTaunts['sm'][0], 
   20536: SuitFaceoffTaunts['sm'][1], 
   20537: SuitFaceoffTaunts['sm'][2], 
   20538: SuitFaceoffTaunts['sm'][3], 
   20539: SuitFaceoffTaunts['sm'][4], 
   20540: SuitFaceoffTaunts['ty'][0], 
   20541: SuitFaceoffTaunts['ty'][1], 
   20542: SuitFaceoffTaunts['ty'][2], 
   20543: SuitFaceoffTaunts['ty'][3], 
   20544: SuitFaceoffTaunts['cag'][0], 
   20545: SuitFaceoffTaunts['cag'][1], 
   20546: SuitFaceoffTaunts['cag'][2], 
   20547: SuitFaceoffTaunts['cag'][3], 
   20548: SuitFaceoffTaunts['bfs'][0], 
   20549: SuitFaceoffTaunts['bfs'][1], 
   20550: SuitFaceoffTaunts['bfs'][2], 
   20551: SuitFaceoffTaunts['bfs'][3], 
   20552: SuitFaceoffTaunts['rip'][0], 
   20553: SuitFaceoffTaunts['rip'][1], 
   20554: SuitFaceoffTaunts['rip'][2], 
   20555: SuitFaceoffTaunts['pb'][0], 
   20556: SuitFaceoffTaunts['pb'][1], 
   20557: SuitFaceoffTaunts['pb'][2], 
   20558: SuitFaceoffTaunts['pb'][3], 
   20559: SuitFaceoffTaunts['pb'][4], 
   20560: SuitFaceoffTaunts['sj'][0], 
   20561: SuitFaceoffTaunts['sj'][0], 
   20562: SuitFaceoffTaunts['sj'][0], 
   20563: SuitFaceoffTaunts['sj'][0], 
   20564: SuitFaceoffTaunts['sj'][0], 
   20565: SuitFaceoffTaunts['ph'][0], 
   20566: SuitFaceoffTaunts['ph'][1], 
   20567: SuitFaceoffTaunts['ph'][2], 
   20568: SuitFaceoffTaunts['ph'][3], 
   20569: SuitFaceoffTaunts['ph'][4], 
   20570: 'Go!  And make that sale!', 
   20571: 'Huh?  A Toon!  In disguise!', 
   20572: 'Ah-HAH!  I thought I smelled something a little toony in here!', 
   20573: "That's it.  I've had enough of you, pesky Toon!", 
   20574: 'Aha!  We have a Toon on trial!', 
   20575: 'Court is now in session.', 
   20576: 'Get cracking and serve my banquet!', 
   20577: "Hrrmmpph. When I need a job done right, I'll do it myself.", 
   20578: "...You don't have the heads of cogs.", 
   20579: "I won't stand for this.  I'll sit.", 
   20580: SuitFaceoffTaunts['fts'][0], 
   20581: SuitFaceoffTaunts['fts'][1], 
   20582: SuitFaceoffTaunts['fts'][2], 
   20583: SuitFaceoffTaunts['fts'][3], 
   20584: SuitFaceoffTaunts['fts'][4], 
   20585: SuitFaceoffTaunts['fts'][5], 
   20586: SuitFaceoffTaunts['fts'][6], 
   20587: SuitFaceoffTaunts['fts'][7], 
   20588: SuitFaceoffTaunts['fts'][8], 
   20589: SuitFaceoffTaunts['fts'][9], 
   20590: SuitFaceoffTaunts['fts'][10], 
   20591: SuitFaceoffTaunts['fts'][11], 
   20592: SuitFaceoffTaunts['fts'][12], 
   20593: SuitFaceoffTaunts['fts'][13], 
   20594: SuitFaceoffTaunts['fts'][14], 
   20595: SuitFaceoffTaunts['ctn'][0], 
   20596: SuitFaceoffTaunts['ctn'][1], 
   20597: SuitFaceoffTaunts['ctn'][2], 
   20598: SuitFaceoffTaunts['ctn'][3], 
   21000: 'Here boy!', 
   21001: 'Here girl!', 
   21002: 'Stay.', 
   21003: 'Good boy!', 
   ...
   30251: "That's spooky!", 
   30252: 'Pumpkins have taken over Toontown!', 
   30253: 'Have you attended one of the Mini-Server events?', 
   30254: "There's a Skelecog giving out pumpkin heads in Toontown Central!", 
...
TTAccountCustomerServiceHelp = '\nIf you need help, too bad! Disney no longer has Customer Service at %s.'
