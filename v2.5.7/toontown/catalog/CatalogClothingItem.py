...
AShorts = 6
ATokenPriceBasic = 30
ATokenPriceBasicPlus = 50
ATokenPriceCool = 100
ATokenPriceAwesome = 250
ATokenPriceAmazing = 500
ClothingTypes = {101: (
       ABoysShirt, 'bss1', 40), 
   102: (
       ABoysShirt, 'bss2', 40), 
   ...
   2012: (
        AShirt, 'squirting_flower', 5000), 
   2013: (
        ABoysShirt, 'extraordinate_shirt_boy', ATokenPriceAwesome), 
   2014: (
        AGirlsShirt, 'extraordinate_shirt_girl', ATokenPriceAwesome), 
   2015: (
        ABoysShorts, 'extraordinate_shorts', ATokenPriceAwesome), 
   2016: (
        AGirlsSkirt, 'extraordinate_skirt', ATokenPriceAwesome)}
