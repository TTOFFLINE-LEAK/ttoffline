import CatalogFurnitureItem, CatalogChatItem, CatalogClothingItem, CatalogColorChangeItem, CatalogEmoteItem, CatalogWallpaperItem, CatalogFlooringItem, CatalogWainscotingItem, CatalogMouldingItem, CatalogWindowItem, CatalogPoleItem, CatalogPetTrickItem, CatalogBeanItem, CatalogGardenItem, CatalogInvalidItem, CatalogRentalItem, CatalogGardenStarterItem, CatalogNametagItem, CatalogToonStatueItem, CatalogAnimatedFurnitureItem, CatalogAccessoryItem, CatalogHouseItem
INVALID_ITEM = 0
FURNITURE_ITEM = 1
CHAT_ITEM = 2
CLOTHING_ITEM = 3
...
CatalogItemTypes = {CatalogInvalidItem.CatalogInvalidItem: INVALID_ITEM, CatalogFurnitureItem.CatalogFurnitureItem: FURNITURE_ITEM, 
   ...
   CatalogColorChangeItem.CatalogColorChangeItem: COLOR_CHANGE_ITEM}
