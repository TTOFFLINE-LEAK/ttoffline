...
class CatalogWallpaperItem(CatalogSurfaceItem):
    ...
    def encodeDatagram(self, dg, store):
        ...
        if store & CatalogItem.Customization:
            dg.addUint8(self.colorIndex if self.colorIndex else 0)
            dg.addUint16(self.borderIndex if self.borderIndex else 0)
            dg.addUint8(self.borderColorIndex if self.borderColorIndex else 0)
