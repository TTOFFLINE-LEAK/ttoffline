...
class FishSellGUI(DirectFrame):
    ...
    def __init__(self, doneEvent):
        ...
        self.okButtonTokens = DirectButton(parent=self, relief=None, image=okImageList, image_color=(0.3,
                                                                                                     1,
                                                                                                     0.3,
                                                                                                     1), pos=(0.6,
                                                                                                              0,
                                                                                                              -0.4), text=TTLocalizer.FishGuiOkTokens, text_scale=TTLocalizer.FSGUIokButton, text_pos=(0,
                                                                                                                                                                                                       -0.1), command=self.__sellFishTokens)
