...
class FishPanel(DirectFrame):
    ...
    def update(self, fish):
        ...
        tokenValue = self.fish.getTokenValue()
        if value == 1:
            self.value['text'] = TTLocalizer.FishPageValueS % (value, tokenValue)
        else:
            self.value['text'] = TTLocalizer.FishPageValueP % (value, tokenValue)
