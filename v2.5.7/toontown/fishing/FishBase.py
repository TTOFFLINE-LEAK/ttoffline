...
class FishBase:
    ...
    def getTokenValue(self):
        return int(FishGlobals.getValue(self.genus, self.species, self.weight) * FishGlobals.TokenFactor)
    ...
    def getActor(self):
        ...
        actor.setBlend(frameBlend=config.GetBool('interpolate-animations', True))
        return actor
