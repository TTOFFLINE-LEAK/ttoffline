...
class MakeAToon(StateData.StateData):
    ...
    def load(self):
        ...
        self.roomDropActor.setBlend(frameBlend=config.GetBool('interpolate-animations', True))
        ...
        self.roomSquishActor.setBlend(frameBlend=config.GetBool('interpolate-animations', True))
        ...
        self.propSquishActor.setBlend(frameBlend=config.GetBool('interpolate-animations', True))
        ...
        self.spotlightActor.setBlend(frameBlend=config.GetBool('interpolate-animations', True))
