...
class DNASuitPoint:
    ...
    def __str__(self):
        ...
        if pointType == DNASuitPoint.STREET_POINT:
            ...
            if pointType == DNASuitPoint.FRONT_DOOR_POINT:
                pointTypeStr = 'FRONT_DOOR_POINT'
            else:
                if pointType == DNASuitPoint.SIDE_DOOR_POINT:
                    pointTypeStr = 'SIDE_DOOR_POINT'
                else:
                    if pointType == DNASuitPoint.COGHQ_IN_POINT:
                        pointTypeStr = 'COGHQ_IN_POINT'
                    else:
                        if pointType == DNASuitPoint.COGHQ_OUT_POINT:
