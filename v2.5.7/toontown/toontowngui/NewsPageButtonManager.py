...
class NewsPageButtonManager(FSM.FSM):
    ...
    def load(self):
        ...
        self.newIssueButton.reparentTo(base.a2dTopRight, DGG.BACKGROUND_SORT_INDEX - 1)
        self.gotoPrevPageButton = DirectButton(relief=None, image=(self.closeNewsUp, self.closeNewsHover, self.closeNewsHover), text_fg=(1,
                                                                                                                                         ...
                                                                                                                                         1), text_shadow=(0,
                                                                                                                                                          0,
                                                                                                                                                          0,
                                                                                                                                                          1), text_scale=textScale, text_font=ToontownGlobals.getInterfaceFont(), parent=base.a2dBottomRight, pos=shtickerBookPos, scale=shtickerBookScale, command=self.__handleGotoPrevPageButton)
        self.goto3dWorldButton = DirectButton(relief=None, image=(self.closeNewsUp, self.closeNewsHover, self.closeNewsHover), text_fg=(1,
                                                                                                                                        ...
                                                                                                                                        1), text_shadow=(0,
                                                                                                                                                         0,
                                                                                                                                                         0,
                                                                                                                                                         1), text_scale=textScale, text_font=ToontownGlobals.getInterfaceFont(), parent=base.a2dBottomRight, pos=shtickerBookPos, scale=shtickerBookScale, command=self.__handleGoto3dWorldButton)
