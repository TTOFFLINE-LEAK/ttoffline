...
class PasswordScreen:
    ...
    def __handleOK(self, *args):
        ...
        cookie = base.cr.playToken or 'dev'
        base.accept('csmAuthenticationResponse', self.__handleAuthenticationResponse)
        base.cr.csm.authenticateLogin(cookie, password)

    def __handleAuthenticationResponse(self, success):
        if success:
