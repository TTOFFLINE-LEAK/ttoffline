...
class QuestRewardCounter:
    ...
    def setFromAvatar(self, av):
        ...
        self.maxHp += flowerHp
        HQdepts = (ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.SellbotHQ), ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.LawbotHQ), ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.CashbotHQ), ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.BossbotHQ))
