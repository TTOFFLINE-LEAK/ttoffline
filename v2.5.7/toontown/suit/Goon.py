...
AnimDict = {'pg': (('walk', '-walk'), ('collapse', '-collapse'), ('recovery', '-recovery'), ('neutral', '-recovery'), ('run', '-walk')), 'sg': (
        ('walk', '-walk'), ('collapse', '-collapse'), ('recovery', '-recovery'), ('neutral', '-recovery'), ('run', '-walk'), ('sad-neutral', '-recovery'), ('sad-walk', '-walk'))}
