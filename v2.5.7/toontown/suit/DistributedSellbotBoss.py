...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        promoteDoobers = TTLocalizer.BossCogPromoteDoobers % SuitDNA.getDeptFullnameP('s')
        doobersAway = TTLocalizer.BossCogDoobersAway['s']
        welcomeToons = TTLocalizer.BossCogWelcomeToons
        promoteToons = TTLocalizer.BossCogPromoteToons % SuitDNA.getDeptFullnameP('s')
    ...
    def __talkAboutPromotion(self, speech):
        if not self.localToonPromoted:
            ...
            if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
                ...
                newCogSuitLevel = localAvatar.getCogLevels()[CogDisguiseGlobals.dept2deptIndex('s')]
