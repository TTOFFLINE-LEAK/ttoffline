...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __talkAboutPromotion(self, speech):
        if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
            newCogSuitLevel = localAvatar.getCogLevels()[CogDisguiseGlobals.dept2deptIndex('m')]
        ...
        if menuIndex == ResistanceChat.RESISTANCE_TOONUP:
            ...
            if menuIndex == ResistanceChat.RESISTANCE_MONEY:
                ...
                if menuIndex == ResistanceChat.RESISTANCE_RESTOCK:
                    ...
                    if menuIndex == ResistanceChat.RESISTANCE_TOONDOWN:
                        if value == -1:
                            instructions = TTLocalizer.ResistanceToonToondownAllInstructions
                        else:
                            instructions = TTLocalizer.ResistanceToonToondownInstructions % value
