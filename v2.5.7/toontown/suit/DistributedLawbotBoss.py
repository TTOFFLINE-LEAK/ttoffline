...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        nameInfo = TTLocalizer.BossCogNameWithDept % {'name': self._name, 'dept': SuitDNA.getDeptFullname(self.style.dept)}
    ...
    def enterElevator(self):
        ...
        self.setPosHpr(*ToontownGlobals.LawbotBossStartPosHpr)
        self.podium.setZ(0)
        self.happy = 1
        self.raised = 1
        self.forward = 1
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        self.boss = self
        CamPos = [(-3.0, 25.0, 29.5), (83.81, 69.0, 15.0), (37.14, 67.8, 19.09)]
        CamHpr = [(0.0, 5.0, 0.0), (69.0, 6.0, 0.0), (150.0, -5.0, 0.0)]
        upperDoor = render.find('**/interior').find('**/CR3_Door')
        lowerDoor = render.find('**/CR3_Door')
        upperPodium = render.find('**/Podium')
        lowerPodium = render.find('**/Podium_Geo1_Refl')
        bossSeq = Sequence(Func(self.boss.loop, 'neutral'), self.boss.posInterval(5, (-3.0,
                                                                                      89.0,
                                                                                      21), (-3.0,
                                                                                            140,
                                                                                            21)), Wait(2.5), self.boss.posInterval(5, (-3.0,
                                                                                                                                       89.0,
                                                                                                                                       0)), Wait(1), self.boss.posInterval(9, (-3.0,
                                                                                                                                                                               15,
                                                                                                                                                                               0)))
        bossSeq2 = Sequence(Func(self.boss.loop, 'Ff_neutral'), Wait(3), ActorInterval(self.boss, 'Ff_speech'), ActorInterval(self.boss, 'Ff_speech'), ActorInterval(self.boss, 'Ff_lookLt', duration=2.9), ActorInterval(self.boss, 'Ff_lookLt', startTime=2.9, endTime=0), ActorInterval(self.boss, 'Ff_speech', duration=10.15, loop=1), ActorInterval(self.boss, 'Ff_lookRt', endTime=2.9), ActorInterval(self.boss, 'Ff_lookRt', startTime=2.9, endTime=0), Func(self.boss.loop, 'Ff_neutral'))
        treadSeq = Sequence(Func(self.treadWheels, self.boss, 5), Wait(13.5), Func(self.treadWheels, self.boss, 9))
        doorSeq = Sequence(Parallel(upperDoor.posInterval(2.5, (0.0, 2.5, 30.0), (0.0,
                                                                                  0,
                                                                                  0)), lowerDoor.posInterval(3.5, (0.0,
                                                                                                                   0.0,
                                                                                                                   -32.0), (0.0,
                                                                                                                            0.0,
                                                                                                                            0))), Parallel(upperDoor.posInterval(3, (0.5,
                                                                                                                                                                     0,
                                                                                                                                                                     0)), lowerDoor.posInterval(3, (0,
                                                                                                                                                                                                    0,
                                                                                                                                                                                                    0))))
        PodiumSeq = Sequence(Wait(7.5), upperPodium.posInterval(5, (self.podium.getX(), self.podium.getY(), self.podium.getZ() - 20.9)))
        cameraSeq = Sequence(Func(camera.wrtReparentTo, render), LerpPosHprInterval(camera, 6, CamPos[0], CamHpr[0], blendType='easeInOut'), Wait(0.5), LerpPosHprInterval(camera, 5, CamPos[1], CamHpr[1], blendType='easeInOut'), Wait(2), LerpPosHprInterval(camera, 3.5, CamPos[1], (90,
                                                                                                                                                                                                                                                                                         0,
                                                                                                                                                                                                                                                                                         0), blendType='easeIn'), LerpPosHprInterval(camera, 7, CamPos[2], CamHpr[2], blendType='easeOut'), Wait(1), Func(camera.setPosHpr, -3, -50, 6, 0, 8, 0), Wait(5), LerpPosHprInterval(camera, 1, (-3,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          -20,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          12), (0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                10,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                0), blendType='easeInOut'))
        dialogTrack = Track((
         3, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro0, CFSpeech)), (
         9, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro1, CFSpeech)), (
         14, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro2, CFSpeech)), (
         19, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro3, CFSpeech)), (
         25, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro4, CFSpeech)), (
         30, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro5, CFSpeech)), (
         32.5,
         Sequence(Func(self.clearChat), self.loseCogSuits(self.toonsA + self.toonsB, render, (-2.798,
                                                                                     ...
                                                                                     0)))), (
         36.5,
         Sequence(self.toonNormalEyes(self.involvedToons), Func(self.loop, 'Ff_neutral'), Func(self.setChatAbsolute, TTLocalizer.BossCogAttackToons, CFSpeech))))
        toonTrack = Parallel()
        delay = 0
        ...
        track = Parallel(bossSeq, bossSeq2, cameraSeq, doorSeq, PodiumSeq, treadSeq, dialogTrack, toonTrack)
    ...
    def __walkToonToPromotion(self, toonId, delay, mopath, track, delayDeletes):
        ...
        if toon:
            ...
            toonY = toon.getY()
            toonZ = toon.getZ()
            ival = Sequence(Wait(1.5), Wait(delay), Func(toon.suit.setPlayRate, 1, 'walk'), Func(toon.suit.loop, 'walk'), toon.posInterval(23, Point3(toonX, toonY + -90, toonZ)), Func(toon.suit.loop, 'neutral'))
            track.append(ival)

    def treadWheels(self, boss, duration):
        leftTread = boss.find('**/left_tread')
        rightTread = boss.find('**/right_tread')
        Ltread = NodePath('Ltread')
        Rtread = NodePath('Rtread')
        leftTread.setTexProjector(TextureStage.getDefault(), NodePath(), Ltread)
        rightTread.setTexProjector(TextureStage.getDefault(), NodePath(), Rtread)
        leftWheel = Ltread.posInterval(20, VBase3(-60, 0, 0))
        rightWheel = Rtread.posInterval(20, VBase3(-60, 0, 0))
        Sequence(Wait(duration), Func(leftWheel.finish), Func(rightWheel.finish)).start()
        leftWheel.loop()
        rightWheel.loop()
    ...
    def __talkAboutPromotion(self, speech):
        if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
            newCogSuitLevel = localAvatar.getCogLevels()[CogDisguiseGlobals.dept2deptIndex('l')]
