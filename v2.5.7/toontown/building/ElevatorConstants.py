...
ELEVATOR_FIELD = 9
ELEVATOR_FOUR_BOSS = 10
ELEVATOR_WEST_WING = 11
ELEVATOR_WEST_WING_THICC = 12
REJECT_NOREASON = 0
REJECT_SHUFFLE = 1
REJECT_MINLAFF = 2
REJECT_NOSEAT = 3
...
if not config.GetBool('want-mini-server', False):
    ElevatorData = {ELEVATOR_NORMAL: {'openTime': 2.0, 'closeTime': 2.0, 'width': 3.5, 
       ...
       ELEVATOR_FIELD: {'openTime': 2.0, 'closeTime': 2.0, 
                        ...
                        'sfxVolume': 1.0, 
                        'collRadius': 5}, 
       ELEVATOR_FOUR_BOSS: {'openTime': 4.0, 'closeTime': 4.0, 
                            'width': 6.3, 
                            'countdown': bboard.get('elevatorCountdown', 2.0), 
                            'sfxVolume': 0.7, 
                            'collRadius': 7.5}, 
       ELEVATOR_WEST_WING: {'openTime': 2.0, 'closeTime': 7.0, 
                            'width': 5.875, 
                            'countdown': bboard.get('elevatorCountdown', 2.0), 
                            'sfxVolume': 1.0, 
                            'collRadius': 4}, 
       ELEVATOR_WEST_WING_THICC: {'openTime': 4.0, 'closeTime': 4.0, 
                                  'width': 20, 
                                  'countdown': bboard.get('elevatorCountdown', 2.0), 
                                  'sfxVolume': 0.7, 
                                  'collRadius': 7.5}}
