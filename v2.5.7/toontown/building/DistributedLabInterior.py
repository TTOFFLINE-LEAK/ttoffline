...
class DistributedLabInterior(DistributedObject.DistributedObject):
    ...
    def setup(self):
        ...
        doorOrigin = render.find('**/door_origin')
        ...
        pro4EvSeq = Sequence(Func(NodePath(self.laffMeter).hide), Wait(3), Func(NodePath(self.laffMeter).hide), Func(base.localAvatar.disableAvatarControls), Wait(3), Func(NodePath(self.laffMeter).hide), Func(localAvatar.sendUpdate, 'startPro4Ev', []))
        pro4EvSeq.start()
