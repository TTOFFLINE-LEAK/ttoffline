...
class InventoryNew(InventoryBase.InventoryBase, DirectFrame):
    ...
    def setActivateMode(self, mode, heal=1, trap=1, lure=1, bldg=0, creditLevel=None, tutorialFlag=0, gagTutMode=0, inSquirtingFlowerEvent=0):
    ...
    def battleActivateButtons(self):
        ...
        if self.bldg == 1:
            ...
            if self.tutorialFlag == 1 or self.inSquirtingFlowerEvent == 1:
                self.runButton.hide()
                self.sosButton.hide()
