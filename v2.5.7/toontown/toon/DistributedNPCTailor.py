...
class DistributedNPCTailor(DistributedNPCToonBase):
    ...
    def setMovie(self, mode, npcId, avId, timestamp):
        ...
        if mode == NPCToons.PURCHASE_MOVIE_TIMEOUT:
            ...
            if mode == NPCToons.PURCHASE_MOVIE_START or mode == NPCToons.PURCHASE_MOVIE_START_BROWSE or mode == NPCToons.PURCHASE_MOVIE_START_NOROOM or mode == NPCToons.PURCHASE_MOVIE_START_BROWSE_JBS:
                ...
                if self.browsing == 0:
                    ...
                    if mode == NPCToons.PURCHASE_MOVIE_START_BROWSE_JBS:
                ...
                if mode == NPCToons.PURCHASE_MOVIE_COMPLETE:
                    ...
                    if mode == NPCToons.PURCHASE_MOVIE_NO_MONEY:
                        ...
                        if mode == NPCToons.PURCHASE_MOVIE_BAD_SITUATION:
                            self.setChatAbsolute(TTLocalizer.STOREOWNER_GETDRESSED, CFSpeech | CFTimeout)
                            self.resetTailor()
        return
