...
def generateSuits(numberOfSuits, suitLevelRange=[
 0, 0], suitRange=[0, 0], wantExtraShakers=False):
    suits = [sellbotSuits, cashbotSuits, lawbotSuitTypes, bossbotSuits]
    wave = []
    if wantExtraShakers:
...
SuitWaitWaves = [
 1, 4, 7, 10, 13, 16, 19, 22, 24, 25]
SuitIntermissionWaves = [
...
FishingAlert = "You can't fish right now, the docks are closed!"
PartiesAlert = 'There are no parties, the gate is closed!'
