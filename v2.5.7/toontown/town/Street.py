...
class Street(BattlePlace.BattlePlace):
    ...
    def enter(self, requestStatus, visibilityFlag=1, arrowsOn=1):
        ...
        if newsManager:
            ...
            if (ToontownGlobals.HALLOWEEN_COSTUMES in holidayIds or ToontownGlobals.SPOOKY_COSTUMES in holidayIds or base.cr.newsManager.isHolidayRunning(ToontownGlobals.HALLOWEEN)) and self.loader.hood.spookySkyFile:
