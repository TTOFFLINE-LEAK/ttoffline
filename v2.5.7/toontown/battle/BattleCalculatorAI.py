...
class BattleCalculatorAI:
    ...
    def __init__(self, battle, tutorialFlag=0, inSquirtingFlowerEvent=0):
        self.battle = battle
        self.SuitAttackers = {}
        ...
        self.inSquirtingFlowerEvent = inSquirtingFlowerEvent
    ...
    def __calcToonAtkHit(self, attackIndex, atkTargets):
        ...
        if len(atkTargets) == 0:
            return (0, 0)
        if toon.getInstaKillEnabled() or toon.getAlwaysHitSuits():
            return (1, 95)
    ...
    def __targetDefense(self, suit, atkTrack):
        if atkTrack == HEAL:
            return 0
        if suit.getLevel() == 43:
            suitDef = SuitBattleGlobals.SuitAttributes[suit.dna.name]['def'][4]
        else:
    ...
    def __calcToonAtkHp(self, toonId):
        ...
        for currTarget in range(len(targetList)):
            ...
            if attackLevel == -1 and not atkTrack == FIRE:
                ...
                if atkTrack != TRAP:
                    toon = self.battle.getToon(toonId)
                    if toon and toon.getChairmanNerfs() and atkTrack == SOUND:
                        attackDamage = int(round(attackDamage / 2))
                    if toon and toon.getInstaKillEnabled() and atkTrack != HEAL:
 ...
 892     218  LOAD_FAST            10  'damageDone'
         221  LOAD_CONST               0
         224  COMPARE_OP            4  >
         227  POP_JUMP_IF_FALSE   262  'to 262'

 893     230  LOAD_FAST             0  'self'
 ...
 894     262  LOAD_FAST             5  'atkTrack'
         265  LOAD_GLOBAL          17  'TRAP'
         268  COMPARE_OP            2  ==
         271  POP_JUMP_IF_FALSE   330  'to 330'

 895     274  LOAD_FAST             0  'self'
         277  LOAD_ATTR            18  'traps'
         280  LOAD_ATTR            19  'has_key'
         283  LOAD_FAST             9  'currTgt'
         286  LOAD_ATTR            20  'doId'
         289  CALL_FUNCTION_1       1  None
         292  POP_JUMP_IF_FALSE   330  'to 330'

 896     295  LOAD_FAST             0  'self'
         298  LOAD_ATTR            18  'traps'
         301  LOAD_FAST             9  'currTgt'
         304  LOAD_ATTR            20  'doId'
         307  BINARY_SUBSCR    
         308  STORE_FAST           11  'trapInfo'

 897     311  LOAD_FAST            11  'trapInfo'
         314  LOAD_CONST               0
         317  BINARY_SUBSCR    
         318  LOAD_FAST             9  'currTgt'
         321  STORE_ATTR           21  'battleTrap'
         324  JUMP_ABSOLUTE       330  'to 330'
         327  JUMP_FORWARD          0  'to 330'
       330_0  COME_FROM           327  '327'

 898     330  LOAD_CONST               0
         333  STORE_FAST           12  'targetDead'

 899     336  LOAD_FAST             9  'currTgt'
         339  LOAD_ATTR            22  'getHP'
         342  CALL_FUNCTION_0       0  None
         345  LOAD_CONST               0
         348  COMPARE_OP            4  >
         351  POP_JUMP_IF_FALSE   363  'to 363'

 900     354  LOAD_CONST               0
         357  STORE_FAST            8  'allTargetsDead'
         360  JUMP_FORWARD         57  'to 420'

 902     363  LOAD_CONST               1
         366  STORE_FAST           12  'targetDead'

 903     369  LOAD_FAST             5  'atkTrack'
         372  LOAD_GLOBAL          23  'LURE'
         375  COMPARE_OP            3  !=
         378  POP_JUMP_IF_FALSE   420  'to 420'

 904     381  SETUP_LOOP           36  'to 420'
         384  LOAD_FAST             2  'lastAttacks'
         387  GET_ITER         
         388  FOR_ITER             25  'to 416'
         391  STORE_FAST           13  'currLastAtk'

 905     394  LOAD_FAST             0  'self'
         397  LOAD_ATTR            24  '__clearTgtDied'
         400  LOAD_FAST             9  'currTgt'
         403  LOAD_FAST            13  'currLastAtk'
         406  LOAD_FAST             4  'attack'
         409  CALL_FUNCTION_3       3  None
         412  POP_TOP          
         413  JUMP_BACK           388  'to 388'
         416  POP_BLOCK        
       417_0  COME_FROM           381  '381'
         417  JUMP_FORWARD          0  'to 420'
       420_0  COME_FROM           381  '381'
       420_1  COME_FROM           360  '360'

 907     420  LOAD_FAST             9  'currTgt'
         423  LOAD_ATTR            15  'getDoId'
         426  CALL_FUNCTION_0       0  None
         429  STORE_FAST           14  'tgtId'

 908     432  LOAD_FAST             0  'self'
         435  LOAD_ATTR            25  'successfulLures'
         438  LOAD_ATTR            19  'has_key'
         441  LOAD_FAST            14  'tgtId'
         444  CALL_FUNCTION_1       1  None
         447  POP_JUMP_IF_FALSE   690  'to 690'
         450  LOAD_FAST             5  'atkTrack'
         453  LOAD_GLOBAL          23  'LURE'
         456  COMPARE_OP            2  ==
       459_0  COME_FROM           447  '447'
         459  POP_JUMP_IF_FALSE   690  'to 690'

 909     462  LOAD_FAST             0  'self'
         465  LOAD_ATTR            25  'successfulLures'
         468  LOAD_FAST            14  'tgtId'
         471  BINARY_SUBSCR    
         472  STORE_FAST           15  'lureInfo'

 910     475  LOAD_FAST             0  'self'
         478  LOAD_ATTR             0  'notify'
         481  LOAD_ATTR             1  'debug'
         484  LOAD_CONST               'applying lure data: '
         487  LOAD_GLOBAL          26  'repr'
         490  LOAD_FAST            15  'lureInfo'
         493  CALL_FUNCTION_1       1  None
         496  BINARY_ADD       
         497  CALL_FUNCTION_1       1  None
         500  POP_TOP          

 911     501  LOAD_FAST            15  'lureInfo'
         504  LOAD_CONST               0
         507  BINARY_SUBSCR    
         508  STORE_FAST           16  'toonId'

 912     511  LOAD_FAST             0  'self'
         514  LOAD_ATTR             4  'battle'
         517  LOAD_ATTR             5  'toonAttacks'
         520  LOAD_FAST            16  'toonId'
         523  BINARY_SUBSCR    
         524  STORE_FAST           17  'lureAtk'

 913     527  LOAD_FAST             0  'self'
         530  LOAD_ATTR             4  'battle'
         533  LOAD_ATTR            27  'activeSuits'
         536  LOAD_ATTR            28  'index'
         539  LOAD_FAST             9  'currTgt'
         542  CALL_FUNCTION_1       1  None
         545  STORE_FAST           18  'tgtPos'

 914     548  LOAD_FAST             0  'self'
         551  LOAD_ATTR            18  'traps'
         554  LOAD_ATTR            19  'has_key'
         557  LOAD_FAST             9  'currTgt'
         560  LOAD_ATTR            20  'doId'
         563  CALL_FUNCTION_1       1  None
         566  POP_JUMP_IF_FALSE   639  'to 639'

 915     569  LOAD_FAST             0  'self'
         572  LOAD_ATTR            18  'traps'
         575  LOAD_FAST             9  'currTgt'
         578  LOAD_ATTR            20  'doId'
         581  BINARY_SUBSCR    
         582  STORE_FAST           11  'trapInfo'

 916     585  LOAD_FAST            11  'trapInfo'
         588  LOAD_CONST               0
         591  BINARY_SUBSCR    
         592  LOAD_GLOBAL          29  'UBER_GAG_LEVEL_INDEX'
         595  COMPARE_OP            2  ==
         598  POP_JUMP_IF_FALSE   639  'to 639'

 917     601  LOAD_FAST             0  'self'
         604  LOAD_ATTR             0  'notify'
         607  LOAD_ATTR             1  'debug'
         610  LOAD_CONST               'train trap triggered for %d'
         613  LOAD_FAST             9  'currTgt'
         616  LOAD_ATTR            20  'doId'
         619  BINARY_MODULO    
         620  CALL_FUNCTION_1       1  None
         623  POP_TOP          

 918     624  LOAD_GLOBAL          30  'True'
         627  LOAD_FAST             0  'self'
         630  STORE_ATTR           31  'trainTrapTriggered'
         633  JUMP_ABSOLUTE       639  'to 639'
         636  JUMP_FORWARD          0  'to 639'
       639_0  COME_FROM           636  '636'

 919     639  LOAD_FAST             0  'self'
         642  LOAD_ATTR            32  '__removeSuitTrap'
         645  LOAD_FAST            14  'tgtId'
         648  CALL_FUNCTION_1       1  None
         651  POP_TOP          

 920     652  LOAD_FAST             0  'self'
         655  LOAD_ATTR            33  'KBBONUS_TGT_LURED'
         658  LOAD_FAST            17  'lureAtk'
         661  LOAD_GLOBAL          34  'TOON_KBBONUS_COL'
         664  BINARY_SUBSCR    
         665  LOAD_FAST            18  'tgtPos'
         668  STORE_SUBSCR     

 921     669  LOAD_FAST            15  'lureInfo'
         672  LOAD_CONST               3
         675  BINARY_SUBSCR    
         676  LOAD_FAST            17  'lureAtk'
         679  LOAD_GLOBAL          35  'TOON_HP_COL'
         682  BINARY_SUBSCR    
         683  LOAD_FAST            18  'tgtPos'
         686  STORE_SUBSCR     
         687  JUMP_FORWARD         92  'to 782'

 922     690  LOAD_FAST             0  'self'
         693  LOAD_ATTR            36  '__suitIsLured'
         696  LOAD_FAST            14  'tgtId'
         699  CALL_FUNCTION_1       1  None
         702  POP_JUMP_IF_FALSE   782  'to 782'
         705  LOAD_FAST             5  'atkTrack'
         708  LOAD_GLOBAL          37  'DROP'
         711  COMPARE_OP            2  ==
       714_0  COME_FROM           702  '702'
         714  POP_JUMP_IF_FALSE   782  'to 782'

 923     717  LOAD_FAST             0  'self'
         720  LOAD_ATTR             0  'notify'
         723  LOAD_ATTR             1  'debug'
         726  LOAD_CONST               'Drop on lured suit, '
         729  LOAD_CONST               'indicating with KBBONUS_COL '
         732  BINARY_ADD       
         733  LOAD_CONST               'flag'
         736  BINARY_ADD       
 ...
 924     741  LOAD_FAST             0  'self'
         744  LOAD_ATTR             4  'battle'
         747  LOAD_ATTR            27  'activeSuits'
         750  LOAD_ATTR            28  'index'
         753  LOAD_FAST             9  'currTgt'
         756  CALL_FUNCTION_1       1  None
         759  STORE_FAST           18  'tgtPos'

 925     762  LOAD_FAST             0  'self'
         765  LOAD_ATTR            38  'KBBONUS_LURED_FLAG'
         768  LOAD_FAST             4  'attack'
         771  LOAD_GLOBAL          34  'TOON_KBBONUS_COL'
         774  BINARY_SUBSCR    
         775  LOAD_FAST            18  'tgtPos'
         778  STORE_SUBSCR     
         779  JUMP_FORWARD          0  'to 782'
       782_0  COME_FROM           779  '779'
       782_1  COME_FROM           687  '687'

 926     782  LOAD_FAST            12  'targetDead'
         785  POP_JUMP_IF_FALSE   191  'to 191'
         788  LOAD_FAST             5  'atkTrack'
         791  LOAD_FAST             1  'lastTrack'
         794  COMPARE_OP            3  !=
       797_0  COME_FROM           785  '785'
         797  POP_JUMP_IF_FALSE   191  'to 191'

 927     800  LOAD_FAST             0  'self'
         803  LOAD_ATTR             4  'battle'
         806  LOAD_ATTR            27  'activeSuits'
         809  LOAD_ATTR            28  'index'
         812  LOAD_FAST             9  'currTgt'
         815  CALL_FUNCTION_1       1  None
         818  STORE_FAST           18  'tgtPos'

 928     821  LOAD_CONST               0
         824  LOAD_FAST             4  'attack'
         827  LOAD_GLOBAL          35  'TOON_HP_COL'
         830  BINARY_SUBSCR    
         831  LOAD_FAST            18  'tgtPos'
         834  STORE_SUBSCR     

 929     835  LOAD_CONST               -1
         838  LOAD_FAST             4  'attack'
         841  LOAD_GLOBAL          34  'TOON_KBBONUS_COL'
         844  BINARY_SUBSCR    
         845  LOAD_FAST            18  'tgtPos'
         848  STORE_SUBSCR     
         849  JUMP_BACK           191  'to 191'
         852  JUMP_BACK           191  'to 191'
         855  POP_BLOCK        
       856_0  COME_FROM           184  '184'

 931     856  LOAD_FAST             8  'allTargetsDead'
         859  POP_JUMP_IF_FALSE   984  'to 984'
         862  LOAD_FAST             5  'atkTrack'
         865  LOAD_FAST             1  'lastTrack'
         868  COMPARE_OP            3  !=
       871_0  COME_FROM           859  '859'
         871  POP_JUMP_IF_FALSE   984  'to 984'

 932     874  LOAD_FAST             0  'self'
         877  LOAD_ATTR             0  'notify'
         880  LOAD_ATTR            39  'getDebug'
         883  CALL_FUNCTION_0       0  None
         886  POP_JUMP_IF_FALSE   922  'to 922'

 933     889  LOAD_FAST             0  'self'
         892  LOAD_ATTR             0  'notify'
         895  LOAD_ATTR             1  'debug'
         898  LOAD_CONST               'all targets of toon attack '
         901  LOAD_GLOBAL          40  'str'
         904  LOAD_FAST             3  'currToonAttack'
         907  CALL_FUNCTION_1       1  None
         910  BINARY_ADD       
         911  LOAD_CONST               ' are dead'
         914  BINARY_ADD       
         915  CALL_FUNCTION_1       1  None
         918  POP_TOP          
         919  JUMP_FORWARD          0  'to 922'
       922_0  COME_FROM           919  '919'

 934     922  LOAD_FAST             0  'self'
         925  LOAD_ATTR            41  '__clearAttack'
         928  LOAD_FAST             3  'currToonAttack'
         931  LOAD_CONST               'toon'
         934  LOAD_CONST               1
         937  CALL_FUNCTION_257   257  None
         940  POP_TOP          

 935     941  LOAD_FAST             0  'self'
         944  LOAD_ATTR             4  'battle'
         947  LOAD_ATTR             5  'toonAttacks'
         950  LOAD_FAST             3  'currToonAttack'
         953  BINARY_SUBSCR    
         954  STORE_FAST            4  'attack'

 936     957  LOAD_FAST             0  'self'
         960  LOAD_ATTR             6  '__getActualTrackLevel'
         963  LOAD_FAST             4  'attack'
         966  CALL_FUNCTION_1       1  None
         969  UNPACK_SEQUENCE_2     2 
         972  STORE_FAST            5  'atkTrack'
         975  STORE_FAST            6  'atkLevel'
         978  JUMP_ABSOLUTE       984  'to 984'
         981  JUMP_FORWARD          0  'to 984'
       984_0  COME_FROM           981  '981'

 937     984  LOAD_FAST             0  'self'
         987  LOAD_ATTR            42  '__applyToonAttackDamages'
         990  LOAD_FAST             3  'currToonAttack'
         993  CALL_FUNCTION_1       1  None
         996  STORE_FAST           19  'damagesDone'

 938     999  LOAD_FAST             0  'self'
        1002  LOAD_ATTR            42  '__applyToonAttackDamages'
        1005  LOAD_FAST             3  'currToonAttack'
        1008  LOAD_CONST               'hpbonus'
        1011  LOAD_CONST               1
        1014  CALL_FUNCTION_257   257  None
        1017  POP_TOP          

 939    1018  LOAD_FAST             5  'atkTrack'
        1021  LOAD_GLOBAL          23  'LURE'
        1024  COMPARE_OP            3  !=
        1027  POP_JUMP_IF_FALSE  1076  'to 1076'
        1030  LOAD_FAST             5  'atkTrack'
        1033  LOAD_GLOBAL          37  'DROP'
        1036  COMPARE_OP            3  !=
        1039  POP_JUMP_IF_FALSE  1076  'to 1076'
        1042  LOAD_FAST             5  'atkTrack'
        1045  LOAD_GLOBAL          43  'SOUND'
        1048  COMPARE_OP            3  !=
      1051_0  COME_FROM          1039  '1039'
      1051_1  COME_FROM          1027  '1027'
        1051  POP_JUMP_IF_FALSE  1076  'to 1076'

 940    1054  LOAD_FAST             0  'self'
        1057  LOAD_ATTR            42  '__applyToonAttackDamages'
        1060  LOAD_FAST             3  'currToonAttack'
        1063  LOAD_CONST               'kbbonus'
        1066  LOAD_CONST               1
        1069  CALL_FUNCTION_257   257  None
        1072  POP_TOP          
        1073  JUMP_FORWARD          0  'to 1076'
      1076_0  COME_FROM          1073  '1073'

 941    1076  LOAD_FAST             1  'lastTrack'
        1079  LOAD_FAST             5  'atkTrack'
        1082  COMPARE_OP            3  !=
        1085  POP_JUMP_IF_FALSE  1103  'to 1103'

 942    1088  BUILD_LIST_0          0 
        1091  STORE_FAST            2  'lastAttacks'

 943    1094  LOAD_FAST             5  'atkTrack'
        1097  STORE_FAST            1  'lastTrack'
        1100  JUMP_FORWARD          0  'to 1103'
      1103_0  COME_FROM          1100  '1100'

 944    1103  LOAD_FAST             2  'lastAttacks'
        1106  LOAD_ATTR            44  'append'
        1109  LOAD_FAST             4  'attack'
        1112  CALL_FUNCTION_1       1  None
        1115  POP_TOP          

 945    1116  LOAD_FAST             0  'self'
        1119  LOAD_ATTR            45  'itemIsCredit'
        1122  LOAD_FAST             5  'atkTrack'
        1125  LOAD_FAST             6  'atkLevel'
        1128  CALL_FUNCTION_2       2  None
        1131  POP_JUMP_IF_FALSE  1223  'to 1223'

 946    1134  LOAD_FAST             5  'atkTrack'
        1137  LOAD_GLOBAL          17  'TRAP'
        1140  COMPARE_OP            2  ==
        1143  POP_JUMP_IF_TRUE   1217  'to 1217'
        1146  LOAD_FAST             5  'atkTrack'
        1149  LOAD_GLOBAL          23  'LURE'
        1152  COMPARE_OP            2  ==
        1155  POP_JUMP_IF_FALSE  1161  'to 1161'

 947    1158  JUMP_ABSOLUTE      1220  'to 1220'

 948    1161  LOAD_FAST             5  'atkTrack'
        1164  LOAD_GLOBAL           7  'HEAL'
        1167  COMPARE_OP            2  ==
        1170  POP_JUMP_IF_FALSE  1204  'to 1204'

 949    1173  LOAD_FAST            19  'damagesDone'
        1176  LOAD_CONST               0
        1179  COMPARE_OP            3  !=
        1182  POP_JUMP_IF_FALSE  1217  'to 1217'

 950    1185  LOAD_FAST             0  'self'
        1188  LOAD_ATTR            46  '__addAttackExp'
        1191  LOAD_FAST             4  'attack'
        1194  CALL_FUNCTION_1       1  None
        1197  POP_TOP          
        1198  JUMP_ABSOLUTE      1217  'to 1217'
        1201  JUMP_ABSOLUTE      1220  'to 1220'

 952    1204  LOAD_FAST             0  'self'
        1207  LOAD_ATTR            46  '__addAttackExp'
        1210  LOAD_FAST             4  'attack'
        1213  CALL_FUNCTION_1       1  None
        1216  POP_TOP          
        1217  JUMP_ABSOLUTE      1223  'to 1223'
        1220  JUMP_BACK            48  'to 48'
        1223  JUMP_BACK            48  'to 48'
        1226  POP_BLOCK        
      1227_0  COME_FROM            38  '38'

 954    1227  LOAD_FAST             0  'self'
        1230  LOAD_ATTR            31  'trainTrapTriggered'
        1233  POP_JUMP_IF_FALSE  1313  'to 1313'

 955    1236  SETUP_LOOP           74  'to 1313'
        1239  LOAD_FAST             0  'self'
        1242  LOAD_ATTR             4  'battle'
        1245  LOAD_ATTR            27  'activeSuits'
        1248  GET_ITER         
        1249  FOR_ITER             57  'to 1309'
        1252  STORE_FAST           20  'suit'

 956    1255  LOAD_FAST            20  'suit'
        1258  LOAD_ATTR            20  'doId'
        1261  STORE_FAST           21  'suitId'

 957    1264  LOAD_FAST             0  'self'
        1267  LOAD_ATTR            32  '__removeSuitTrap'
        1270  LOAD_FAST            21  'suitId'
        1273  CALL_FUNCTION_1       1  None
        1276  POP_TOP          

 958    1277  LOAD_GLOBAL          47  'NO_TRAP'
        1280  LOAD_FAST            20  'suit'
        1283  STORE_ATTR           21  'battleTrap'

 959    1286  LOAD_FAST             0  'self'
        1289  LOAD_ATTR             0  'notify'
        1292  LOAD_ATTR             1  'debug'
        1295  LOAD_CONST               'train trap triggered, removing trap from %d'
        1298  LOAD_FAST            21  'suitId'
        1301  BINARY_MODULO    
        1302  CALL_FUNCTION_1       1  None
        1305  POP_TOP          
        1306  JUMP_BACK          1249  'to 1249'
        1309  POP_BLOCK        
      1310_0  COME_FROM          1236  '1236'
        1310  JUMP_FORWARD          0  'to 1313'
      1313_0  COME_FROM          1236  '1236'

 961    1313  LOAD_FAST             0  'self'
        1316  LOAD_ATTR             0  'notify'
        1319  LOAD_ATTR            39  'getDebug'
        1322  CALL_FUNCTION_0       0  None
        1325  POP_JUMP_IF_FALSE  1393  'to 1393'

 962    1328  SETUP_LOOP           62  'to 1393'
        1331  LOAD_FAST             0  'self'
        1334  LOAD_ATTR             3  'toonAtkOrder'
        1337  GET_ITER         
        1338  FOR_ITER             48  'to 1389'
        1341  STORE_FAST            3  'currToonAttack'

 963    1344  LOAD_FAST             0  'self'
        1347  LOAD_ATTR             4  'battle'
        1350  LOAD_ATTR             5  'toonAttacks'
        1353  LOAD_FAST             3  'currToonAttack'
        1356  BINARY_SUBSCR    
        1357  STORE_FAST            4  'attack'

 964    1360  LOAD_FAST             0  'self'
        1363  LOAD_ATTR             0  'notify'
        1366  LOAD_ATTR             1  'debug'
        1369  LOAD_CONST               'Final Toon attack: '
        1372  LOAD_GLOBAL          40  'str'
        1375  LOAD_FAST             4  'attack'
        1378  CALL_FUNCTION_1       1  None
        1381  BINARY_ADD       
        1382  CALL_FUNCTION_1       1  None
        1385  POP_TOP          
        1386  JUMP_BACK          1338  'to 1338'
        1389  POP_BLOCK        
      1390_0  COME_FROM          1328  '1328'
        1390  JUMP_FORWARD          0  'to 1393'
      1393_0  COME_FROM          1328  '1328'

Parse error at or near `JUMP_BACK' instruction at offset 1223
    ...
    def __suitAtkHit(self, attackIndex):
        ...
        atkAcc = atkInfo['acc']
        if theSuit.getLevel() == 43:
            suitAcc = SuitBattleGlobals.SuitAttributes[theSuit.dna.name]['acc'][4]
        else:
            ...
            if toon and toon.immortalMode:
                ...
                if self.TOONS_TAKE_NO_DAMAGE:
                    ...
                    if self.__suitAtkHit(attackIndex):
                        ...
                        atkInfo = SuitBattleGlobals.getSuitAttack(theSuit.dna.name, theSuit.getLevel(), atkType)
                        result = atkInfo['hp']
                if simbase.air.currentEpisode == 'squirting_flower' and toon.getHp() - result < 1:
                    return 0
