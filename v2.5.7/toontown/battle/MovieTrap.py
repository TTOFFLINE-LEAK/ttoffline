...
def createThrownTrapMultiTrack(trap, propList, propName, propPos=None, propHpr=None, anim=0, explode=0):
    return __createThrownTrapMultiTrack(trap, propList, propName, propPos, propHpr, anim, explode)
