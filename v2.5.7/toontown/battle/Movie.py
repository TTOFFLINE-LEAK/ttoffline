...
class Movie(DirectObject.DirectObject):
    ...
    def genRewardDicts(self, id0, origExp0, earnedExp0, origQuests0, items0, missedItems0, origMerits0, merits0, parts0, id1, origExp1, earnedExp1, origQuests1, items1, missedItems1, origMerits1, merits1, parts1, id2, origExp2, earnedExp2, origQuests2, items2, missedItems2, origMerits2, merits2, parts2, id3, origExp3, earnedExp3, origQuests3, items3, missedItems3, origMerits3, merits3, parts3, id4, origExp4, earnedExp4, origQuests4, items4, missedItems4, origMerits4, merits4, parts4, id5, origExp5, earnedExp5, origQuests5, items5, missedItems5, origMerits5, merits5, parts5, id6, origExp6, earnedExp6, origQuests6, items6, missedItems6, origMerits6, merits6, parts6, id7, origExp7, earnedExp7, origQuests7, items7, missedItems7, origMerits7, merits7, parts7, deathList, uberList, helpfulToonsList):
        ...
        entries = ((id0, origExp0, earnedExp0, origQuests0, items0, missedItems0, origMerits0, merits0, parts0),
         ...
         (
          id4, origExp4, earnedExp4, origQuests4, items4, missedItems4, origMerits4, merits4, parts4),
         (
          id5, origExp5, earnedExp5, origQuests5, items5, missedItems5, origMerits5, merits5, parts5),
         (
          id6, origExp6, earnedExp6, origQuests6, items6, missedItems6, origMerits6, merits6, parts6),
         (
          id7, origExp7, earnedExp7, origQuests7, items7, missedItems7, origMerits7, merits7, parts7))
    ...
    def genAttackDicts(self, toons, suits, id0, tr0, le0, tg0, hp0, ac0, hpb0, kbb0, died0, revive0, id1, tr1, le1, tg1, hp1, ac1, hpb1, kbb1, died1, revive1, id2, tr2, le2, tg2, hp2, ac2, hpb2, kbb2, died2, revive2, id3, tr3, le3, tg3, hp3, ac3, hpb3, kbb3, died3, revive3, id4, tr4, le4, tg4, hp4, ac4, hpb4, kbb4, died4, revive4, id5, tr5, le5, tg5, hp5, ac5, hpb5, kbb5, died5, revive5, id6, tr6, le6, tg6, hp6, ac6, hpb6, kbb6, died6, revive6, id7, tr7, le7, tg7, hp7, ac7, hpb7, kbb7, died7, revive7, sid0, at0, stg0, dm0, sd0, sb0, st0, sid1, at1, stg1, dm1, sd1, sb1, st1, sid2, at2, stg2, dm2, sd2, sb2, st2, sid3, at3, stg3, dm3, sd3, sb3, st3, sid4, at4, stg4, dm4, sd4, sb4, st4, sid5, at5, stg5, dm5, sd5, sb5, st5, sid6, at6, stg6, dm6, sd6, sb6, st6, sid7, at7, stg7, dm7, sd7, sb7, st7):
        ...
        toonAttacks = (
         ...
         (
          id4, tr4, le4, tg4, hp4, ac4, hpb4, kbb4, died4, revive4),
         (
          id5, tr5, le5, tg5, hp5, ac5, hpb5, kbb5, died5, revive5),
         (
          id6, tr6, le6, tg6, hp6, ac6, hpb6, kbb6, died6, revive6),
         (
          id7, tr7, le7, tg7, hp7, ac7, hpb7, kbb7, died7, revive7))
        ...
        suitAttacks = ((sid0, at0, stg0, dm0, sd0, sb0, st0),
         ...
         (
          sid4, at4, stg4, dm4, sd4, sb4, st4),
         (
          sid5, at5, stg5, dm5, sd5, sb5, st5),
         (
          sid6, at6, stg6, dm6, sd6, sb6, st6),
         (
          sid7, at7, stg7, dm7, sd7, sb7, st7))
    ...
    def reorganizeCheck(self, a):
        if base.turnBasedReorganize == 4:
            a['hp'] = int(a['hp'] * 1.5)
            if a['name'] == 'Fore' or a['name'] == 'BossJump':
                for dict in a['target']:
                    dict['hp'] = int(dict['hp'] * 1.5)

            else:
                a['target']['hp'] = int(a['target']['hp'] * 1.5)
        else:
            if base.turnBasedReorganize == 3:
                a['name'] = 'Reorganize'
                a['acc'] = 0
                a['hp'] = 0
                a['taunt'] = 0
                a['id'] = 60
                base.turnBasedReorganize = 4
            else:
                base.turnBasedReorganize += 1
        return a