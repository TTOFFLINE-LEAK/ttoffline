    ...
    def __placeButtons(self, numAvatars, invalidTargets, localNum, fireCosts):
        ...
        for i in range(8):
            if numAvatars > i and i not in invalidTargets and i != localNum:
                ...
                if fireCosts[i] <= localAvatar.getPinkSlips() and fireCosts[i] != 69:
        ...
        if canfire:
            ...
            if isUnfireable:
                self.textFrame['text'] = TTLocalizer.FireCogImpossibleTitle % localAvatar.getPinkSlips()
            else:
