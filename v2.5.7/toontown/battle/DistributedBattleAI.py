...
class DistributedBattleAI(DistributedBattleBaseAI.DistributedBattleBaseAI):
    ...
    def __init__(self, air, battleMgr, pos, suit, toonId, zoneId, finishCallback=None, maxSuits=4, tutorialFlag=0, inSquirtingFlowerEvent=0, levelFlag=0, interactivePropTrackBonus=-1, maxToons=4):
        DistributedBattleBaseAI.DistributedBattleBaseAI.__init__(self, air, zoneId, finishCallback, maxSuits=maxSuits, tutorialFlag=tutorialFlag, inSquirtingFlowerEvent=inSquirtingFlowerEvent, interactivePropTrackBonus=interactivePropTrackBonus, maxToons=maxToons)
