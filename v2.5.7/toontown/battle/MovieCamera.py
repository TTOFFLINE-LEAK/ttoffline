...
def chooseSoundOpenShot(sounds, targets, attackDuration):
    ...
    if numSounds == 1:
        ...
        if numSounds >= 2 and numSounds <= 8:
            shotChoices = [
...
def chooseThrowOpenShot(throws, suitThrowsDict, attackDuration):
    ...
    if numThrows == 1:
        ...
        if numThrows >= 2 and numThrows <= 5:
            shotChoices = [
             allGroupLowShot, suitGroupThreeQuarterLeftBehindShot]
        else:
            if numThrows >= 6 and numThrows <= 8:
                shotChoices = [
                 allGroupLowShot8, suitGroupThreeQuarterLeftBehindShot8]
            else:
...
def chooseThrowCloseShot(throws, suitThrowsDict, openDuration, openName, attackDuration):
    ...
    if numSuits == 1:
        ...
        if numSuits >= 2 and numSuits <= 8 or numSuits == 0:
            shotChoices = [
             allGroupLowShot, suitGroupThreeQuarterLeftBehindShot]
        else:
            notify.error('Bad number of suits: %s' % numSuits)
...
def chooseThrowShadowShot(toon, suitThrowsDict, attackDuration):
    openShot = chooseThrowShadowOpenShot(1, suitThrowsDict, attackDuration)
    openDuration = openShot.getDuration()
    openName = openShot.getName()
...
def chooseThrowShadowOpenShot(throws, suitThrowsDict, attackDuration):
    numThrows = throws
    av = None
    duration = 3.0
    av = suitThrowsDict
...
def chooseSquirtOpenShot(squirts, suitSquirtsDict, attackDuration):
    ...
    if numSquirts == 1:
        ...
        if numSquirts >= 2 and numSquirts <= 5:
            shotChoices = [
             allGroupLowShot, suitGroupThreeQuarterLeftBehindShot]
        else:
            if numSquirts >= 6 and numSquirts <= 8:
                shotChoices = [
                 allGroupLowShot8, suitGroupThreeQuarterLeftBehindShot8]
            else:
...
def chooseDropOpenShot(drops, suitDropsDict, attackDuration):
    ...
    if numDrops == 1:
        ...
        if numDrops >= 2 and numDrops <= 5 or numDrops == 0:
            shotChoices = [
             allGroupLowShot, suitGroupThreeQuarterLeftBehindShot]
        else:
            if numDrops >= 6 and numDrops <= 8:
                shotChoices = [
                 allGroupLowShot8, suitGroupThreeQuarterLeftBehindShot8]
            else:
                                                                                                                    ...
                                                                                                                    if name == LIQUIDATE:
                                                                                                                        ...
                                                                                                                        if name == MARKET_CRASH:
                                                                                                                            ...
                                                                                                                            if name == MUMBO_JUMBO:
                                                                                                                                ...
                                                                                                                                if name == OBJECTION:
                                                                                                                                    shakeIntensity = 5.15
                                                                                                                                    camTrack.append(suitCameraShakeShot(suit, 1.0, shakeIntensity, objection=True))
                                                                                                                                else:
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    if name == FLEX:
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        if name == SONG_AND_DANCE:
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if name == SHADOW_TOON:
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                if name == CAN_ATTACK:
                                                                                                                                                                                                                                                                    camTrack.append(defaultCamera(openShotDuration=11.0))
                                                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                                                    if name == GEAR_STORM:
                                                                                                                                                                                                                                                                        camTrack.append(defaultCamera(openShotDuration=4.5))
                                                                                                                                                                                                                                                                    else:
...
def allGroupLowShot(avatar, duration):
    if avatar:
        try:
            if avatar.isBoss:
                return heldShot(0, -20, 3, 0, 0, 0, duration, 'allGroupLowShot')
        except:
            pass
...
def allGroupLowShot8(avatar, duration):
    return heldShot(20, -0.5, 3, 89, 0, 0, duration, 'allGroupLowShot8')
...
def toonGroupShot8(avatar, duration):
    return heldShot(14, 0, 10, 115, -30, 0, duration, 'toonGroupShot8')
        ...
        try:
            if avatar.isBoss:
                if random.random() > 0.5:
                    ...
                    x = -40.37
                    h = -134.61
                return heldShot(x, 43.5, 21.5, h, -22.7, 0, duration, 'suitGroupThreeQuarterLeftBehindShot')
        except:
            pass
...
def suitGroupThreeQuarterLeftBehindShot8(avatar, duration):
    if random.random() > 0.5:
        x = 14.37
        h = 134.61
    else:
        x = -14.37
        h = -134.61
    return heldShot(x, 9.5, 9.16, h, -22.7, 0, duration, 'suitGroupThreeQuarterLeftBehindShot8')
...
def suitCameraShakeShot(avatar, duration, shakeIntensity, quake=0, objection=False):
...
def avatarCloseUpThrowShot(avatar, duration):
    if avatar:
        try:
            if avatar.isBoss:
                return heldRelativeShot(avatar, 8, 21, avatar.getHeight() * 0.6, 159, -3.6, 0, duration, 'avatarCloseUpThrowShot')
        except:
            pass
...
def avatarCloseUpThreeQuarterLeftShot(avatar, duration):
    if avatar:
        try:
            if avatar.isBoss:
                return heldRelativeShot(avatar, -15.4, 15.9, avatar.getHeight() * 0.55, -131.5, 3.6, 0, duration, 'avatarCloseUpThreeQuarterLeftShot')
        except:
            pass
