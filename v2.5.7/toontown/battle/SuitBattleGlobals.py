...
def getActualFromRelativeLevel(name, relLevel):
    ...
    actualLevel = min(data['level'] + relLevel, 50)
    return actualLevel
...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, 'singularname': TTLocalizer.SuitFlunkyS, 
   ...
   'tbc': {'name': TTLocalizer.SuitTheBigCheese, 'singularname': TTLocalizer.SuitTheBigCheeseS, 
           ...
           'attacks': (
                     (
                      'CigarSmoke',
                      (10, 12, 15, 18, 20, 22, 23, 24, 25),
                      (55, 65, 75, 85, 95, 95, 95, 95, 95),
                      (20, 20, 20, 20, 20, 20, 20, 20, 20)),
                     (
                      'FloodTheMarket',
                      (14, 16, 18, 20, 22, 23, 23, 24, 24),
                     ...
                     (
                      'TeeOff',
                      (8, 11, 14, 17, 20, 21, 21, 22, 22),
                      (55, 65, 70, 75, 80, 85, 90, 90, 90),
                      (50, 50, 50, 50, 50, 50, 50, 50, 50)))}, 
   'dd': {'name': TTLocalizer.SuitDankDownsizer, 'singularname': TTLocalizer.SuitDankDownsizerS, 
          'pluralname': TTLocalizer.SuitDankDownsizerP, 
          'level': 49, 
          'hp': (2652, 2652, 2652, 2652, 2652), 
          'def': (40, 40, 40, 40, 40), 
          'freq': (100, 0, 0, 0, 0), 
          'acc': (55, 55, 55, 55, 55), 
          'attacks': (
   ...
   'mh': {'name': TTLocalizer.SuitMrHollywood, 'singularname': TTLocalizer.SuitMrHollywoodS, 
          ...
          'attacks': (
                    (
                     ...
                     (55, 65, 75, 85, 96, 98, 99, 60, 30),
                     (50, 50, 50, 50, 50, 50, 50, 50, 50)),
                    (
                     'RazzleDazzle',
                     (8, 11, 14, 17, 20, 22, 24, 26, 28),
                     (70, 75, 85, 90, 95, 95, 95, 95, 90),
                     (50, 50, 50, 50, 50, 50, 50, 50, 50)))}, 
   'sf': {'name': TTLocalizer.SuitSwagForeman, 'singularname': TTLocalizer.SuitSwagForemanS, 
   ...
   'rb': {'name': TTLocalizer.SuitRobberBaron, 'singularname': TTLocalizer.SuitRobberBaronS, 
          ...
          'attacks': (
                    (
                     'PowerTrip',
                     (11, 14, 16, 18, 21, 22, 23, 24, 24),
                     (60, 65, 70, 75, 80, 80, 80, 85, 90),
                     (50, 50, 50, 50, 50, 50, 50, 50, 50)),
                    (
                     'TeeOff',
                     (10, 12, 14, 16, 18, 19, 20, 21, 22),
                     (60, 65, 75, 85, 90, 90, 90, 90, 95),
                     (50, 50, 50, 50, 50, 50, 50, 50, 50)))}, 
   'ols': {'name': TTLocalizer.SuitBCOG, 'singularname': TTLocalizer.SuitBCOGS, 
           'pluralname': TTLocalizer.SuitBCOGP, 
           'level': 6, 
           'hp': (72, 90, 110, 132, 156), 
           'def': (30, 35, 40, 45, 50), 
           'freq': (50, 30, 10, 5, 5), 
   ...
   'm8': {'name': TTLocalizer.SuitM8, 'singularname': TTLocalizer.SuitM8S, 
          ...
          'attacks': (
                    ...
                    ('FingerWag',
                     ...
                     (80, 85, 85, 85, 90),
                     (33, 33, 33, 33, 33)))}, 
   'm9': {'name': TTLocalizer.SuitM9, 'singularname': TTLocalizer.SuitM9S, 
          'pluralname': TTLocalizer.SuitM9P, 
          'level': 8, 
          'hp': (180, 220, 264, 312, 400), 
          'def': (35, 40, 45, 50, 55), 
          'freq': (50, 30, 10, 5, 5), 
          ...
          'attacks': (
                    ...
                    ('FingerWag',
                     ...
                     (80, 85, 85, 85, 90),
                     (33, 33, 33, 33, 33)))}, 
   'mdr': {'name': TTLocalizer.SuitMolder, 'singularname': TTLocalizer.SuitMolderS, 
           'pluralname': TTLocalizer.SuitMolderP, 
           'level': 8, 
           'hp': (90, 110, 132, 156, 200, 2652), 
           'def': (35, 40, 45, 50, 55), 
           'freq': (50, 30, 10, 5, 5), 
           'acc': (35, 40, 45, 50, 55), 
           'attacks': (
                     ...
                     ('FingerWag',
                      ...
                      (80, 85, 85, 85, 90),
                      (33, 33, 33, 33, 33)))}, 
   'mtt': {'name': TTLocalizer.SuitMTT, 'singularname': TTLocalizer.SuitMTTS, 
           'pluralname': TTLocalizer.SuitMTTP, 
           'level': 8, 
           'hp': (50, 125, 313, 781, 1953), 
           'def': (35, 40, 45, 50, 55), 
           'freq': (50, 30, 10, 5, 5), 
           'acc': (35, 40, 45, 50, 55), 
           'attacks': (
                     ...
                     (
                      ...
                      (25, 30, 35, 40, 45),
                      (50, 50, 50, 50, 33)))}, 
   'sm': {'name': TTLocalizer.SuitStormish, 'singularname': TTLocalizer.SuitStormishS, 
          'pluralname': TTLocalizer.SuitStormishP, 
          'level': 8, 
          ...
          'attacks': (
                    ...
                    (
                     ...
                     (60, 70, 80, 90, 80),
                     (50, 50, 50, 50, 50)))}, 
   'sbf': {'name': TTLocalizer.SuitSteelBottomFeeder, 'singularname': TTLocalizer.SuitSteelBottomFeederS, 
           'pluralname': TTLocalizer.SuitSteelBottomFeederP, 
           'level': 8, 
           'hp': (50, 125, 313, 781, 1953), 
           'def': (35, 40, 45, 50, 55), 
           'freq': (50, 30, 10, 5, 5), 
           ...
           'attacks': (
                     ...
                     (
                      ...
                      (25, 30, 35, 40, 45),
                      (50, 50, 50, 50, 33)))}, 
   'stm': {'name': TTLocalizer.SuitSteelTelemarketer, 'singularname': TTLocalizer.SuitSteelTelemarketerS, 
           'pluralname': TTLocalizer.SuitSteelTelemarketerP, 
           'level': 8, 
           'hp': (125, 313, 781, 1953, 4883), 
           'def': (35, 40, 45, 50, 55), 
           'freq': (50, 30, 10, 5, 5), 
           'acc': (35, 40, 45, 50, 55), 
           'attacks': (
                     ...
                     (
                      ...
                      (75, 80, 85, 90, 95),
                      (40, 40, 40, 40, 40)))}, 
   'ty': {'name': TTLocalizer.SuitTheYagich, 'singularname': TTLocalizer.SuitTheYagichS, 
          'pluralname': TTLocalizer.SuitTheYagichP, 
          'level': 8, 
          'hp': (125, 313, 781, 1953, 4883), 
          'def': (35, 40, 45, 50, 55), 
          'freq': (50, 30, 10, 5, 5), 
          ...
          'attacks': (
                    ...
                    (
                     ...
                     (75, 80, 85, 90, 95),
                     (40, 40, 40, 40, 40)))}, 
   'cag': {'name': TTLocalizer.SuitCagealicous, 'singularname': TTLocalizer.SuitCagealicousS, 
           'pluralname': TTLocalizer.SuitCagealicousP, 
           'level': 8, 
           'hp': (110, 132, 156, 200, 2652), 
           'def': (40, 45, 50, 55, 70), 
           'freq': (10, 5, 5, 30, 50), 
           ...
           'attacks': (
                     ...
                     (
                      ...
                      (75, 80, 85, 95, 95),
                      (15, 15, 15, 15, 15)))}, 
   'bfs': {'name': TTLocalizer.SuitBuffShark, 'singularname': TTLocalizer.SuitBuffSharkS, 
           ...
           'attacks': (
                     ...
                     (
                      ...
                      (75, 75, 75, 75, 75),
                      (40, 43, 54, 59, 75)))}, 
   'pb': {'name': TTLocalizer.SuitPencilBreaker, 'singularname': TTLocalizer.SuitPencilBreakerS, 
          ...
          'attacks': (
                    ...
                    (
                     ...
                     (60, 75, 80, 85, 90),
                     (10, 10, 10, 10, 10)))}, 
   'sj': {'name': TTLocalizer.SuitShadowJustice, 'singularname': TTLocalizer.SuitShadowJusticeS, 
          'pluralname': TTLocalizer.SuitShadowJusticeP, 
          'level': 8, 
          'hp': (110, 132, 156, 200, 2652), 
          'def': (35, 40, 45, 50, 55), 
          'freq': (50, 30, 10, 5, 5), 
          ...
          'attacks': (
                    ...
                    (
                     ...
                     (60, 75, 80, 85, 90),
                     (50, 50, 50, 50, 50)))}, 
   'ph': {'name': TTLocalizer.SuitPineapplehead, 'singularname': TTLocalizer.SuitPineappleheadS, 
          ...
          'attacks': (
                    ...
                    (
                     ...
                     (25, 30, 35, 40, 45),
                     (50, 50, 50, 50, 33)))}, 
   'pmmh': {'name': TTLocalizer.SuitMrHollywood, 'singularname': TTLocalizer.SuitMrHollywoodS, 
            'pluralname': TTLocalizer.SuitMrHollywoodP, 
            'level': 7, 
            'hp': (90, 110, 132, 156, 200, 462, 992, 1722, 2652), 
            'def': (35, 40, 45, 50, 55, 60, 65, 70, 70), 
            ...
            'attacks': (
                      ...
                      (
                       ...
                       (30, 30, 30, 30, 30, 30, 30, 30, 30)))}, 
   'pmrb': {'name': TTLocalizer.SuitRobberBaron, 'singularname': TTLocalizer.SuitRobberBaronS, 
            'pluralname': TTLocalizer.SuitRobberBaronP, 
            'level': 7, 
            'hp': (90, 110, 132, 156, 200, 462, 992, 1722, 2652), 
            'def': (35, 40, 45, 50, 55, 60, 65, 70, 70), 
            ...
            'attacks': (
                      ...
                      (
                       ...
                       (75, 75, 75, 75, 75, 75, 75, 75, 75),
                       (30, 30, 30, 30, 30, 30, 30, 30, 30)))}, 
   'pmbw': {'name': TTLocalizer.SuitBigWig, 'singularname': TTLocalizer.SuitBigWigS, 
            'pluralname': TTLocalizer.SuitBigWigP, 
            'level': 7, 
            'hp': (90, 110, 132, 156, 200, 462, 992, 1722, 2652), 
            'def': (35, 40, 45, 50, 55, 60, 65, 70, 70), 
            ...
            'attacks': (
                      ...
                      (
                       ...
                       (80, 80, 80, 80, 80, 80, 80, 80, 80),
                       (35, 35, 35, 35, 35, 35, 35, 35, 35)))}, 
   'pmtbc': {'name': TTLocalizer.SuitTheBigCheese, 'singularname': TTLocalizer.SuitTheBigCheeseS, 
             'pluralname': TTLocalizer.SuitTheBigCheeseP, 
             'level': 7, 
             'hp': (90, 110, 132, 156, 200, 462, 992, 1722, 2652), 
             'def': (35, 40, 45, 50, 55, 60, 65, 70, 70), 
             ...
             'attacks': (
                       ...
                       (
                        ...
                        (70, 70, 70, 70, 70, 70, 70, 70, 70),
                        (30, 30, 30, 30, 30, 30, 30, 30, 30)))}, 
   'fts': {'name': TTLocalizer.SuitFeathers, 'singularname': TTLocalizer.SuitFeathersS, 
           'pluralname': TTLocalizer.SuitFeathersP, 
           'level': 6, 
           'hp': (72, 90, 110, 132, 156), 
           'def': (30, 35, 40, 45, 50), 
           'freq': (50, 30, 10, 5, 5), 
           ...
           'attacks': (
                     ...
                     (
                      ...
                      (70, 75, 80, 85, 95),
                      (30, 30, 30, 30, 30)))}, 
   'ctn': {'name': TTLocalizer.SuitCaptain, 'singularname': TTLocalizer.SuitCaptainS, 
           'pluralname': TTLocalizer.SuitCaptainP, 
           'level': 8, 
           'hp': (110, 132, 156, 200, 2652), 
           'def': (40, 45, 50, 55, 70), 
           'freq': (30, 10, 5, 5, 0), 
...
OBJECTION = SuitAttacks.keys().index('Objection')
...
PUSH_SWITCH = SuitAttacks.keys().index('PushSwitch')
SHADOW_TOON = SuitAttacks.keys().index('ShadowToon')
BOSS_JUMP = SuitAttacks.keys().index('BossJump')
GEAR_THROW = SuitAttacks.keys().index('GearThrow')
GEAR_STORM = SuitAttacks.keys().index('GearStorm')
CAN_ATTACK = SuitAttacks.keys().index('CanAttack')
SAFE_THROW = SuitAttacks.keys().index('SafeThrow')
CASH_TORNADO = SuitAttacks.keys().index('CashTornado')
GAVEL = SuitAttacks.keys().index('Gavel')
BOOKSHELF = SuitAttacks.keys().index('Bookshelf')
FORE = SuitAttacks.keys().index('Fore')
BOSS_DEMOTION = SuitAttacks.keys().index('BossDemotion')
REORGANIZE = SuitAttacks.keys().index('Reorganize')
