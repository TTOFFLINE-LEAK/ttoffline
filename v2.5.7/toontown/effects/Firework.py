    ...
    def generateFireworkIval(self):
        if not self.fireworkIval:
            ...
            if self.typeId == FireworkType.BasicPeony:
                ...
                if self.typeId == FireworkType.AdvancedPeony:
                    ...
                    if self.typeId == FireworkType.DiademPeony:
                        ...
                        if self.typeId == FireworkType.Chrysanthemum:
                            ...
                            if self.typeId == FireworkType.DiademChrysanthemum:
                                ...
                                if self.typeId == FireworkType.Ring:
                                    ...
                                    if self.typeId == FireworkType.Saturn:
                                        ...
                                        if self.typeId == FireworkType.Bees:
                                            ...
                                            if self.typeId == FireworkType.TrailBurst:
                                                ...
                                                if self.typeId == FireworkType.GlowFlare:
                                                    ...
                                                    if self.typeId == FireworkType.PalmTree:
                                                        ...
                                                        if self.typeId == FireworkType.Mickey:
                                                            ...
                                                            if self.typeId == FireworkType.PirateSkull:
                                                                ...
                                                                if self.typeId == FireworkType.AmericanFlag:
                                                                    fireworkParallel = Parallel()
                                                                    ...
                                                                    if self.typeId == FireworkType.IceCream:
