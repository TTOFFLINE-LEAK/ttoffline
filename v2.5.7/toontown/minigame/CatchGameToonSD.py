...
class CatchGameToonSD(StateData.StateData):
    ...
    def enterFallBack(self):
        ...
        if self.toon.isDisguised:
            self.fallBackIval = Sequence(ActorInterval(self.toon.suit, animName, startTime=startFrame / newRate, endTime=totalFrames / newRate, playRate=playRate), FunctionInterval(resume))
    ...
    def enterFallForward(self):
        ...
        if self.toon.isDisguised:
            self.fallFwdIval = Sequence(ActorInterval(self.toon.suit, animName, startTime=startFrame / newRate, endTime=totalFrames / newRate, playRate=playRate), FunctionInterval(resume))
