...
AREA_DATA[ToontownGlobals.ToontownCentral]['DNA_TRIO'] = ('phase_4/dna/storage_TT_sz.jazz',
                                                          'phase_4/dna/storage_TT.jazz',
                                                          'phase_4/dna/toontown_central_sz.jazz')
...
AREA_DATA[ToontownGlobals.DonaldsDock]['DNA_TRIO'] = ('phase_6/dna/storage_DD_sz.jazz',
                                                      'phase_6/dna/storage_DD.jazz',
                                                      'phase_6/dna/donalds_dock_sz.jazz')
...
AREA_DATA[ToontownGlobals.DaisyGardens]['DNA_TRIO'] = ('phase_8/dna/storage_DG_sz.jazz',
                                                       'phase_8/dna/storage_DG.jazz',
                                                       'phase_8/dna/daisys_garden_sz.jazz')
...
AREA_DATA[ToontownGlobals.MinniesMelodyland]['DNA_TRIO'] = ('phase_6/dna/storage_MM_sz.jazz',
                                                            'phase_6/dna/storage_MM.jazz',
                                                            'phase_6/dna/minnies_melody_land_sz.jazz')
...
AREA_DATA[ToontownGlobals.TheBrrrgh]['DNA_TRIO'] = ('phase_8/dna/storage_BR_sz.jazz',
                                                    'phase_8/dna/storage_BR.jazz',
                                                    'phase_8/dna/the_burrrgh_sz.jazz')
...
AREA_DATA[ToontownGlobals.TheBrrrgh]['ANIMATIONS'] = ([('wave', 2.0), (None, 1.0)],
 [('applause', 2.0),
  ('slip-forward', 2.0),
  (None, 1.0),
  (None, 1.0)],
...
AREA_DATA[ToontownGlobals.DonaldsDreamland]['DNA_TRIO'] = ('phase_8/dna/storage_DL_sz.jazz',
                                                           'phase_8/dna/storage_DL.jazz',
                                                           'phase_8/dna/donalds_dreamland_sz.jazz')
...
AREA_DATA[ToontownGlobals.DonaldsDreamland]['ANIMATIONS'] = ([('wave', 2.0), (None, 1.0)],
 [('applause', 2.0),
  ('jump', 2.0),
  ('slip-forward', 2.0),
  (None, 1.0),
