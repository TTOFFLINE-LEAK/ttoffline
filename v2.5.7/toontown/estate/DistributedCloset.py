...
class DistributedCloset(DistributedFurnitureItem.DistributedFurnitureItem):
    ...
    def load(self):
        ...
        self.freakSeq = Sequence(Func(self.nakedLabel.show), SoundInterval(loader.loadSfx('phase_9/audio/sfx/CHQ_GOON_tractor_beam_alarmed.ogg')), Func(self.nakedLabel.hide))
