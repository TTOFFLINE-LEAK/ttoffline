...
WATERING_CAN_HUGE = 3
MAX_WATERING_CANS = 4
WateringCanAttributes = {0: {'numBoxes': 2, 'skillPts': 100, 
       'name': TTLocalizer.WateringCanSmall}, 
   1: {'numBoxes': 2, 'skillPts': 200, 
       'name': TTLocalizer.WateringCanMedium}, 
   2: {'numBoxes': 2, 'skillPts': 400, 
       'name': TTLocalizer.WateringCanLarge}, 
   3: {'numBoxes': 2, 'skillPts': 1000, 
...
PlantAttributes = {49: {'name': TTLocalizer.FlowerSpeciesNames[49], 'plantType': FLOWER_TYPE, 
        ...
        'varieties': (
                    ...
                    (
                     17, FLOWER_VIOLET, 8))}, 
   50: {'name': TTLocalizer.FlowerSpeciesNames[50], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -2, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    (
                     20, FLOWER_VIOLET, 5), (21, FLOWER_RED, 6), (22, FLOWER_YELLOW, 8))}, 
   51: {'name': TTLocalizer.FlowerSpeciesNames[51], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -2, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    ...
                    (
                     34, FLOWER_GREEN, 7))}, 
   52: {'name': TTLocalizer.FlowerSpeciesNames[52], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -2, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    ...
                    (
                     47, FLOWER_YELLOW, 8))}, 
   53: {'name': TTLocalizer.FlowerSpeciesNames[53], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -2, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    ...
                    (
                     53, FLOWER_PINK, 5))}, 
   54: {'name': TTLocalizer.FlowerSpeciesNames[54], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -2, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    ...
                    (
                     64, FLOWER_PINK, 6))}, 
   55: {'name': TTLocalizer.FlowerSpeciesNames[55], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -2, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    (
                     70, FLOWER_BLUE, 7), (71, FLOWER_PINK, 8))}, 
   56: {'name': TTLocalizer.FlowerSpeciesNames[56], 'plantType': FLOWER_TYPE, 
        'growthThresholds': (1, 1, 1), 
        'maxWaterLevel': getMaxWateringCanPower(), 
        'minWaterLevel': -1, 
        'seedlingModel': 'phase_5.5/models/estate/seedling', 
        ...
        'varieties': (
                    ...
                    (
                     4, FLOWER_BLUE, 8))}, 
   200: {'name': TTLocalizer.StatuaryDonald, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_donald', 
         'worldScale': 0.05, 
         'varieties': ((1000, 1, 0), ), 
         'pinballScore': (10, 1)}, 
   201: {'name': TTLocalizer.StatuaryMickey1, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_mickey_flute', 
         'worldScale': 0.05, 
         'varieties': ((1001, 1, 0), ), 
         'pinballScore': (50, 1)}, 
   202: {'name': TTLocalizer.StatuaryGardenAccelerator, 'plantType': STATUARY_TYPE, 
         'model': 'phase_4/models/props/goofy_statue', 
         'varieties': ((1002, 1, 0), )}, 
   203: {'name': TTLocalizer.StatuaryMinnie, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_minnie', 
         'worldScale': 0.05, 
         'varieties': ((1003, 1, 0), ), 
         'pinballScore': (150, 1)}, 
   204: {'name': TTLocalizer.StatuaryMickey2, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_mickey_shovel', 
         'worldScale': 0.05, 
         'varieties': ((1004, 1, 0), ), 
         'pinballScore': (250, 1)}, 
   205: {'name': TTLocalizer.StatuaryToonWave, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_pedestal', 
         'worldScale': 0.05, 
         'varieties': ((1005, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   206: {'name': TTLocalizer.StatuaryToonVictory, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_pedestal', 
         'worldScale': 0.05, 
         'varieties': ((1006, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   207: {'name': TTLocalizer.StatuaryToonCrossedArms, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_pedestal', 
         'worldScale': 0.05, 
         'varieties': ((1007, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   208: {'name': TTLocalizer.StatuaryToonThinking, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_pedestal', 
         'worldScale': 0.05, 
         'varieties': ((1008, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   210: {'name': TTLocalizer.StatuaryLeakingFountain, 'plantType': STATUARY_TYPE, 
         'model': 'phase_14/models/estate/flippywhiz', 
         'worldScale': 1.0, 
         'varieties': ((1010, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   230: {'name': TTLocalizer.StatuaryMeltingSnowman, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/tt_m_prp_ext_snowman', 
         'worldScale': 1.0, 
         'varieties': ((1030, 1, 0), ), 
         'pinballScore': (500, 1), 
         'growthThresholds': (1, 2)}, 
   231: {'name': TTLocalizer.StatuaryMeltingSnowDoodle, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/tt_m_prp_ext_snowDoodle', 
         'worldScale': 1.0, 
         'varieties': ((1031, 1, 0), ), 
         'pinballScore': (500, 1), 
         'growthThresholds': (1, 2)}, 
   234: {'name': TTLocalizer.AnimatedStatuaryFlappyCog, 'plantType': STATUARY_TYPE, 
         ...
         'varieties': ((1035, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   254: {'name': 'reserved tag', 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_minnie', 
         'worldScale': 0.05, 
         'varieties': ((2001, 1, 0), ), 
         'pinballScore': (15, 1)}, 
   255: {'name': 'reserved tag', 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/garden_minnie', 
         'worldScale': 0.05, 
         'varieties': ((2002, 1, 0), ), 
         'pinballScore': (15, 1)}}
...
for i in range(NUM_GAGS):
    ...
    attr = {'name': name, 'plantType': GAG_TREE_TYPE, 'growthThresholds': (
...
Recipes = {0: {'beans': 'RRR', 'special': -1}, 
   ...
   1010: {'beans': 'SBSBVOC', 'special': 110}, 
...
SHOVEL_GOLD = 3
MAX_SHOVELS = 4
ShovelAttributes = {0: {'numBoxes': 2, 'skillPts': 80, 
       'name': TTLocalizer.ShovelTin}, 
   1: {'numBoxes': 2, 'skillPts': 160, 
       'name': TTLocalizer.ShovelSteel}, 
   2: {'numBoxes': 2, 'skillPts': 320, 
       'name': TTLocalizer.ShovelSilver}, 
   3: {'numBoxes': 2, 'skillPts': 640, 
...
BOX_TWO = 2
BOX_THREE = 3
FLOWER_POS = (None, (0, ), (-1.5, 1.5), (-3.4, 0, 3.5))
standardFlowerBoxes = (
 (
...
rusticFlowerBoxes = (
 (
  16.708, -6.903, -90, BOX_ONE),
 (
  16.708, 6.325, -90, BOX_ONE),
 (
...
estateBoxes = {0: standardFlowerBoxes, 1: tikiFlowerBoxes, 
   2: teepeeFlowerBoxes, 
   3: castleFlowerBoxes, 
   4: standardFlowerBoxes, 
   5: rusticFlowerBoxes}
...
Specials = {0: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 1, 
       ...
       'beanCost': 125}, 
   1: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 2, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       ...
       'beanCost': 125}, 
   2: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 1, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       'photoName': TTLocalizer.GardenTextMagicBeans, 
       'description': TTLocalizer.GardenSpecialDiscription, 
       'beanCost': 125}, 
   3: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 2, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       'photoName': TTLocalizer.GardenTextMagicBeansB, 
       'description': TTLocalizer.GardenSpecialDiscriptionB, 
       'beanCost': 125}, 
   4: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 1, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       'photoName': TTLocalizer.GardenTextMagicBeans, 
       'description': TTLocalizer.GardenSpecialDiscription, 
       'beanCost': 125}, 
   5: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 2, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       'photoName': TTLocalizer.GardenTextMagicBeansB, 
       'description': TTLocalizer.GardenSpecialDiscriptionB, 
       'beanCost': 125}, 
   6: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 2, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       'photoName': TTLocalizer.GardenTextMagicBeansB, 
       'description': TTLocalizer.GardenSpecialDiscription, 
       'beanCost': 125}, 
   7: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 2, 
       'photoModel': 'phase_4/models/props/goofy_statue', 
       'photoScale': 0.1, 
       'photoPos': (0, 0, -1), 
       'photoName': TTLocalizer.GardenTextMagicBeansB, 
       'description': TTLocalizer.GardenSpecialDiscriptionB, 
       'beanCost': 125}, 
   100: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_donald', 
         'photoScale': 0.04, 
         'photoPos': (0, 0, -1), 
         ...
         'isCatalog': True, 
         'beanCost': 125}, 
   101: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_mickey_flute', 
         'photoScale': 0.025, 
         'photoPos': (0, 0, -1.05), 
         ...
         'isCatalog': True, 
         'beanCost': 250}, 
   102: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/sack', 
         'photoScale': 1.0, 
         'photoPos': (0, 0, -1.0), 
   ...
   103: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_minnie', 
         'photoScale': 0.02, 
         'photoPos': (0, 0, -1.05), 
         ...
         'isCatalog': True, 
         'beanCost': 500}, 
   104: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_mickey_shovel', 
         'photoScale': 0.02, 
         'photoPos': (0, 0, -1.05), 
         ...
         'isCatalog': True, 
         'beanCost': 1000}, 
   105: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_pedestal', 
         'photoScale': 0.02, 
         'photoPos': (0, 0, -1.05), 
         ...
         'beanCost': 5000, 
         'minSkill': 639}, 
   106: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_pedestal', 
         'photoScale': 0.02, 
         'photoPos': (0, 0, -1.05), 
         ...
         'beanCost': 5000, 
         'minSkill': 639}, 
   107: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_pedestal', 
         'photoScale': 0.02, 
         'photoPos': (0, 0, -1.05), 
         ...
         'beanCost': 5000, 
         'minSkill': 639}, 
   108: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_pedestal', 
         'photoScale': 0.02, 
         'photoPos': (0, 0, -1.05), 
         ...
         'beanCost': 5000, 
         'minSkill': 639}, 
   130: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/tt_m_prp_ext_snowman_icon', 
         'photoScale': 90.0, 
         'photoPos': (0, 0, 0.0), 
         ...
         'beanCost': 25, 
         'minSkill': 0}, 
   131: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/tt_m_prp_ext_snowDoodle_icon', 
         'photoScale': 90.0, 
         'photoPos': (0, 0, 0.0), 
         ...
         'beanCost': 50, 
         'minSkill': 0}, 
   135: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/tt_a_ara_pty_tubeCogVictory_', 
         'photoAnimation': [
                          'default', 'wave'], 
         'photoScale': 1.25, 
         'photoPos': (0, 0, -0.04), 
         ...
         'beanCost': 50, 
         'minSkill': 1}, 
   110: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_14/models/estate/flippywhiz', 
         'photoScale': 0.35, 
         'photoPos': (0, 0, -1.05), 
         'photoName': TTLocalizer.StatuaryLeakingFountain, 
         'description': TTLocalizer.GardenSpecialDiscription, 
         'isCatalog': True, 
         'beanCost': 750}}
...
TrophyDict = {0: (TTLocalizer.GardenTrophyNameDict[0],), 1: (
     TTLocalizer.GardenTrophyNameDict[1],), 
   2: (
     TTLocalizer.GardenTrophyNameDict[2],), 
   3: (
     TTLocalizer.GardenTrophyNameDict[3],)}