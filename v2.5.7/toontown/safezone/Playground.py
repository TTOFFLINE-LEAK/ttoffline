...
class Playground(Place.Place):
    ...
    def load(self):
        ...
        self.pumpkin3 = None
        self.pumpkin4 = None
        self.pumpkintall1 = None
        self.pumpkintall2 = None
        self.pumpkintall3 = None
        self.pumpkintall4 = None
        self.pumpkinloop = Sequence()
        self.pumpkinloop2 = Sequence()
        self.pumpkinloop3 = Sequence()
        self.pumpkinloop4 = Sequence()
        self.pumpkinloop5 = Sequence()
        self.pumpkinloop6 = Sequence()
        self.pumpkinloop7 = Sequence()
        self.pumpkinloop8 = Sequence()
        self.pumpkinList = None
        self.propNode = render.attachNewNode('currentPropNode')
    ...
    def preparePumpkins(self, list):
        for l in list:
            l[0].generatePumpkin()
            l[0].reparentTo(render)
            l[0].setPos(l[1], l[2], l[3])
            l[0].setH(l[4])
            l[0].loop('neutral')
            one = 1
            l[0].setScale(one)
            appendment = l[0].getAnim(l[6])
            l[5].append(appendment)
            l[5].loop()
    ...
    def enterTeleportIn(self, requestStatus):
        ...
        if self.dialog:
            ...
            if base.localAvatar.hp < 1:
                if base.localAvatar.zoneId == 14000:
                ...
                if base.cr.currentEpisode == 'gyro_tale':
                    ...
                    if base.localAvatar.hp > 0 and (Quests.avatarHasTrolleyQuest(base.localAvatar) or Quests.avatarHasFirstCogQuest(base.localAvatar) or Quests.avatarHasFriendQuest(base.localAvatar) or Quests.avatarHasPhoneQuest(base.localAvatar) and Quests.avatarHasCompletedPhoneQuest(base.localAvatar)) and self.loader.hood.id == ToontownGlobals.ToontownCentral:
                        requestStatus['nextState'] = 'popup'
                        ...
                        if base.localAvatar.quests[0][0] == Quests.TROLLEY_QUEST_ID:
                            ...
                            if base.localAvatar.quests[0][0] == Quests.FIRST_COG_QUEST_ID:
                                ...
                                if base.localAvatar.quests[0][0] == Quests.FRIEND_QUEST_ID:
                                    ...
                                    if base.localAvatar.quests[0][0] == Quests.PHONE_QUEST_ID:
