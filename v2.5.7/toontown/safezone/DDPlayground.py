...
class DDPlayground(Playground.Playground):
    ...
    def load(self):
        ...
        if base.cr.newsManager.isHolidayRunning(ToontownGlobals.TRICK_OR_TREAT) or base.cr.newsManager.isHolidayRunning(ToontownGlobals.HALLOWEEN_PROPS) or base.cr.newsManager.isHolidayRunning(ToontownGlobals.HALLOWEEN):
            ...
            self.pumpkinList = [
             [
              self.pumpkin2, -1.045, -73.028, 7.931, -46, self.pumpkinloop2, 1],
             [
              self.pumpkin3, -98.412, -8.598, -12.308, -271, self.pumpkinloop3, 2],
             [
              self.pumpkintall1, -25.558, 2.597, 5.763, -52, self.pumpkinloop4, 0],
             [
              self.pumpkintall2, 23.687, 19.331, -12.308, -39, self.pumpkinloop5, 1],
             [
              self.pumpkintall3, -17.41, 127.654, -12.308, -19, self.pumpkinloop6, 2]]
