...
class DistributedButterfly(DistributedObject.DistributedObject):
    ...
    paleYellowColors = (Vec4(0.8, 0, 0.8, 1),
     ...
     Vec4(0.9, 0.6, 0.9, 1),
     Vec4(1, 0.6, 0.9, 1))
    halloweenColors = (Vec4(0, 0, 0, 0.75),
     Vec4(0, 0, 0, 0.75),
     Vec4(0, 0, 0, 0.75),
     Vec4(0, 0, 0, 0.75),
     Vec4(0, 0, 0, 0.75),
    ...
    def generate(self):
        ...
        self.butterfly.setBlend(frameBlend=config.GetBool('interpolate-animations', True))
        ...
        for type in self.wingTypes:
            ...
            if type != chosenType:
                ...
                if base.cr.isHalloween:
                    color = self.halloweenColors[(self.doId % len(self.halloweenColors))]
                else:
