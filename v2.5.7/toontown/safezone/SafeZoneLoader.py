...
class SafeZoneLoader(StateData.StateData):
    ...
    def load(self):
        ...
        if base.cr.newsManager.isHolidayRunning(TRICK_OR_TREAT) or base.cr.newsManager.isHolidayRunning(HALLOWEEN_PROPS) or base.cr.newsManager.isHolidayRunning(HALLOWEEN):
            if not (base.localAvatar.zoneId == ToontownGlobals.OldDaisyGardens or base.localAvatar.zoneId == ToontownGlobals.ScroogeBank or base.localAvatar.zoneId == '21834' or base.localAvatar.zoneId == ToontownGlobals.OldOakStreet):
