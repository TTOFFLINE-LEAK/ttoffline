...
class OZSafeZoneLoader(SafeZoneLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.dnaFile = 'phase_6/dna/outdoor_zone_sz.jazz'
        self.safeZoneStorageDNAFile = 'phase_6/dna/storage_OZ_sz.jazz'
        self.__toonTracks = {}
        del self.fsm
    ...
    def unload(self):
        ...
        if self.geyserTrack:
            ...
            self.geyserTrack = None
            del self.geyserTrack
        if self.geyserActor is not None:
            self.geyserActor.cleanup()
            self.geyserActor = None
            del self.geyserActor
        if self.geyserModel is not None:
            self.geyserModel.removeNode()
            self.geyserModel = None
            del self.geyserModel
        if self.waterfallActor is not None:
            self.waterfallActor.cleanup()
            self.waterfallActor = None
            del self.waterfallActor
        if self.waterfallModel is not None:
            self.waterfallModel.removeNode()
            self.waterfallModel = None
            del self.waterfallModel
