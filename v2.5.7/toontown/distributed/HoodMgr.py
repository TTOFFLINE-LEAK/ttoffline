...
class HoodMgr(DirectObject.DirectObject):
    ...
    dropPoints = {ToontownGlobals.DonaldsDock: (
       ...
       ToontownGlobals.ToonFest: (
                                [
                                 54.0, -191.0, 10.95, -95.0, 0.0, 0.0],
                                [
                                 268.0, -289.0, 28.474, -10.0, 0.0, 0.0],
                                [
                                 56.0, -351.0, 8.33, -50.0, 0.0, 0.0],
                                [
                                 170.0, -173.0, 4.597, -30.0, 0.0, 0.0],
                                [
                                 123.0, -4.0, 4.597, -123.0, 0.0, 0.0],
                                [
                                 44.0, 108.0, 35.503, 210.0, 0.0, 0.0],
                                [
                                 358.0, 43.0, 9.632, -220.0, 0.0, 0.0],
                                [
                                 395.0, -248.0, 9.864, 105.0, 0.0, 0.0],
                                [
                                 307.0, -503.0, 0.932, 100.0, 0.0, 0.0]), 
       ...
       ToontownGlobals.BossbotHQ: (
                                 [
                                  142.173, -30.277, -1.726, -304, 0, 0],
                                 [
                                  109, 54, -1.726, -252, 0, 0],
                                 [
                                  21.412, 11.274, -1.726, -9, 0, 0],
                                 [
                                  65, -99, -1.726, 387, 0, 0],
                                 [
                                  -8, -47, -1.726, 328, 0, 0],
