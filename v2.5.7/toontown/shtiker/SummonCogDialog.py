...
class SummonCogDialog(DirectFrame, StateData.StateData):
    ...
    def __init__(self, suitIndex):
                                                                                                                                  ...
                                                                                                                                  0.7), image_pos=(0,
                                                                                                                                                   ...
                                                                                                                                                   0.18), image_color=ToontownGlobals.GlobalDialogColor, text=TTL.SummonDlgTitle, text_scale=0.12, text_pos=(0,
                                                                                                                                                                                                                                                             0.4), borderWidth=(0.01,
                                                                                                                                                                                                                                                                                0.01), sortOrder=DGG.NO_FADE_SORT_INDEX)
        ...
        currentKnown = base.localAvatar.cogCounts[self.suitIndex] != 0
        self.suitFullName = SuitBattleGlobals.SuitAttributes[self.suitName]['name'] if currentKnown else TTL.SuitPageMystery
        return
    ...
    def issueSummons(self, summonsType):
        if summonsType == 'single':
            ...
            if summonsType == 'building':
                text = TTL.SummonDlgBuildingConf
            else:
                if summonsType == 'invasion':
