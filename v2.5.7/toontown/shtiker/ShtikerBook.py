...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def __init__(self, doneEvent):
        ...
        self.pageOrder = [TTLocalizer.OptionsPageTitle,
         TTLocalizer.ShardPageTitle if not __debug__ else TTLocalizer.ServerPageTitle,
                    ...
                    if pageName == TTLocalizer.InventoryPageTitle:
                        ...
                        if pageName == TTLocalizer.QuestPageToonTasks:
                            ...
                            if pageName == TTLocalizer.TrackPageShortTitle:
                                ...
                                if pageName == TTLocalizer.WordPageTitle:
                                    iconModels = loader.loadModel('phase_3.5/models/gui/sos_textures')
                                                        ...
                                                        if pageName == TTLocalizer.KartPageTitle:
                                                            ...
                                                            if pageName == TTLocalizer.GolfPageTitle:
                                                                ...
                                                                if pageName == TTLocalizer.EventsPageName:
                                                                    ...
                                                                    if pageName == TTLocalizer.PhotoPageTitle:
    ...
    def __pageDone(self, serverList=None):
        ...
        if pageDoneStatus:
            if pageDoneStatus['mode'] == 'close':
                ...
                messenger.send(self.doneEvent, [serverList])
