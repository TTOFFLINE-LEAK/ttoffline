...
class KartPage(ShtikerPage):
    ...
    def load(self):
        ...
        self.customizeTab = DirectButton(parent=self, relief=None, text=TTLocalizer.KartPageCustomizeTab, text_scale=TTLocalizer.KPkartTab, text_align=TextNode.ALeft, text_pos=(-0.025,
                                                                                                                                                                                 0.0,
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                             -90), image_scale=(0.033,
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                0.035), image_color=normalColor, image1_color=clickColor, image2_color=rolloverColor, image3_color=diabledColor, text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode, extraArgs=[PageMode.Customize], pos=(0.92,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          0.55))
        self.recordsTab = DirectButton(parent=self, relief=None, text=TTLocalizer.KartPageRecordsTab, text_scale=TTLocalizer.KPkartTab, text_align=TextNode.ALeft, image=gui.find('**/tabs/polySurface2'), image_pos=(0.12,
                                                                                                                                                                                                                      1,
                                                                                                                                                                                                                      -0.91), image_hpr=(0,
                                                                                                                                                                                                                                         0,
                                                                                                                                                                                                                                         -90), image_scale=(0.033,
        ...
        self.trophyTab = DirectButton(parent=self, relief=None, text=TTLocalizer.KartPageTrophyTab, text_scale=TTLocalizer.KPkartTab, text_pos=(0.03,
                                                                                                                                                0.0,
                                                                                                                                                0.0), text_align=TextNode.ALeft, image=gui.find('**/tabs/polySurface3'), image_pos=(-0.28,
                                                                                                                                                                                                                                    1,
                                                                                                                                                                                                                                    -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                       0,
                                                                                                                                                                                                                                                       -90), image_scale=(0.033,
                                                                                                                                                                                                                                                                          0.033,
                                                                                                                                                                                                                                                                          0.035), image_color=normalColor, image1_color=clickColor, image2_color=rolloverColor, image3_color=diabledColor, text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode, extraArgs=[PageMode.Trophy], pos=(0.92,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 -0.3))
...
class KartCustomizeUI(DirectFrame):
    ...
    def destroy(self):
        ...
        self.rideKartButton.destroy()
        del self.avatar
        del self.itemSelector
        del self.kartViewer
        del self.rideKartButton
    ...
    def load(self):
        ...
        self.rideKartButton = DirectButton(parent=self, relief=None, image=(
         guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=(0.7,
                                                                                                                            1,
                                                                                                                            1), text='Ride Kart', text_scale=0.052, text_pos=(0,
                                                                                                                                                                              -0.02), pos=(0.5,
                                                                                                                                                                                           0.0,
                                                                                                                                                                                           -0.4), command=self.rideKart)
    ...
    def hide(self):
        ...
        if hasattr(self, 'rideKartButton'):
            self.rideKartButton.hide()
        DirectFrame.hide(self)

    def rideKart(self):
        self.notify.warning('Implement kart riding functionality here')
...
class RacingTrophiesUI(DirectFrame):
    ...
    def load(self):
        ...
        self.ticketDisplay = DirectLabel(parent=self, relief=None, image=loader.loadModel('phase_6/models/karting/tickets'), image_pos=(0.2,
                                                                                                                                        0,
                                                                                                                                        -0.635), image_scale=0.2, text=TTLocalizer.KartPageTickets + str(self.avatar.getTickets()), text_scale=0.07, text_fg=(0,
                                                                                                                                                                                                                                                              0,
                                                                                                                                                                                                                                                              0.95,
                                                                                                                                                                                                                                                              1.0), text_pos=(0,
                                                                                                                                                                                                                                                                              -0.65), text_font=ToontownGlobals.getSignFont())
        ...
        def load(self, uiRootNode):
            ...
            self.uiTextBox = DirectFrame(parent=self, relief=None, scale=1.0, text='', text_font=ToontownGlobals.getInterfaceFont(), text_fg=(0.5,
                                                                                                                                              ...
                                                                                                                                              1), text_shadow=(0,
                                                                                                                                                               0,
                                                                                                                                                               0,
                                                                                                                                                               1), text_scale=0.0715, text_pos=(0.0,
                                                                                                                                                                                                -0.23,
                                                                                                                                                                                                0.0))
            self.deleteButton = DirectButton(parent=self, relief=None, geom=(uiRootNode.find('**/uiAccessorydelete_up'),
             ...
             uiRootNode.find('**/uiAccessorydelete_rollover')), text=TTLocalizer.KartShtikerDelete, text_font=ToontownGlobals.getSignFont(), text_pos=(0,
                                                                                                                                                       -0.125,
                                                                                                                                                       0), text_scale=TTLocalizer.KPdeleteButton, text_fg=(1,
                                                                                                                                                                                                           1,
                                                                                                                                                                                                           1,
 ...
 (0, 0)], rotatePos=(0, 0)):
        ...
        if leftArrow and len(leftArrow) == 5:
            self.uiRotateLeft = DirectButton(parent=self, relief=None, geom=(uiRootNode.find('**/' + leftArrow[0]),
             ...
             uiRootNode.find('**/' + leftArrow[3])), scale=1.0, text=TTLocalizer.KartView_Left, text_scale=TTLocalizer.KProtateButton, text_pos=(leftArrow[4][0], leftArrow[4][1], 0), text_fg=(1,
                                                                                                                                                                                                1,
                                                                                                                                                                                                1,
                                                                                                                                                                                                1.0), text_shadow=(0,
                                                                                                                                                                                                                   0,
        ...
        if rightArrow and len(rightArrow) == 5:
            self.uiRotateRight = DirectButton(parent=self, relief=None, geom=(uiRootNode.find('**/' + rightArrow[0]),
             ...
             uiRootNode.find('**/' + rightArrow[3])), scale=1.0, text=TTLocalizer.KartView_Right, text_scale=TTLocalizer.KProtateButton, text_pos=(rightArrow[4][0], rightArrow[4][1], 0), text_fg=(1,
                                                                                                                                                                                                    1,
                                                                                                                                                                                                    1,
                                                                                                                                                                                                    1.0), text_shadow=(0,
                                                                                                                                                                                                                       0,
