        ...
        if self.mode == GardenPage_Collection:
            ...
            if self.mode == GardenPage_Basket:
                ...
                if self.mode == GardenPage_Trophy:
                    ...
                    if self.mode == GardenPage_Specials:
                        self.createGardenSpecialsList()
