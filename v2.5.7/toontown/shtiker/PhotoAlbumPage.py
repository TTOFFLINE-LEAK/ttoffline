...
class PhotoAlbumPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.renamePanel = DirectFrame(parent=self, relief=None, pos=(0.45, 0, -0.45), image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.0,
                                                                                                                                                                                     ...
                                                                                                                                                                                     0.6), text=TTLocalizer.PhotoPageAddNamePanel, text_scale=0.06, text_pos=(0.0,
                                                                                                                                                                                                                                                              0.13), sortOrder=DGG.NO_FADE_SORT_INDEX)
    ...
    def deleteConfirm(self):
        if self.photoPath and self.selectedFileName:
            if os.path.isfile(self.photoPath + self.selectedFileName):
            ...
            self.deleteCancel()
            self.errorPanel['text'] = 'Huh. A really bad bug happened, but the game prevented you from crashing.'
            self.errorPanel.show()
            self.updateScrollList()
        return
