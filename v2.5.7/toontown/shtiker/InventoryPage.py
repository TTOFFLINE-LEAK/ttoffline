...
class InventoryPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.moneyDisplay = DirectLabel(parent=self, relief=None, pos=(0.45, 0, -0.5), scale=0.8, text=str(base.localAvatar.getMoney()), text_scale=0.18, text_fg=(0.95,
                                                                                                                                                                   0.95,
                                                                                                                                                                   0,
                                                                                                                                                                   1), text_shadow=(0,
                                                                                                                                                                                    0,
        ...
        secondJarGui = hidden.attachNewNode(cm.generate())
        secondJarGui.setTransparency(1)
        tex = loader.loadTexture('phase_6/maps/ttr_t_tf_gui_tokenJar.jpg', 'phase_6/maps/ttr_t_tf_gui_tokenJar_a.rgb')
        secondJarGui.setTexture(tex, 1)
        self.tokensDisplay = DirectLabel(parent=self, relief=None, pos=(0.75, 0, -0.5), scale=0.25, text=str(base.localAvatar.getTokens()), text_scale=0.36, text_fg=(0.95,
                                                                                                                                                                      0.95,
                                                                                                                                                                      0,
                                                                                                                                                                      1), text_shadow=(0,
                                                                                                                                                                                       0,
                                                                                                                                                                                       ...
                                                                                                                                                                                       1), text_pos=(-0.05,
                                                                                                                                                                                                     -0.2,
                                                                                                                                                                                                     0), image=secondJarGui, text_font=ToontownGlobals.getSignFont())
        jarGui.removeNode()
        secondJarGui.removeNode()
        cm = None
        return
    ...
    def __tokensChange(self, tokens):
        self.tokensDisplay['text'] = str(tokens)
    ...
    def enter(self):
        ...
        self.tokensDisplay['text'] = str(base.localAvatar.getTokens())
        ...
        self.accept(localAvatar.uniqueName('tokensChange'), self.__tokensChange)
    ...
    def exit(self):
        ...
        self.ignore(localAvatar.uniqueName('tokensChange'))
