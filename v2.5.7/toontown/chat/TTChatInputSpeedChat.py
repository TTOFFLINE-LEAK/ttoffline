...
ceoMenuStructure = [2300,
 ...
 2316,
 2317]
fourBossMenuStructure = [
 [OTPLocalizer.SCMenuFourBossBattleVP,
  2400,
  2401,
  2402,
  2403,
  ...
  2407],
 [
  OTPLocalizer.SCMenuFourBossBattleCFO,
  2410,
  2411,
  2412,
  2413,
  ...
  2416],
 [
  OTPLocalizer.SCMenuFourBossBattleCJ,
  2420,
  2421,
  2422,
  2423,
  2424],
 [
  OTPLocalizer.SCMenuFourBossBattleCEO,
  2430,
  2431,
  2432,
  2433],
...
class TTChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def addCharMenu(self, indices):
        if self.charMenu == None:
            menu = TTSCCogMenu(indices)
            self.charMenu = SCMenuHolder(OTPLocalizer.SCMenuChar, menu=menu)
            self.speedChat[2:2] = [self.charMenu]
        return

    def removeCharMenu(self):
        if self.charMenu:
            i = self.speedChat.index(self.charMenu)
            del self.speedChat[i]
            self.charMenu.destroy()
            self.charMenu = None
        return
    ...
    def addFourBossMenu(self):
        if self.fourBossMenu == None:
            menu = SCMenu()
            menu.rebuildFromStructure(fourBossMenuStructure)
            self.fourBossMenu = SCMenuHolder(OTPLocalizer.SCMenuFourBossBattle, menu=menu)
            self.speedChat[2:2] = [self.fourBossMenu]
        return

    def removeFourBossMenu(self):
        if self.fourBossMenu:
            i = self.speedChat.index(self.fourBossMenu)
            del self.speedChat[i]
            self.fourBossMenu.destroy()
            self.fourBossMenu = None
        return
