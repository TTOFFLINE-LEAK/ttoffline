...
class DistributedToonFestTrampolineActivity(DistributedPartyActivity):
    ...
    def loadModels(self):
        ...
        self.beans = [ loader.loadModel('phase_6/models/events/ttr_tf_m_token') for i in range(self.numJellyBeans) ]
    ...
    def loadGUI(self):
        ...
        self.token_gui = loader.loadModel('phase_6/models/gui/ttr_m_tf_gui_tokens')
        ...
        self.guiBeans = [ self.guiBean.instanceUnderNode(jumpLineLocator, self.uniqueName('guiBean%d' % i)) for i in range(self.numJellyBeans)
                        ]
        ...
        self.quitEarlyButton = DirectButton(parent=base.a2dTopRight, relief=None, text=TTLocalizer.PartyTrampolineQuitEarlyButton, text_fg=(1,
                                                                                                                                            ...
                                                                                                                                            0.65,
                                                                                                                                            1), text_pos=(0,
                                                                                                                                                          -0.23), text_scale=0.7, image=(
         quitEarlyUp, quitEarlyDown, quitEarlyRollover), image_color=(1, 0, 0, 1), image_scale=(20,
                                                                                                1,
                                                                                                11), pos=(-0.183,
                                                                                                          0,
    ...
    def acquireToon(self):
        ...
        self.trampB = self.normalTrampB
        self.leavingTrampoline = False
        self.hopOnAnim = Sequence(Func(self.toon.b_setAnimState, 'jump', 1.0), Wait(0.4), PartyUtils.arcPosInterval(0.75, self.toon, Point3(0.0, 0.0, 3.6), 5.0, self.tramp), Func(self.postHopOn))
    ...
    def postHopOff(self):
        ...
        if self.doJellyBeans:
            self.sendUpdate('awardTokens', [self.numBeansCollected, int(self.topHeight)])
