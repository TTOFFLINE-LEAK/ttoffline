...
ComicFont = 'phase_3/models/fonts/Comic'
...
lWestWing = 'West Wing'
lShortChangeOffice = 'Short Change Office'
lHighriseHallway = 'High Rise Hallway'
lBathroom = 'High Rise Bathroom'
lBar = 'High Rise Bar'
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'), 1000: (
   ...
   5300: (
        'to', 'on', 'Oak Street'), 
   7000: (
        'to the', 'at the', 'Toonfest'), 
   7100: (
        'to the', 'at the', "Mille's Meadow"), 
   7200: (
        'to the', 'at the', "Bill's Hills"), 
   9000: (
        'to the', 'in the', 'Playground'), 
   9100: (
        'to', 'on', 'Lullaby Lane'), 
   ...
   10300: (
         'to the', 'in the', 'Executive Office'), 
   10400: (
         'to the', 'in the', '        Terrifying Two'), 
   10500: (
   ...
   10750: (
         'to the', 'in the', 'The Entire Eighteen'), 
   10760: (
         'to the', 'in the', 'The Clubhouse'), 
   10800: (
         'to the', 'in the', 'Bossbot Backwoods'), 
   11000: (
   ...
   11300: (
         'to the', 'in the', lWestWing), 
   11500: (
         'to the', 'in the', 'Sellbot Factory'), 
   11569: (
         'to the', 'in the', 'Smokestacks'), 
   12000: (
         'to', 'in', 'Cashbot Train Yard'), 
   12100: (
         'to the', 'in the', 'Cashbot HQ Lobby'), 
   12200: (
         'to the', 'in the', lShortChangeOffice), 
   12210: (
         'to the', 'in the', lHighriseHallway), 
   12220: (
         'to the', 'in the', lBathroom), 
   12230: (
         'to the', 'in the', lBar), 
   12240: (
         'to the', 'in the', "Buff Shark's Office"), 
   12500: (
   ...
   19000: (
         'to', 'in', '? ? ? ? ? ? ? ? ?'), 
   19100: (
         'to the', 'in the', 'Executive Lobby'), 
   21000: (
         'to the', 'in the', 'Playground'), 
   21300: (
         'to', 'on', 'Oak Street'), 
   21400: (
         'to the', 'at the', 'Moneybin'), 
   62000: (
         'to the', 'at the', 'Scrapyard'), 
   1002000: (
           '', '', '')}
...
SellbotSwagEntrance = 'Smokey Entrance'
Office = 'Office'
FactoryNames = {0: 'Factory Mockup', 11500: 'Sellbot Cog Factory', 
   11569: "Smokin' Foreman's Smokestacks", 
...
Period = '.'
Laff = 'Laff'
ToonfestTokenS = 'ToonFest Token'
ToonfestTokenP = 'ToonFest Tokens'
...
QuestsTokensRewardSingular = ('You get 1 {0}.').format(ToonfestTokenS)
QuestsTokensRewardPlural = ('You get %s {0}.').format(ToonfestTokenP)
QuestsTokensRewardPosterSingular = ('Reward: 1 {0}.').format(ToonfestTokenS)
QuestsTokensRewardPosterPlural = ('Reward: %s {0}.').format(ToonfestTokenP)
...
QuestDialogDict = {160: {GREETING: '', QUEST: "Ok, now I think you are ready for something more rewarding.\x07If you can defeat 3 Bossbots I'll give you a little bonus.", 
   ...
   5247: {QUEST: 'This neighborhood is pretty tough...\x07You might want to learn some new tricks.\x07_toNpcName_ taught me everything I know, so maybe he can help you too._where_'}, 5248: {GREETING: 'Ahh, yes.', LEAVING: '', 
   ...
   5249: {GREETING: 'Mmmmm.', QUEST: 'Excellent!\x07Now demonstrate your skill as a fisherman.\x07I dropped three fuzzy dice in the pond yesterday.\x07Fish them out and bring them to me.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'It seems you may not be so clever with the rod and reel.'}, 
   5250: {GREETING: '', LEAVING: '', 
   ...
   903: {QUEST: 'You may be ready to see _toNpcName_ the Blizzard Wizard for your final test._where_'}, 5234: {GREETING: '', QUEST: 'Aha, you are back.\x07Before we begin, we must eat.\x07Bring us some lumpy cheese for our broth.\x07Lumpy cheese can only be gathered from Big Cheese Cogs.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'We still need lumpy cheese'}, 
   5278: {GREETING: '', QUEST: 'Aha, you are back.\x07Before we begin, we must eat.\x07Bring us some caviar for our broth.\x07Caviar can only be gathered from Mr. Hollywood Cogs.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'We still need caviar'}, 
   5235: {GREETING: '', QUEST: 'A simple man eats with a simple spoon.\x07A Cog took my simple spoon, so I simply can not eat.\x07Return my spoon to me.  I think a Robber Baron took it.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'I simply must have my spoon.'}, 
   5279: {GREETING: '', QUEST: 'A simple man eats with a simple spoon.\x07A Cog took my simple spoon, so I can not eat.\x07Return my spoon to me.  I think a Big Wig took it.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'I simply must have my spoon.'}, 
   5236: {GREETING: '', QUEST: 'Many thanks.\x07Slurp, slurp...\x07Ahhh, now you must catch a talking toad.  Try fishing in the pond.', 
          LEAVING: '', 
   ...
   5238: {GREETING: '', QUEST: "So the wizard sent you.  I'm sad to say we're fresh out of red bean ice cream cones.\x07You see, a bunch of Cogs came in and just took them.\x07They said they were for Mr. Hollywood, or some such nonsense.\x07I'd sure appreciate if you could round them back up for me.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'}, 
   5280: {GREETING: '', QUEST: "So the wizard sent you.  I'm sad to say we're fresh out of red bean ice cream cones.\x07You see, a bunch of Cogs came in and just took them.\x07They said they were for The Big Cheese, or some such nonsense.\x07I'd sure appreciate if you could round them back up for me.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'}, 
   5239: {QUEST: "Thanks for bringing back my ice cream cones!\x07Here's one for Lil Oldman.", GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'You better bring that ice cream to Lil Oldman before it melts.'}, 
   5240: {GREETING: '', QUEST: 'Very good.  Here you go toad...\x07Slurp, slurp...\x07Okay, now we are almost ready.\x07If you can just bring me some powder to dry my hands.\x07I think those Big Wig Cogs sometimes have powder from their wigs.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find any powder?'}, 
   5281: {GREETING: '', QUEST: 'Very good.  Here you go toad...\x07Slurp, slurp...\x07Okay, now we are almost ready.\x07If you can just bring me some powder to dry my hands.\x07I think those Mr. Hollywood Cogs sometimes keep powder for their noses.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find any powder?'}, 
   5241: {QUEST: 'Okay.\x07As I once said, to truly throw a pie, you must throw not with the hand...\x07...but with the soul.\x07I know not what that means, so I will sit and contemplate while you restore buildings.\x07Return when you have completed your task.', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Your task is not yet complete.'}, 
   5242: {GREETING: '', QUEST: 'Although I still know not what I am talking about, you truly are worthy.\x07I give you a final task...\x07The talking toad would like a girlfriend.\x07Find another talking toad.  The toad has spoken.', 
          LEAVING: '', 
...
ChatGarblerChicken = ['bock', 'buck', 'bakahk', 'cluck']
...
SuitDankDownsizer = 'Dank Downsizer'
...
SuitSwagForeman = "Smokin' Foreman"
...
SuitBigWig = 'Big Wig'
SuitSwagAttorney = 'Swag Attorney'
...
SuitM8 = 'Sysadmin'
SuitM9 = 'M9'
SuitSteelBottomFeeder = 'Steel Bottom Feeder'
SuitSteelTelemarketer = 'Steel Telemarketer'
SuitMolder = 'The Molder'
SuitMTT = 'Mettaton'
SuitStormish = 'Stormish'
SuitTheYagich = 'The Yagich'
SuitTheYagichS = 'a The Yagich'
SuitTheYagichP = 'The Yagichs'
SuitCagealicous = 'Cagealicous'
SuitCagealicousS = 'a Cagealicous'
SuitCagealicousP = 'Cagealicouses'
SuitBuffShark = 'Buff Shark'
SuitBuffSharkS = 'a Buff Shark'
SuitBuffSharkP = 'Buff Sharks'
SuitRiplex = 'Riplex'
SuitRiplexS = 'a Riplex'
SuitRiplexP = 'Riplexes'
SuitPencilBreaker = 'Pencil Breaker'
SuitPencilBreakerS = 'a Pencil Breaker'
SuitPencilBreakerP = 'Pencil Breakers'
SuitShadowJustice = 'Shadow Justice'
SuitShadowJusticeS = 'a Shadow Justice'
SuitShadowJusticeP = 'Shadow Justices'
SuitPineapplehead = 'Pineapple\x03head'
SuitPineappleheadS = 'a Pineapple\x03head'
SuitPineappleheadP = 'Pineapple\x03heads'
SuitFeathers = 'Feathers'
SuitFeathersS = 'a Feathers'
SuitFeathersP = 'Feathers'
SuitCaptain = 'The Captain'
SuitCaptainS = 'a The Captain'
SuitCaptainP = 'The Captains'
...
SuitDankDownsizerS = 'Dank Downsizer'
...
SuitSwagForemanS = "Smokin' Foreman"
...
SuitSwagAttorneyS = 'Swag Attorney'
...
SuitM8S = 'a Sysadmin'
SuitM9S = 'M9'
SuitSteelBottomFeederS = 'a Steel Bottom Feeder'
SuitSteelTelemarketerS = 'a Steel Telemarketer'
SuitMolderS = 'a Molder'
SuitMTTS = 'a Mettaton'
SuitStormishS = 'a Stormish'
...
SuitDankDownsizerP = 'Dank Downsizers'
...
SuitSwagForemanP = "Smokin' Foremen"
...
SuitSwagAttorneyP = 'Swag Attorneys'
...
SuitM8P = 'Sysadmins'
SuitM9P = 'M9s'
SuitSteelBottomFeederP = 'Steel Bottom Feeders'
SuitSteelTelemarketerP = 'Steel Telemarketers'
SuitMolderP = 'The Molders'
SuitMTTP = 'The Mettatons'
SuitStormishP = "The Stormish's"
...
SuitAttackNames = {'Audit': 'Audit!', 'Bite': 'Bite!', 
   ...
   'BossJump': 'Shakeout!', 
   'GearThrow': 'Gears!', 
   'GearStorm': 'Gear Storm!', 
   'CanAttack': 'Can Blast!', 
   'SafeThrow': 'Safe!', 
   'CashTornado': 'Cash Tornado!', 
   'Gavel': 'Gavel!', 
   'Bookshelf': 'Booked!', 
   'Fore': 'Fore!', 
   'BossDemotion': 'Demotion!', 
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
   ...
   'CigarSmoke': [
                'Your defeat tastes good like a cigaratte should.',
                'Your future is cloudy, Toon.',
                "SURGEON GENERAL'S WARNING: Smoking kills.",
                'A fat one for a fat cat.',
                'Cog Nation, Inc. is sponsored by Foreman Cigars.',
                'Got a light?',
                '*cough cough*',
   ...
   'SongAndDance': [
                  "I'm a well known dancer across town.",
   ...
   'PushSwitch': [
                ...
                'Hold up, I wanna figure this out quick.',
                'Give me some time.',
                'This better not be a trap.'], 
   'ShadowToon': [
                'This Toon speaks for itself.',
                'Trust nobody.  Not even yourself.',
                'This is as fair as our attacks get.',
                'Let there be darkness.',
                'Light cannot exist without darkness.',
                'What comes around goes around.'], 
   'BossJump': [
              "I'll send you packing while shaking!",
              'Shake it, toons!',
              "You're less sturdy than you think.",
              'Time to bring down the house!',
              'Try to withstand this!',
              'I despise competition.',
              "This market ain't big enough for the two of us!"], 
   'GearThrow': [
               "You aren't geared up for this.",
               'You seem to be lacking the proper gear.',
               'Come back when you have better gear.'], 
   'GearStorm': [
               "Raining cats and dogs? I don't think so!",
               'Hail has nothing on this!',
   ...
   'CanAttack': [
               'You think you can, but I know I can.',
               "Don't mind me... just adding fuel to the fire.",
               "Let's have a blast. More specifically, you blasting out of here.",
               "Don't try this at home.",
               'Drink before work, as I like to say!',
               "If you can't take the heat, stay out of the blast range."], 
   'SafeThrow': [
               'Loans can be such a burden!',
               "I hope you don't mind if I put this weight on your shoulders.",
               'Better safe than sorry.',
               'In this kind of buisness, we like to play it safe.'], 
   'CashTornado': [
                 'This kind of cash will make your head spin!',
                 'The power of money is incredible.',
                 'Money is power.',
                 'You can move mountains with this much cash!'], 
   'Gavel': [
           'I find you guilty!',
           'Beware the slammer!',
           'This is your punishment.',
           'Your lies have come crashing down!'], 
   'Bookshelf': [
               'These are heavy duty books.',
               'Reading this much will give anyone a headache.',
               'Reading is a great way to pass the time!... and to pass out from.',
               "You should've studied on how to dodge this."], 
   'Fore': [
          'Fore!',
          'Fore!'], 
   'BossDemotion': [
                  ...
                  "You thought you had it all, but you're nothing!",
                  'What a failure, back you go!',
                  'Get out of my sight!'], 
   'Reorganize': [
                "It's time to reorganize.",
                "It's time to reorganize."]}
BuildingWaitingForVictors = (
 'Please wait...',)
...
FADoorCodes_WALKWAY_BLOCKED = 'Yikes! A Toon is currently battling a Cog inside! You need to wait until the battle is complete.'
...
AvatarChoiceMakeAToonAF = 'Time to\nMake A\nNew Toon!'
...
AvatarChooserInfo = 'Server Information'
EpisodePlay = 'Play'
EpisodeUnavailable = 'Not Ready'
EpisodePrologue = 'Prologue'
EpisodeSquirtingFlower = 'Squirting Flower'
EpisodeCogHighrise = 'Short Work'
EpisodeGyroPt1 = "Gyro's Tale"
EpisodePrologueDesc = "Experience the creation of the Cogs, playing as Scrooge McDuck!\n\nAs seen in Toontown Online's 2003 Installation Video."
EpisodeSquirtingFlowerDesc = "What happened to Oak Street when the Cogs invaded?\n\nFight for Daisy's Gardens, playing as Coach Zucchini!"
EpisodeCogHighriseDesc = 'What is the life of normal Cogs like?\n\nWalk through the hallways of a Cog High Rise as a Short Change!'
EpisodeGyroPt1Desc = 'What is the truth behind Doctor Surlee and Gyro Gearloose?\n\nSee through the eyes of Gyro and his storied past.'
...
MusicDgSzActivity = 'Daffodils and Daisies'
...
MusicDownloader = 'Become a Toon!'
MusicPrologueGyro = 'Gyro?'
MusicLab = "Gyro's Lab"
MusicMoneybin = 'The Money Bin'
MusicSwagtory = 'The Smokestacks'
MusicOfflineTheme = 'The Offline Theme'
MusicGyroChase = "Gyro's Escape"
MusicGyroCreate = 'Rewriting History'
MusicCogBar = 'The Cog Bar'
MusicCogBathroom = 'Intruder!'
MusicSquirtingBattle = 'A Dangerous Encounter'
MusicPolishAnthem = 'Poland Is Not Yet Lost'
JukeboxAddSong = 'Add\nSong'
...
PartyDecorationNameDict = {0: {'editor': 'Balloon Anvil', 'description': 'Try to keep the fun from floating away!'}, 
   ...
   11: {'editor': 'Bean Banner', 'description': 'A Jellybean banner designed by Cassidy'}, 
   12: {'editor': 'Gag Cake', 'description': 'A Topsy Turvy gag cake designed by Felicia'}, 
   ...
   26: {'editor': 'Toon Hall', 'description': "Flippy's home!"}, 
   27: {'editor': 'Bank', 'description': 'The Toontown Bank.'}, 
   28: {'editor': 'Gazebo', 'description': "Toontown Central's Gazebo."}, 
   29: {'editor': 'Trolley', 'description': 'Toons go to play minigames on this!'}, 
   30: {'editor': 'Pet Shop', 'description': 'The shop where pets are sold.'}, 
   31: {'editor': 'School', 'description': 'The Toontown Schoolhouse.'}, 
   32: {'editor': 'Library', 'description': 'The Toontown Library.'}, 
   33: {'editor': 'Gag Tank', 'description': 'A plain old gag tank.'}, 
   34: {'editor': 'Mickey Horse Statue', 'description': 'Sir Knight Mickey to the rescue!'}, 
   35: {'editor': 'Goofy Statue', 'description': 'A statue of the goofiest citizen in Toontown!'}, 
   36: {'editor': 'Silly Meter', 'description': 'A replica of the Silly Meter.'}, 
   37: {'editor': 'Fountain', 'description': 'Some Toons never found their way out of this one.'}, 
   38: {'editor': 'Holiday Tree', 'description': "Only for that extra 'holiday cheer'."}, 
   39: {'editor': 'Flippy Stand', 'description': "Flippy Doggenbottom's Election Stand"}, 
   40: {'editor': 'Podium', 'description': "Alec Tinn's Election Podium."}, 
   41: {'editor': 'Election Stage', 'description': 'Toon Council Presidental Elections Stage.'}, 
   42: {'editor': 'Slappy Stand', 'description': "Slappy Quackintosh's Election Stand."}, 
   43: {'editor': 'Safes', 'description': 'Remember to always stay safe!'}, 
   44: {'editor': 'Train', 'description': 'As seen on the Pick-A-Toon screen.'}, 
   45: {'editor': 'Fire Hydrant', 'description': 'Some say this hydrant has once come to life...'}, 
   46: {'editor': 'Jellybean Bank', 'description': 'Reminds Toons of Slappy.'}, 
   47: {'editor': 'Organ', 'description': 'Best played by Jethred.'}, 
   48: {'editor': 'Popcorn Cart', 'description': 'Popcorn! Yummy!'}, 
   49: {'editor': 'Toon House', 'description': 'A generic cabin bought only with jellybeans!'}, 
   50: {'editor': 'Castle', 'description': 'A large and tall castle bought only with jellybeans!'}, 
   51: {'editor': 'Tiki Hut', 'description': 'A beach styled home bought only with jellybeans!'}, 
   52: {'editor': 'Tepee', 'description': 'A unique American Indian styled home bought only with jellybeans!'}, 
   53: {'editor': 'Gag Shop', 'description': "Goofy's Gag Shop, home to only the tooniest gags!"}, 
   54: {'editor': 'SnowDoodle', 'description': 'His only trick is being cold!'}, 
   55: {'editor': 'ValenToons Anvil', 'description': "We've got your heart on a string!"}, 
   56: {'editor': "Smokin' Claus", 'description': "Now that's some real Holiday Swag right there."}, 
   57: {'editor': 'TTC Sky Generator', 'description': 'Enables the Toontown Central sky.'}, 
   58: {'editor': 'DDL Sky Generator', 'description': "Enables the Donald's Dreamland sky."}, 
   59: {'editor': 'MML Sky Generator', 'description': "Enables the Minnie's Melodyland sky."}, 
   60: {'editor': 'Foggy Sky Generator', 'description': 'Enables the Foggy Toontown sky.'}, 
   61: {'editor': 'Spooky Sky Generator', 'description': 'Enables the Spooky Toontown sky.'}, 
   62: {'editor': 'Cog Sky Generator', 'description': 'Enables the Cog Headquarters sky.'}, 
   63: {'editor': 'Old Cog Sky Generator', 'description': 'Enables the 2003 Cog Headquarters sky.'}, 
   64: {'editor': 'BBHQ Sky Generator', 'description': 'Enables the Bossbot Headquarters sky.'}}
...
ShardTabTitle = 'Current'
ShardPageTitle = 'Current Mini-Server'
ShardPageMiniserverInfo = 'You are currently in: %s'
...
ShardPagePopulationTotal = 'Total Population: %d'
...
SuitPageQuota = '%d defeated.'
SuitPageCogRadar = '{0} {1} found.'
SuitPageBuildingRadar = '{0} building{1} found.'
SuitPageDefeatMoreCogs = 'Defeat {0} more {1} to unlock this statistic.'
SuitPageDefeatOtherCogs = 'Complete! Defeat more {0} to unlock this statistic.'
SuitPageLoading = 'Loading...'
DisguisePageTitle = Cog + ' Disguise'
DisguisePageMeritAlert = 'Ready for\npromotion!'
DisguisePageCogLevel = 'Level %s'
DisguisePageMeritFull = 'Full'
WordPageTitle = 'Magic Words & Clothing IDs'
WordPageTabTitle = 'Magic Words'
...
ClothingPageTitle = 'Clothing IDs'
ClothingPageShirt = 'Shirt IDs'
ClothingPageSleeve = 'Sleeve IDs'
ClothingPageShort = 'Shorts IDs'
AccessoriesPageTitle1 = 'Head Accessories'
AccessoriesPageTitle2 = 'Body Accessories'
...
ServerPageTitle = 'Mini-Servers'
ServerPageButton = 'Server %s'
ServerPageName = 'Name: %s'
ServerPageGameMode = 'Game Mode: %s'
ServerPageDesc = 'Description: %s'
ServerPageMoreInfo = 'More Information:'
ServerPagePopulation = 'Population: %d / 16'
ServerPageMoreInfoBtn = 'Open'
ServerPageConnectBtn = 'Connect'
ServerPageConnectDialog = 'Are you sure you would like to connect to: %s\n\nNOTE: Leaving "Username" blank will connect to the server with the username that you\'re currently using.'
ServerPageConnectDialogExt = 'Are you sure you would like to connect to this server?\n\nNOTE: Leaving "Username" or "Game Server" blank will use the info that you\'re currently using.'
ServerPageMoreInfoDialog = 'This will open your browser to show you more info about this server\nWould you like to continue?'
ServerPageNoMiniservers = "There currently aren't any Mini-Servers online.  Please check back later."
ServerPageListOffline = 'The Mini-Server List is offline.  Please check back later.'
ServerPageChangeServer = 'Change Server'
...
LoaderLabel = 'Loading...'
AprilFoolsLoaderLabel = ['Loading Club Penguin...', "Smokin' Foreman", "Fixing Ben's Code...", 'Start me up', 'Stealing your bank info...', 'Downloading RAT...', 'Overheating processor...',
 'Overhead capacitors to 105%.', 'Delaying Toontown Apex...', 'brb dinner', 'totaly made from scratch i sware!', 'Money Back 100% True', 'worm as in virus not earth worm! lol',
 'Go Flippy yourself', 'Delaying doodles...', "Stealing Sir Max's quiz stage...", 'Giving Riggy Marole a taste for blood...', 'Locking Riggy Marole in his cage...',
 "Making Lil Oldman's ToonTasks harder...", 'Banning people for saying "mature staff"...', 'Switching Resistance Ranger Rocky and Rocky Reborn...',
 'Hey there Toons, Coach Z here with another video!', 'Feeding JJKoletar his dinner...', 'Polishing the Chairman...',
 'Loading The Legend of Pirates Online...', 'Locking Riggy Marole in the Funny Farm...', 'Making a new game...', 'Removing UNDERTALE easter eggs...',
 'Loading underwater habitats for sharks...', 'TEW TOW?!?!?!?!??!', 'Adding Mixing Animation...', 'Cancelling Episode 3...']
AFEnteringToontown = ['Club Penguin', 'Toontown Online', 'The Legend of Pirates Online', 'The Legend of Toontown Offline', 'Riggy Marole is coming for you', 'Video Game', 'Toontown Apex Redone',
 'Joey Praising Simulator', 'Toontown Offline v3', 'Sonic the Hedgehog 4 Episode III', 'Toontown Rewritten', 'Toontown Infinite', 'Toontown Origins', 'Toontown Frenchy',
 'Toontown Planet', 'Toonbox', 'Toontown Explorer', 'Toontown Revolution', 'Toontown Toontown', 'Yo Mamma', 'Tountaun Ofurain', 'Frizzy Fried Chicken', 'Toontown Alox',
 'Toontown House', 'Toontown Next', 'Cogtown Online', 'Cogtown TRUE Development', 'Toonbook', 'But nobody came.', 'UNDERTALE', 'Toontown Toontown: 2', 'UNDERFELL Episode 3',
 "Ryno's Toontown Infinite Modifications", 'Doki Doki Literature Club', 'Toontown Level Editor', 'Tewtow Offlie']
...
FireCogImpossibleTitle = "PINK SLIPS LEFT:%s\nCAN'T FIRE THIS COG!"
...
PlaygroundDeathAckMessageO = 'The Toons have turned you into a Toon!\n\nYou are a prisoner. You may not leave the playground until you are a Cog.'
...
STOREOWNER_GETDRESSED = 'This is a well-established clothing store, and we know that you own clothing.  Wear it before buying anything.'
...
TF_STOREOWNER_NOMONEY = ["You're going to be needing some more tokens for that one, buddy.", "Woah there, you haven't gotten the tokens for that. Save 'em up!"]
TF_STOREOWNER_LIMIT = ["Hey pal, I'd buy another too, but it looks like you've already hit the limit.", "Nice try, but you've already got plenty of those!"]
TF_STOREOWNER_FULL = ['You been on a shopping spree, ace? Looks like your closet is full!', "You're gonna need to clear some items from your closet before I can give you that."]
TF_STOREOWNER_INVALID = ["Looks like that prize is out of stock! That's peculiar...", 'We just got a recall on that prize - try again later, bud.']
TF_STOREOWNER_MAILFULL = ["I'd love to deliver that prize to ya's, but your mailbox is already full.", 'You been on a shopping spree, ace? Looks like your mailbox is full!']
TF_STOREOWNER_DELIVERYFULL = ['You been on a shopping spree, ace? The postmaster is already trying to deliver too many items to you!', "You've got too many items on order, pal. Try again after you've gotten a few."]
...
ResistanceToonToondownInstructions = 'all the Toons near you will lose %s Laff points'
ResistanceToonToondownAllInstructions = 'all the Toons near you will lose all their Laff points'
...
ShirtStylesDescriptions = {'bss1': 'solid', 'bss2': 'single stripe', 
   ...
   'extraordinate_shirt_boy': 'Extraordinaire Shirt', 
   'extraordinate_shirt_girl': 'Extraordinaire Shirt'}
BottomStylesDescriptions = {'bbs1': 'plain w/ pockets', 'bbs2': 'belt', 
   ...
   'tt2': 'Sequel Shorts', 
   'extraordinate_shorts': 'Extraordinaire Shorts', 
   'extraordinate_skirt': 'Extraordinaire Skirt'}
AwardMgrBoy = 'boy'
AwardMgrGirl = 'girl'
...
MessageConfirmColor = "You've purchased a special 'Rewritten' ticket. This ticket will allow you to change your entire color to '%s', however it is irreversible unless you were to buy another ticket from Toonfest!\n\nAre you sure you want to change your appearance?"
MessageConfirmColorSpecial = "You've purchased a special 'Rewritten' ticket. This ticket will allow you to change your entire Toon's color to '%s', however it is irreversible unless you were to buy another ticket from Toonfest!\n\nAre you sure you want to change your appearance? You won't be able to choose your current color effect again!"
MessageColorConfirmed = "Your color is now '%s'! If you don't like it, you can always buy a new color from Toonfest."
...
CatalogGoodbyeList = ['Bye now!',
 ...
 'Ok, bye now!',
 'Bye!']
CatalogGoodbyeListSkeleton = ['alright, seeya.',
 'seeya, bud.',
...
NPCToonNames = {20000: 'Tutorial Tom', 999: 'Toon Tailor', 
   ...
   14026: 'Doctor Surlee\n[2013]', 
   14027: 'Mata Hairy', 
   14028: 'Bumpy Bumblebehr', 
   14029: "Good ol' Gil Giggles", 
   14030: 'Captain Rollie Dandysnooker', 
   14031: 'Colonel Violet Supergrooven', 
   14032: 'Prof. Von Fumblesplat', 
   14033: 'Silly Lily Gigglesnout', 
   14034: 'Lord Lowden Clear', 
   14035: 'Ryno', 
   14036: 'Nickdoge', 
   14037: 'Mr. Cheeze', 
   14038: 'Bill', 
   ...
   14045: 'mr e', 
   14046: 'mrs e', 
   14047: 'Mister Yippie Thunderbubble', 
   14048: 'Sir Furbal', 
   14049: 'Prof McMouse', 
   14501: 'Touch Yourself Terry', 
   14500: 'Magic Mille', 
   15000: lHQOfficerM, 
   15001: lHQOfficerM, 
   15002: lHQOfficerM, 
   ...
   15013: lHQOfficerM, 
   15014: lHQOfficerF, 
   51916: 'Scrooge McDuck', 
   51917: 'Gyro Gearloose', 
   91913: 'Shockley', 
   91914: 'Sir Max', 
   91915: 'McQuack', 
   91916: 'Hawkheart'}
...
FishGuiOk = 'Sell for Jellybeans'
FishGuiOkTokens = ('Sell for {0}').format(ToonfestTokenP)
...
TipDict = {TIP_NONE: ('',), TIP_GENERAL: (
               ...
               'Rescued buildings are sometimes recaptured by the Cogs. To keep your star, go out and rescue more buildings!',
               ...
               "Go to the 'Pick-A-Toon' screen to play an Episode!",
               'Never make eye contact with the Grumpy Construction Worker in Goofy Speedway!',
               'A list of all Magic Words can be found on a page in your Sthicker Book.',
               'Some Magic Word Commands require administrator privleges to use on a Mini-Server.',
               'A Toontown Offline Mini-Server can only hold up to 16 Toons at a time.',
               'High Laff Toons may want to speak to Flippy in the Toon Hall.',
   ...
   TIP_STREET: (
              ...
              'When you\'ve defeated enough Cogs, use the "Cog Radar" by clicking Cog icons on the Cog Gallery page in your Shticker Book.',
   ...
   TIP_COGHQ: (
             ...
             'You can access a secret part of Sellbot Headquarters by taking a trip on the Sellbot Kart.',
             'Cogs have been so busy recently, they barely have time to relax among the Bossbot Headquarters woods!',
             'A new Factory in Sellbot Headquarters will earn you a special, otherwise non-obtainable reward upon completion.',
...
TipDictAF = {TIP_NONE: ('',), TIP_GENERAL: (
               'To defeat the Cyberdemon, shoot at it until it dies.',
               'Riggy Marole is always watching.',
               'You can hurt yourself if you run with scissors.',
               'You should never look directly at the sun.',
               'Sans easter eggs.',
               'Never press F6!',
               "Heya! Huh? Sorry, I can't understand you. Use the SpeedChat.",
               'RAID! RAID! RAID! We are team EPIC! We are team EPIC! We are team EPIC! We are team EPIC! We are team EPIC! We are team EPIC! We are team EPIC! We are team EPIC!',
               'Stop reading this.',
               'Toontown Offline is a horrible game! Never play it.',
               'If your Toon gets to dating level 15, they will be able to pop the question. Hope they say yes!',
               'Having a long-term relationship with another Toon has more benefits than a one-night relationship.',
               "Toons can partner even if they're the same gender. Don't be afraid to experiment!",
               'This page intentionally left blank.',
               'Plaid shirts and striped pants rarely make a positive fashion statement.',
               'The game will delete itself unless you think of just Monika.',
               'Mr. Cheeze is an abusive mod.',
               'I was banned by mrmcuckingcheeze because he abuses power.'), 
   TIP_STREET: (
              'To defeat the Cyberdemon, shoot at it until it dies.',
              'Riggy Marole is always watching.',
              'You can hurt yourself if you run with scissors.',
              ...
              'This page intentionally left blank.',
              'Plaid shirts and striped pants rarely make a positive fashion statement.',
              'If you get mugged, you lose all of your jellybeans.',
              "RiGgY's HeRe",
              'While walking warily down the street with the brim pulled way down low, be cautious of machine guns.',
              'The game will delete itself unless you think of just Monika.',
              'Mr. Cheeze is an abusive mod.',
              'I was banned by mrmcuckingcheeze because he abuses power.'), 
   TIP_MINIGAME: (
                ...
                'This page intentionally left blank.',
                'Plaid shirts and striped pants rarely make a positive fashion statement.',
                'In the Toon Memory Game, your will to live is permanently lost. Be careful!',
                'The game will delete itself unless you think of just Monika.',
                'Mr. Cheeze is an abusive mod.',
                'I was banned by mrmcuckingcheeze because he abuses power.'), 
   TIP_COGHQ: (
             'You must complete your Bossbot Disguise before visiting the V.P.',
             'You must complete your Lawbot Disguise before visiting the C.F.O.',
             'You must complete your Sellbot Disguise before visiting the Chief Justice.',
             'You must complete your Hackerbot Disguise before visiting the C.E.O.',
             'Collect Cog Merits by defeating Bossbot Cogs in battle.',
             'Collect Cogbucks by defeating Lawbot Cogs in battle.',
             'Collect Jury Notices by defeating Sellbot Cogs in battle.',
             'Collect Stock Options by defeating Cashbot Cogs in battle.',
             'You can talk.',
             'Defeating the Sellbot V.P. by yourself is easy!',
             'Defeating the Cashbot C.F.O. by yourself is easy!',
             'Defeating the Lawbot Chief Justice by yourself is easy!',
             'Defeating the Bossbot C.E.O. by yourself is easy!',
             "You must defeat Smokin' Foreman to recover a Sellbot Cog Disguise part.",
             "Earn Cashbot disguise suit parts as rewards for completing ToonTasks in Donald's Dreamland."), 
   TIP_ESTATE: (
              'Doodles can understand some SpeedChat phrases. Try "You stink!"',
              'Use the "Pet" SpeedChat menu to ask your Doodle to do tricks.',
              "You can teach Doodles tricks with training lessons from Clarabelle's Cattlelog.",
              'Reward your Doodle for doing tricks.',
              'Feed your Doodle a jellybean when it is hungry.',
   ...
   TIP_GOLF: (
            'Press the Tab key to see a top view of the golf course.', 'Press the Up Arrow key to point yourself towards the golf hole.', 'Swinging the club is just like throwing a pie.')}
TipDictCH = {TIP_NONE: ('',), TIP_GENERAL: (
               'Always be prepared to seal the deal.',
               'You can spend the least amount of Cogbucks associating with the Glad Hander- he likes a shmoozer!',
               'Counterfeit of Cogbucks will result in immidiate demotion.',
               'Always keep your ears plugged for Sound Gags.',
               'Now hiring Cashbot Cogs for contract work in Metropolis Manor.',
               'Keep your eyes away from Jokes at all times.',
               'Visit the Sellbot Factory to keep your propeller grease-free!',
               'Be wary to always ignore Toon Jury Summons!',
               'Discussion about The Chairman in front of Toons will result in immidiate demotion to a Level 1 Cog.',
               "Avoid the Toons' playgrounds at all times.",
               'Toons can use Toon-up in battle. Try to use power attacks to take them out quickly.',
               "Drop has low accuracy on cogs, so you shouldn't have to worry about getting hit.",
               'Never look into the eyes of a toon with Hypno-Goggles on.',
               'You can use your propeller to fly between areas.',
               'Each cog has a light meter on their chest. A red light means you are going to explode soon.'), 
   TIP_STREET: (
              'To defeat the Cyberdemon, shoot at it until it dies.',
              'Riggy Marole is always watching.',
              'You can hurt yourself if you run with scissors.',
...
SellbotSwagFactorySpecMainEntrance = 'The Smokestacks'
...
ResistanceToondownMenu = 'Toon-down'
ResistanceToondownItem = '%s Toon-down'
ResistanceToondownItemMax = 'Max'
ResistanceToondownChat = 'Toons of the World, Go Sad!'
...
LawbotBossTempIntro4 = 'You smell funny, Lawbot...'
LawbotBossTempIntro5 = 'Or should I say TOON?'
...
WinterCarolingStart = "Presents there, Presents here, Toontown's now in Holiday Cheer!"
...
BoardingInviteeBadDO = '%s not in the sudoers file. This incident will be reported.'
...
ElevatorSellBotFactory2 = 'Smokey Entrance'
...
MagicWordTreesDesc = "Usage: ~growTrees [track 0-6] [level 0-6]\n\nDescription: Grows all the trees in your Toon's garden."
MagicWordHarvest = '~pickTrees'
MagicWordHarvestDesc = "Usage: ~pickTrees [track 0-6] [level 0-6]\n\nDescription: Picks all the trees in your Toon's garden."
MagicWordFlowers = '~growFlowers'
MagicWordFlowersDesc = "Usage: ~growFlowers\n\nDescription: Grows all the flowers in your Toon's garden."
MagicWordPickFlowers = '~pickAllFlowers'
MagicWordPickFlowersDesc = "Usage: ~pickAllFlowers\n\nDescription: Picks all the flowers in your Toon's garden."
MagicWordHouseType = '~houseType'
MagicWordHouseTypeDesc = 'Usage: ~houseType [0 - 5]\n\nDescription: Sets your house type.'
MagicWordElectionCamera = '~cameraView'
MagicWordElectionCameraDesc = 'Usage: ~cameraView\n\nDescription: View from the angle of the Camerabots in the Election. Open + close your book to quit.'
MagicWordStartHoliday = '~startHoliday'
MagicWordStartHolidayDesc = 'Usage: ~startHoliday [0 - 123]\n\nDescription: Starts a holiday.\n\nExample: ~startHoliday 3 - Begins Halloween on the server/game.'
MagicWordEndHoliday = '~endHoliday'
MagicWordEndHolidayDesc = 'Usage: ~endHoliday [0 - 123]\n\nDescription: Ends a holiday.'
MagicWordGiveFish = '~gibFish'
MagicWordGiveFishDesc = 'Usage: ~gibFish [fish name]\n\nDescription: Request that the next fish you catch will be the one specified.'
MagicWordRemoveFishRequest = '~noGibFish'
MagicWordRemoveFishRequestDesc = 'Usage: ~noGibFish\n\nDescription: Delete any requests previously made with the ~gibFish command.'
MagicWordRun = '~run'
MagicWordRunDesc = 'Usage: ~run\n\nDescription: Makes your Toon go faster.'
MagicWordOobe = '~oobe'
MagicWordOobeDesc = 'Usage: ~oobe\n\nDescription: Allows you to move the camera with the mouse.'
MagicWordFanfare = '~fanfare'
MagicWordFanfareDesc = 'Usage: ~fanfare\n\nDescription: Celebrate yourself.'
MagicWordUnites = '~unites'
MagicWordUnitesDesc = 'Usage: ~unites [amount]\n\nDescription: Give yourself unites.'
MagicWordTrackAccess = '~trackAccess'
MagicWordTracksAccessDesc = 'Usage: ~trackAccess [x x x x x x x]\n\nDescription: Set your accessable gag tracks.\n\nExample: ~setTrackAccess 0 1 1 1 1 1 1 - Gives you all gag tracks except Toon-Up.'
MagicWordTracks = '~tracks'
MagicWordTracksDesc = "Usage: ~tracks [gagless]\n\nDescription: Give yourself all gag tracks at once, or leave out a single track.\n\nExample: '~tracks' will give you all gag tracks, but '~tracks soundless' will make you soundless."
MagicWordPouch = '~pouch'
MagicWordPouchDesc = 'Usage: ~pouch [0 - 255]\n\nDescription: Change how many gags you can hold.'
MagicWordExp = '~exp'
MagicWordExpDesc = 'Usage: ~exp [gag track] [value]\n\nDescription: Change your gag experience for a specific track.\n\nExtra: ~exp maxed will max your EXP in all tracks.\n\nExample: ~exp toon-up 10000 - Sets your Toon-up track to 10,000 EXP.'
MagicWordFireworks = '~fireworks'
MagicWordFireworksDesc = 'Usage: ~fireworks [july4 - newyears - summer]\n\nDescription: Begins fireworks.\n\nExample: ~fireworks newyears - Begins New Years fireworks.'
MagicWordSummons = '~summons'
MagicWordSummonsDesc = 'Usage: ~summons\n\nDescription: Give yourself maximum Cog summons.'
MagicWordNudify = '~nudify'
MagicWordNudifyDesc = 'Usage: ~nudify\n\nDescription: Sets your clothing to none.\n\nExtra: If you want to put on clothing, use "~dna torso".'
MagicWordInventory = '~inventory'
MagicWordInventoryDesc = 'Usage: ~inventory [clear] OR ~inventory [restock x x]\n\nDescription: Clear your gag inventory, or give yourself gags.\n\nExample: ~inventory restock 6 6 - Gives you gags in all tracks.'
MagicWordCogSuit = '~setCogSuit'
MagicWordCogSuitDesc = 'Usage: ~setCogSuit [cog type] [cog name abbreviation] [cog level]\n\nDescription: Set your Cog suit in a specific Cog Branch.\n\nExample: ~setCogSuit Bossbot f 1 - Set your Bossbot suit to a level 1 Flunky'
MagicWordCogIndex = '~setCogIndex'
MagicWordCogIndexDesc = "Usage: ~setCogIndex [-1 - 4] [0 - 7]\n\nDescription: Put yourself in a Cog suit.\n\nExample: '~setCogIndex 1 1' will put you into your Lawbot suit with a Cog Head, '~setCogIndex 1 0' without a Cog Head."
MagicWordCharIndex = '~setCharIndex'
MagicWordCharIndexDesc = "Usage: ~setCharIndex [-1 - 17]\n\nDescription: Transform into a Disney Character.\n\nExample: '~setCharIndex 4' will turn you into Goofy."
MagicWordDoodleIndex = '~setDoodleIndex'
MagicWordDoodleIndexDesc = "Usage: ~setDoodleIndex [-1 - 0]\n\nDescription: Transform into the doodle that you own.  If you don't own a doodle, you become Fluffy."
MagicWordGoonIndex = '~setGoonIndex'
MagicWordGoonIndexDesc = "Usage: ~setGoonIndex [-1 - 1]\n\nDescription: Transform into a Goon.\n\nExample: '~setGoonIndex 1' will turn you into a Security Goon."
MagicWordBossIndex = '~setBossIndex'
MagicWordBossIndexDesc = "Usage: ~setBossIndex [-1 - 3]\n\nDescription: Transform into a Boss Cog.\n\nExample: '~setBossIndex 3' will turn you into the V.P."
MagicWordCogLoop = '~cogLoop'
MagicWordCogLoopDesc = 'Usage: ~cogLoop [animation]\n\nDescription: Animate yourself in a Cog suit.\n\nExample: ~cogLoop sit - Loops yourself in a sitting pose.'
MagicWordCogPose = '~cogPose'
MagicWordCogPoseDesc = 'Usage: ~cogPose [animation] [frame]\n\nDescription: Pose yourself in a Cog suit.\n\nExample: ~cogPose glower 30 - Poses yourself in a glower pose.'
MagicWordCogPingPong = '~cogPingPong'
MagicWordCogPingPongDesc = 'Usage: ~cogPingPong [animation] [first frame] [final frame]\n\nDescription: Bounces yourself in a Cog suit from the first frame to the final frame and vice versa.\n\nExample: ~cogPingPong effort 110 120 - Loops yourself in a cheering animation.'
MagicWordCredits = '~rollCredits'
MagicWordCreditsDesc = 'Usage: ~rollCredits\n\nDescription: Roll the Toontown Offline credits. Disconnects you when they finish.'
MagicWordInvasionStatus = '~invasionStatus'
MagicWordInvasionStatusDesc = 'Usage: ~invasionStatus\n\nDescription: Returns the number of cogs available in an invasion in a pretty way.'
MagicWordInstaKill = '~instaKill'
MagicWordInstaKillDesc = 'Usage: ~instaKill\n\nDescription: Your gags will now instantly kill the Cogs.'
MagicWordEndFlying = '~endFlying'
MagicWordEndFlyingDesc = 'Usage: ~endFlying\n\nDescription: Skip the flying minigame in a Lawbot Field Office.'
MagicWordRevealMap = '~revealMap'
MagicWordRevealMapDesc = 'Usage: ~revealMap\n\nDescription: Reveal the map in a Sellbot Field Office.'
MagicWordEndMaze = '~endMaze'
MagicWordEndMazeDesc = 'Usage: ~endMaze\n\nDescription: Completes the Maze in a Sellbot Field Office.'
MagicWordShakeCamera = '~shakeCamera'
MagicWordShakeCameraDesc = 'Usage: ~shakeCamera [intensity]\n\nDescription: Momentarily shake the camera, as if something heavy went bump nearby.\n\nExample: ~shakeCamera 1 - Will shake your camera a little bit.'
MagicWordSetSpeed = '~setSpeed'
MagicWordSetSpeedDesc = "Usage: ~setSpeed [0 - 1,000]\n\nDescription: Change the speed of your Toon.\n\nExample: '~setSpeed 1' will make your Toon extremely slow, but '~setSpeed 100' will make your Toon very fast."
MagicWordPing = '~ping'
MagicWordPingDesc = 'Usage: ~ping\n\nDescription: Pong!'
MagicWordHelp = '~help'
MagicWordHelpDesc = 'Usage: ~help\n\nDescription: Get some help.'
MagicWordDoThump = '~doThump'
MagicWordDoThumpDesc = "Usage: ~doThump\n\nDescription: Plays a 'thump attack' effect in front of your current position."
MagicWordGibSpecials = '~gibSpecials'
MagicWordGibSpecialsDesc = 'Usage: ~gibSpecials\n\nDescription: Give your Toon all special gardening statues.'
MagicWordFlowerAll = '~flowerAll'
MagicWordFlowerAllDesc = 'Usage: ~flowerAll\n\nDescription: Plant all your flower plots.'
MagicWordStartBingo = '~startBingo'
MagicWordStartBingoDesc = 'Usage: ~startBingo\n\nDescription: Start Bingo.'
MagicWordStopBingo = '~stopBingo'
MagicWordStopBingoDesc = 'Usage: ~stopBingo\n\nDescription: Stop Bingo.'
MagicWordRequestBingoCard = '~requestBingoCard'
MagicWordRequestBingoCardDesc = 'Usage: ~requestBingoCard [bingo type]\n\nDescription: Request the next type of Bingo to be played.\n\nExample: ~requestBingoCard blockout - Blockout will be the next card to be played.'
MagicWordAbortMinigame = '~abortMinigame'
MagicWordAbortMinigameDesc = 'Usage: ~abortMinigame\n\nDescription: Abort any minigame you are currently in.'
MagicWordRequestMinigame = '~requestMinigame'
MagicWordRequestMinigameDesc = 'Usage: ~requestMinigame [minigame name]\n\nDescription: Request the next minigame to be played.\n\nExample: ~requestMinigame maze - Maze Game will be the next to be played.'
MagicWordLeaveRace = '~leaveRace'
MagicWordLeaveRaceDesc = "Usage: ~leaveRace\n\nDescription: Leave the race you're currently in."
MagicWordSkipMovie = '~skipMovie'
MagicWordSkipMovieDesc = 'Usage: ~skipMovie\n\nDescription: Skip the current animations in a Cog Battle.'
MagicWordSkipCEO = '~skipCEO'
MagicWordSkipCEODesc = 'Usage: ~skipCEO\n\nDescription: Skips to the next round of the CEO.'
MagicWordSkipCFO = '~skipCFO'
MagicWordSkipCFODesc = 'Usage: ~skipCFO\n\nDescription: Skips to the next round of the CFO.'
MagicWordHitCFO = '~hitCFO'
MagicWordHitCFODesc = 'Usage: ~hitCFO\n\nDescription: Hits the CFO. Mostly just to de-safe him.'
MagicWordSkipVP = '~skipVP'
MagicWordSkipVPDesc = 'Usage: ~skipVP\n\nDescription: Skips to the next round of the VP.'
MagicWordSkipCJ = '~skipCJ'
MagicWordSkipCJDesc = 'Usage: ~skipCJ\n\nDescription: Skips to the next round of the CJ.'
MagicWordFillJury = '~fillJury'
MagicWordFillJuryDesc = 'Usage: ~fillJury\n\nDescription: Fills all the seats in the Lawbot Jury.'
MagicWordSuitPathsShow = '~spShow'
MagicWordSuitPathsShowDesc = 'Usage: ~spShow\n\nDescription: Shows all the suit paths.'
MagicWordSuitPathsHide = '~spHide'
MagicWordSuitPathsHideDesc = 'Usage: ~spHide\n\nDescription: Hides all the suit paths.'
MagicWordSpawnCog = '~spawnCog'
MagicWordSpawnCogDesc = 'Usage: ~spawnCog [cog abbreviation] [level] [special suit #]\n\nDescription: Spawns a Cog in your area.\n\nExtra: Special suit 1 is skelecog, 2 is v2.0.\n\nExample: ~spawnCog f 5 - Spawns a level 5 Flunky.'
MagicWordInvasion = '~invasion'
MagicWordInvasionDesc = 'Usage: ~invasion [start/stop] [cog abbreviation] [amount of cogs] [special suit #]\n\nDescription: Spawns a Cog Invasion.\n\nExtra: Special suit 1 is skelecog, 2 is v2.0.\n\nExample: ~invasion start f - Spawns a Flunky invasion.'
MagicWordGardenGame = '~gardenGame'
MagicWordGardenGameDesc = 'Usage: ~gardenGame\n\nDescription: Starts the unreleased Garden minigame.'
MagicWordSleep = '~sleep'
MagicWordSleepDesc = 'Usage: ~sleep\n\nDescription: Enable and disable sleeping.'
MagicWordGlobalTP = '~globalTp'
MagicWordGlobalTPDesc = 'Usage: ~globalTp\n\nDescription: Allow yourself to teleport anywhere on the map.'
MagicWordMaxGarden = '~maxGarden'
MagicWordMaxGardenDesc = "Usage: ~maxGarden\n\nDescription: Max your Toon's garden."
MagicWordKick = '~~kick'
MagicWordKickDesc = 'Usage: ~~kick [reason]\n\nDescription: Kick a Toon off a miniserver. Providing a reason is optional.'
MagicWordFreeBldg = '~freeBldg'
MagicWordFreeBldgDesc = 'Usage: ~freeBldg\n\nDescription: Despawns a Cog building.'
MagicWordSos = '~sos'
MagicWordSosDesc = 'Usage: ~sos [amount] [npc name]\n\nDescription: Give yourself SOS Cards.\n\nExample: ~sos 99 Flippy - Gives your Toon 99 Flippy SOS Cards.'
MagicWordEmotes = '~emotes'
MagicWordEmotesDesc = 'Usage: ~emotes\n\nDescription: Unlock all the emotes on a Toon.'
MagicWordNametag = '~nametag'
MagicWordNametagDesc = "Usage: ~nametag [style]\n\nDescription: Sets your Toon's nametag style.\n\nExample: ~nametag boardwalk - Sets your nametag style to 'Boardwalk'."
MagicWordCatalog = '~catalog'
MagicWordCatalogDesc = 'Usage: ~catalog\n\nDescription: Delivers your next catalog.'
MagicWordMerits = '~merits'
MagicWordMeritsDesc = 'Usage: ~merits [cog department] [amount]\n\nDescription: Gives you merits.\n\nExample: ~merits cashbot 8,900 - Gives you 8,900 cogbucks.'
MagicWordTrackBonus = '~trackBonus'
MagicWordTrackBonusDesc = 'Usage: ~trackBonus [0 - 6]\n\nDescription: Makes a gag track organic.\n\nExample: ~trackBonus 1 - Makes your Trap organic.'
MagicWordQuestTier = '~questTier'
MagicWordQuestTierDesc = 'Usage: ~questTier [value]\n\nDescription: Sets your task level. Will reset any current toontasks.'
MagicWordSpawnFO = '~spawnFO'
MagicWordSpawnFODesc = 'Usage: ~spawnFO [s/l] [difficulty]\n\nDescription: Spawns a Field Office.\n\nExample: ~spawnFO s 1 - Spawns an easy Sellbot Field Office.'
MagicWordSpawnBuilding = '~spawnBuilding'
MagicWordSpawnBuildingDesc = 'Usage: ~spawnBuilding [cog abbreviation]\n\nDescription: Spawns a Cog building.\n\nExample: ~spawnBuilding f - Spawns a Cog Building as if a Flunky took it over.'
MagicWordTricks = '~tricks'
MagicWordTricksDesc = 'Usage: ~tricks\n\nDescription: Unlock all pet tricks.'
MagicWordGoodSOS = '~goodSOS'
MagicWordGoodSOSDesc = 'Usage: ~goodSOS\n\nDescription: Give yourself good SOS Cards.'
MagicWordImmortal = '~immortal'
MagicWordImmortalDesc = 'Usage: ~immortal\n\nDescription: Make yourself immortal.'
MagicWordUnlimitedGags = '~unlimitedGags'
MagicWordUnlimitedGagsDesc = 'Usage: ~unlimitedGags\n\nDescription: Restock your gags at the start of each round.'
MagicWordSetQP = '~setQP'
MagicWordSetQPDesc = 'Usage: ~setQP [task slot] [progress]\n\nDescription: Set your progress for a toontask.\n\nExample: ~setQP 1 20 - Will set your progress to 20 in your first task slot.'
MagicWordGivePies = '~givePies'
MagicWordGivePiesDesc = 'Usage: ~givePies [0 - 9] [amount]\n\nDescription: Give yourself pies.\n\nExample: ~givePies 6 -  Will give you infinite Wedding Cakes.'
MagicWordSetTrophyScore = '~setTrophyScore'
MagicWordSetTrophyScoreDesc = 'Usage: ~setTrophyScore [value]\n\nDescription: Set your rank on the Toon Platoon.'
MagicWordDna = '~dna'
MagicWordDnaDesc = 'Usage: ~dna [body part] [color/clothing ID]\n\nDescription: Set the colors and clothing of your Toon.\n\nExtra: See the clothing tab for clothing IDs.\n\nExample: ~dna toptex 69 - Sets your shirt to ID 69.'
MagicWordSetTickets = '~setTickets'
MagicWordSetTicketsDesc = 'Usage: ~setTickets [0 - 99,999]\n\nDescription: Give yourself Tickets.'
MagicWordSetGM = '~setGM'
MagicWordSetGMDesc = 'Usage: ~setGM [icon ID]\n\nDescription: Give yourself an admin icon over your head.\n\nExample: ~setGM 2 - Gives you a whistle icon above your Toon.'
MagicWordTogGM = '~togGM'
MagicWordTogGMDesc = 'Usage: ~togGM\n\nDescription: Toggle your admin icon.'
MagicWordGhost = '~ghost'
MagicWordGhostDesc = 'Usage: ~ghost\n\nDescription: Become invisible.'
MagicWordSetShoes = '~setShoes'
MagicWordSetShoesDesc = 'Usage: ~setShoes [shoe ID] [shoe texture ID]\n\nDescription: Change the shoes on your Toon.'
MagicWordSetBackpack = '~setBackpack'
MagicWordSetBackpackDesc = 'Usage: ~setBackpack [backpack ID] [backpack texture ID]\n\nDescription: Change the backpack on your Toon.'
MagicWordSetGlasses = '~setGlasses'
MagicWordSetGlassesDesc = 'Usage: ~setGlasses [glasses ID] [glasses texture ID]\n\nDescription: Change the glasses on your Toon.'
MagicWordSetHat = '~setHat'
MagicWordSetHatDesc = 'Usage: ~setHat [hat ID] [hat texture ID]\n\nDescription: Change the hat on your Toon.'
MagicWordSetName = '~setName'
MagicWordSetNameDesc = "Usage: ~setName [name]\n\nDescription: Change a Toon's name."
MagicWordSetMaxFishTank = '~setMaxFishTank'
MagicWordSetMaxFishTankDesc = 'Usage: ~setMaxFishTank [20 - 99]\n\nDescription: Set your fish tank size.'
MagicWordSetFishingRod = '~setFishingRod'
MagicWordSetFishingRodDesc = 'Usage: ~setFishingRod [0 - 4]\n\nDescription: Set your fishing rod type.'
MagicWordSetMaxMoney = '~setMaxMoney'
MagicWordSetMaxMoneyDesc = 'Usage: ~setMaxMoney [40 - 250]\n\nDescription: Set your jellybean jar size.'
MagicWordSetCE = '~setCE'
MagicWordSetCEDesc = 'Usage: ~setCE [1 - 25] [playground duration]\n\nDescription: Give yourself a cheesy effect.\n\nExample: ~setCE 1 8 - Gives you a cheesy effect for a long time.'
MagicWordSystem = '~system'
MagicWordSystemDesc = 'Usage: ~system\n\nDescription: Broadcasts a message to the server.'
MagicWordAccID = '~accID'
MagicWordAccIDDesc = 'Usage: ~accID\n\nDescription: Get the accountId from the target player.'
MagicWordShowAvIDS = '~showAvIds'
MagicWordShowAvIDSDesc = 'Usage: ~showAvIds\n\nDescription: Show avatar IDs in Toon nametags.'
MagicWordWire = '~wire'
MagicWordWireDesc = 'Usage: ~wire\n\nDescription: Toggle wireframe mode.'
MagicWordFPS = '~fps'
MagicWordFPSDesc = 'Usage: ~fps\n\nDescription: Toggle FPS meter.'
MagicWordTextures = '~textures'
MagicWordTexturesDesc = 'Usage: ~textures\n\nDescription: Toggle textures off and on.'
MagicWordLeftHand = '~leftHand'
MagicWordLeftHandDesc = "Usage: ~leftHand [prop name]\n\nDescription: Place a prop into a Toon's left hand."
MagicWordRightHand = '~rightHand'
MagicWordRightHandDesc = "Usage: ~rightHand [prop name]\n\nDescription: Place a prop into a Toon's right hand."
MagicWordPingPong = '~pingPong'
MagicWordPingPongDesc = 'Usage: ~pingPong [animation]\n\nDescription: Bounce between the start and end of an animation.'
MagicWordPose = '~pose'
MagicWordPoseDesc = 'Usage: ~pose [animation] [frame #]\n\nDescription: Pause your Toon at a certain frame in an animation.'
MagicWordLoop = '~loop'
MagicWordLoopDesc = 'Usage: ~loop [animation]\n\nDescription: Loop your Toon in an animation.'
MagicWordGreen = '~green'
MagicWordGreenDesc = 'Usage: ~green [cog abbreviation - NPC name]\n\nDescription: Green the target Toon with specified Cog or NPC.\n\nExample: ~green mh - Greens a Toon with a Mr. Hollywood.'
MagicWordMaxDoodle = '~maxDoodle'
MagicWordMaxDoodleDesc = 'Usage: ~maxDoodle\n\nDescription: Maxes your Doodle.'
MagicWordFeedDiners = '~feedDiners'
MagicWordFeedDinersDesc = 'Usage: ~feedDiners\n\nDescription: Feed all the diners in a CEO battle.'
MagicWordDisableGoons = '~disableGoons'
MagicWordDisableGoonsDesc = 'Usage: ~disableGoons\n\nDescription: Disables all Goons in the current area.'
MagicWordSpawnProp = '~spawnProp'
MagicWordSpawnPropDesc = 'Usage: ~spawnProp [prop]\n\nDescription: Spawns a prop at your feet. Only works in Playgrounds.'
MagicWordStunVP = '~stunVP'
MagicWordStunVPDesc = 'Usage: ~stunVP\n\nDescription: Stuns the Sellbot VP in the final round.'
MagicWordTPose = '~tpose'
MagicWordTPoseDesc = 'Usage: ~tpose\n\nDescription: Removes the animation that is currently being played.'
MagicWordSetEyes = '~setEyes'
MagicWordSetEyesDesc = "Usage: ~setEyes [0 - 4]\n\nDescription: Change your Toon's eyes.\n\nExample: ~setEyes 2 - Changes your eyes into angry eyes."
MagicWordSetMuzzle = '~setMuzzle'
MagicWordSetMuzzleDesc = "Usage: ~setMuzzle [0 - 5]\n\nDescription: Change your Toon's muzzle.\n\nExample: ~setMuzzle 3 - Changes your muzzle into a delighted muzzle."
MagicWordSetAccessLevel = '~setAccessLevel'
MagicWordSetAccessLevelDesc = "Usage: ~setAccessLevel [-1 - 2]\n\nDescription: Change someone's access to commands."
MagicWordTrolley = '~trolley'
MagicWordTrolleyDesc = 'Usage: ~trolley\n\nDescription: Ding Ding!'
MagicWordPlaySound = '~playSound'
MagicWordPlaySoundDesc = 'Usage: ~playSound [sound]\n\nDescription: Plays specified sound on the target.\n\nExample: ~playSound ttoff_theme - Plays the Toontown Offline theme song.'
MagicWordSetTaskCarry = '~setTaskCarry'
MagicWordSetTaskCarryDesc = 'Usage: ~setTaskCarry [1 - 4]\n\nDescription: Sets the number of ToonTasks that your Toon can carry.\n\nExample: ~setTaskCarry 2 - Lets you carry 2 ToonTasks.'
MagicWordGetZone = '~getZone'
MagicWordGetZoneDesc = 'Usage: ~getZone\n\nDescription: Returns the zone ID of the target.'
MagicWordSetScale = '~setScale'
MagicWordSetScaleDesc = "Usage: ~setScale [0.4 - 5]\n\nDescription: Sets the scale of the target.\n\nExample: ~setScale 5 - Sets the target's scale to 5."
MagicWordInstaDelivery = '~instaDelivery'
MagicWordInstaDeliveryDesc = 'Usage: ~instaDelivery\n\nDescription: Instantly delivers all cattlelog orders, including all future orders.'
MagicWordAlwaysHitCogs = '~alwaysHitCogs'
MagicWordAlwaysHitCogsDesc = 'Usage: ~alwaysHitCogs\n\nDescription: Your gags will now always hit the Cogs.'
HackerbotProgressNoPartReceived = 'Sorry, you did not receive a Hackerbot suit part.'
HackerbotProgressSuitComplete = 'Congratulations! You have completed your Hackerbot disguise!'
QuizLeaveButton = 'Leave'
EventManagerSettings = 'Event Settings'
EventManagerStartEvent = 'Start Event'
EventManagerMode = 'Event Mode'
EventManagerFreeMode = 'Free Mode'
EventManagerStrictMode = 'Strict Mode'
EventManagerDelay = 'Delay'
ToontownOfflineTeamCredits = [
 [
  'ROLE_DEVELOPER', 'Developers'],
 [
  'JawhnL5', 'Project Lead & Lead Developer'],
 [
  'Sparkpin', 'Developer'],
 [
  'Rocky Reborn', 'Head Producer & Developer'],
 [
  "Smokin' Foreman", 'Head Artist & Developer'],
 [
  'Nickdoge', 'Developer'],
 [
  'Ryno', 'Video Producer & Developer'],
 [
  'Frank', 'Website & Game Developer'],
 [
  'Jake S.', 'Head Website Developer'],
 [
  'Little Cat', 'Developer'],
 [
  'Hypsin88', 'Developer'],
 [
  'Bear E. Funny', 'Assistant Developer'],
 [
  'Disyer', 'Assistant Developer'],
 [
  'ROLE_ARTIST', 'Artists'],
 [
  'Supertricky', '3D Artist'],
 [
  'Ned', '2D Artist'],
 [
  'Loonatic', '2D Artist'],
 ...
 [
  'Allyjean', '2D Artist'],
 [
  'ROLE_MUSICIAN', 'Composers'],
 [
  'Toontown Musician', 'Composer'],
 [
  'Retro Aesthetic', 'Head Composer'],
 [
  'ROLE_SUPPORT', 'Supporters'],
 [
  'Mr. Cheeze', 'Support'],
 [
  'Jamie', 'Support'],
 [
  'ROLE_EXSTAFF', 'Former Staff'],
 [
  'Logano', 'Project Founder & Former Developer'],
 [
  'Odie5776', 'Former 3D Artist'],
 [
  'Triangles', 'Former 3D Artist & Composer'],
 [
  'InvisbleMario', 'Former Developer'],
 [
  'Emily', 'Former Support'],
 [
  'Yippie', 'Former Support'],
 [
  'Brady', 'Former 2D Artist'],
 [
  'ROLE_CONTRIBUTORS', 'Contributors'],
 [
  'Lord Top Cat', 'Original Website Host'],
 [
  'Loblao', 'Development Assistance & Game Deployment'],
 [
  'Markgasus', 'Development Assistance & Input'],
 [
  'Necromoni', 'Development Assistance'],
 [
  'Seto', 'Development Assistance'],
 [
  'Dank Mickey', 'Development Assistance'],
 [
  'QED', 'Development Assistance'],
 [
  'Sweet Ratt', '3D Art'],
 [
  'Treetop Legend', '3D Art'],
 [
  'Christopher ', '3D Art'],
 [
  'Nicholas Lionrider', '2D Art'],
 [
  'Piplup', '2D Art'],
 [
  'Feathers', '2D Art'],
 [
  'Professor Meow', 'Music'],
 [
  'Sir Beppo', 'Music'],
 [
  'Startomas', 'Sfx'],
 [
  'MakotaRedheart', 'Writing']]
ToontownOnlineTeamCredits = [
 [
  'IMG_TTO', "Disney's Toontown Online"],
 [
  'ROLE_ORGANIZATIONS', 'Organizations'],
 [
  'Disney Interactive Media Group', 'Game Developer'],
 [
  'Schell Games', 'Contracters'],
 [
  'Frogchildren Studios', 'Contracters'],
 [
  'ROLE_MANAGEMENT', 'Management'],
 [
  'Jesse Schell', 'Head Designer & Developer'],
 [
  'Mike Goslin', 'Director & Panda3D Engineer'],
 [
  'Greg Wiatroski', 'Director'],
 [
  'Felipe Lara', 'Creative Director, 2D Artist'],
 [
  'Ellen Steur', 'Producer'],
 [
  'Sarah Lowery', 'Producer'],
 [
  'Ryan McDonald', 'Producer'],
 [
  'Chris Barkoff', 'Producer'],
 [
  'Starr Long', 'Producer'],
 [
  'Steve Wadsworth', 'Walt Disney Internet Group President'],
 [
  'Ken Goldstein', 'Disney Online Vice President'],
 [
  'ROLE_DEVELOPER', 'Developers'],
 [
  'Shawn Patton', 'Developer'],
 [
  'Jason Everett', 'Developer'],
 [
  'Samik Bhowal', 'Developer'],
 [
  'Joe Shochet', 'Developer'],
 [
  'Roger Hughston', 'Developer'],
 [
  'David Rose', 'Panda3D Engineer'],
 [
  'Mark Mine', 'Panda3D Engineer'],
 [
  'Chris Brunner', 'Panda3D Engineer'],
 [
  'ROLE_ARTIST', 'Artists'],
 [
  'Jay Friedmann', '2D Artist'],
 [
  'Darren Chang', '2D Artist'],
 [
  'Matt Oldfield', '3D Artist'],
 [
  'James Schauf', '3D Artist'],
 [
  'Debbie Kim', '3D Artist'],
 [
  'John DiRiggi', '3D Artist'],
 [
  'Bruce Woodside', 'Animation Director'],
 [
  'Richard Edwards', '3D Animator'],
 [
  'Bridget McKahan', '3D Animator'],
 [
  'Dave Chiapperino', '3D Animator'],
 [
  'ROLE_MUSICIAN', 'Composers'],
 [
 ...
 [
  'Maury Mclntyre', 'Marketing Director'],
 [
  'Ben Luce', 'Marketing Artist'],
 [
  'Jenna Parlato', 'Marketing Artist'],
 [
  'Kathleen Donaldson', 'Marketing Artist']]
ToontownRewrittenTeamCredits = [
 [
  'IMG_TTR', 'Toontown Rewritten'],
 [
  'ROLE_DEVELOPER', 'Developers'],
 [
  'JoeyZio', 'Project Lead & Developer'],
 [
  'Hawkheart', 'Lead Developer'],
 [
  'AlJaMa', 'Astron Developer'],
 [
  'AC Town', 'Server Administator'],
 [
  'LukeWarm74', 'Website Developer'],
 [
  'jjkoletar', 'Developer'],
 [
  'Harv', 'Developer'],
 ...
 [
  'Anth', 'Developer'],
 [
  'Blindsight', 'Developer'],
 [
  'Gustavo', 'Developer'],
 [
  'The Random Dog', 'Public Relations & Applications Developer'],
 [
  'Scootz', 'Alternate Reality Game Developer'],
 [
  'ROLE_ARTIST', 'Artists'],
 [
  'Roger Dog', 'Head 3D Artist'],
 [
  'Slate Blue Rabbit', 'Head 2D Artist'],
 [
  'Zigguratxnaut', '3D Artist'],
 [
  'Flippy Cheezer', '3D Artist'],
 [
  'Captain McCrunchy', '3D Artist'],
 [
  'Captain Lollipop', '3D Artist'],
 [
  'Joshora', '3D Artist'],
 [
  'Garfieldo', '3D Artist'],
 ...
 [
  'ROLE_MUSICIAN', 'Composers'],
 [
  'Consonus', 'Head Composer'],
 [
  'Cool Peaches', 'Composer'],
 [
  'YorkeTheMouse', 'Composer'],
 [
  'Dale', 'Composer'],
 [
  'Jethred', 'Composer']]
SpecialThanksCredits = [
 ...
 [
  'IMG_TTI', 'Toontown Infinite'],
 [
  'IMG_TTS', 'Toontown Stride'],
 [
  'IMG_TTH', 'Toontown House'],
 [
  'IMG_ODS', 'Operation Dessert Storm'],
 [
  'IMG_TTFF', "Toontown's Funny Farms"],
 [
  'ROLE_TESTERS', 'Testers'],
 [
  'Natalie', '/r/toontown Head Mod, Tester, & Friend'],
 [
  'Louie Picklezilla', 'Tester & Friend'],
 [
  'Forks', 'Tester & Friend'],
 [
  'True Blue Dogemon', 'Tester & Friend'],
 [
  'Aelicien', 'Tester & Friend'],
 [
  'Riley', 'Tester & Friend'],
 [
  'Shoe', 'Tester & Friend'],
 [
  'Doctor Popcorn McBurger', 'Tester & Friend'],
 [
  'Tommeh', 'Tester & Friend'],
 [
  'Madsiekins', 'Tester & Friend'],
 [
  'Tookie', 'Tester & Friend'],
 [
  'ROLE_COMMUNITY_CONTRIBUTORS', 'Community Contributors'],
 [
  'Bowser Jr.', 'Community Contributor'],
 [
  'Chayoyo', 'Community Contributor'],
 [
  'Katchra', 'Community Contributor'],
 [
  'The Familiar Scoot', 'Community Contributor'],
 [
  'Gent', 'Community Contributor'],
 [
  'Inspiring Emerald', 'Community Contributor'],
 [
  'Momoishappy', 'Community Contributor'],
 [
  'No Life Logano', 'Community Contributor'],
 [
  'Prof McMouse', 'Community Contributor'],
 [
  'Yolkimus', 'Community Contributor'],
 [
  'S.J.', 'Community Contributor'],
 [
  'Bagel Man', 'Community Contributor'],
 [
  'Toon Joey', 'Community Contributor'],
 [
  'Jake', 'Community Contributor'],
 [
  'Cephei', 'Community Contributor'],
 [
  'ROLE_MISC', 'Miscellaneous'],
 [
  'Gina', "Designer of the Solo 'Jazz Cup'"],
 [
  'Supertricky', 'Thank you for your friendship, talents, & emmense efforts'],
 [
  '...AND YOU.', ''],
 [
  '...Thank you for playing our game. We hope you enjoyed.', '']]
SwagtoryReward = ['That was intense! You deserve a reward. Take this {0} {1} summon.', 'gg no re. Take this {0} {1} summon.', 'Amazing job, Toon. Take this {0} {1} summon.']
RankNineUnknown = 'rank 9 {0}'
SwagtoryNoReward = "You didn't get a reward this time. Try again, Toon."
RiggyChatter = ["They didn't believe ToonFest was a pie in the sky idea, but look at those pies now! HAH!",
 ...
 "They ain't selling my own bowtie in the sh-- hey, where IS my bowtie?",
 ...
 "Say, _avName_, I'm liking the look. Ever tried adding a spotted bowtie to it?",
 '_avName_, let me tell you, YOU would look good in ToonFest Blue!',
 ...
 "Woah, woah, don't get so close! There's a glue spill here!",
 "I absolutely love the view from here. Good thing, too, because I can't move from this spot!",
 'I was told my movement choreography plan was lost in the mail... or did they never make it? Hmm...']
LowdenTalk = "Hey there, {0}!\x07We're still waiting on other Toons, so hang in there!\x07This will be a dangerous operation, so I recommend that you take a full group of 8 Toons."
LowdenAlreadyTalked = "Can you feel the excitement in the air?\x07The Operation's getting closer every second... I can just see Slappy now!\x07It's almost time... get ready!"
...
DownsizerSpeakCog = "Who are you looking at, Cashbot?\x07Yea, I know I'm not supposed to be here.\x07See, I worked in that Bar a couple floors down.\x07Then some shmoozer with a look like me took my position.\x07The nerve!\x07Whatever. The CEO was just demoted again, not like I have anything to do."
DownsizerSpeakCog2 = "That's sure off.\x07You're looking rather up there, Short Change.\x07Has a Toon gotten to you?\x07Thought so. Those dastardly animals always bringing along fun!\x07You should report that intrusion to the CFO!"
MinglerSpeakCog = 'I just got promoted from Two-Face!\x07Ahem. My apologies, Short Change.\x07I should know better than to express toon-like qualities such as excitement over promotion.\x07Carry on then, I am waiting on my co-worker, Name Dropper.'
MinglerSpeakCog2 = 'I just got promoted from Two-Face!\x07I see your health meter shows some excitement too, Short Change.\x07Ahem. What am I thinking, silliness is the worst.\x07My deep apologies for expressing this toon-like attitude.\x07A Toon got you silly too, then?\x07It will be best to stay here and get grumpy again, then.\x07Send my regards to Penny Pincher.'
CheezeSpeakCog1 = 'Rub off, Short change.\x07No?\x07Nobody has been that direct to me in a while.\x07The last person who talked to me like that was quite a Shmoozer.\x07As a level 50 Cog, I must order you to get back to work.\x07What? Do I need to pressure you with some Positive Reinforcement?'
TelemarketerSpeakCog1 = "Just look at that Eagle.\x07He's staring me down like a hawk.\x07...\x07Typical Lawbot."
EagleSpeakCog1 = 'What a greasy Sellbot Telemarketer is.\x07His calls to the DA Offices only peck the surface.\x07...\x07Typical Sellbot.'
ToonFestTrampolineBeanResults = 'You collected %d tokens.'
ToonFestTrampolineBonusTokenResults = 'You collected %d jellybeans, plus %d more for getting the Big Bean. '
ToonFestRewardDoubledJellybean = 'Double Tokens!'
ToonFestTrampolineTokenTitle = 'Token Trampoline'
ToonFestTrampolineActivityInstructions = 'Use the Control key to jump.\n\nJump when your Toon is at its lowest point on the trampoline to jump higher.'
ToonFestCannonActivityTitle = 'ToonFest Cannons'
ToonFestCannonActivityInstructions = 'Hit the clouds to change their color and bounce in the air! While IN THE AIR, you can USE THE ARROW KEYS to GLIDE.'
ToonFestCannonResults = 'You collected %d tokens!\n\nNumber of Clouds Hit: %d'
Credit = 'Powered by the Fabulous Toontown Rewritten Engine'
CreditHalloween = 'Powered by the Spooky Toontown Rewritten Engine'
CreditWinter = 'Powered by the Merry Toontown Rewritten Engine'
CreditElections = 'Powered by the Democratic Toontown Rewritten Engine'
CreditAprilFools = 'stolen from toontown rewritten :D'