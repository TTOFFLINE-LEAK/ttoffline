...
import sys, os, math, tempfile, shutil, atexit, ToontownAccess, TTLocalizer, ToontownBattleGlobals, ShaderManager
...
class ToonBase(OTPBase.OTPBase):
    ...
    def initNametagGlobals(self):
        ...
        exclaim3d = ChatBalloon(loader.loadModel('phase_3/models/props/chatbox_exclaim_cutout'))
        speech2d = ChatBalloon(loader.loadModel('phase_3/models/props/chatbox_noarrow'))
        if config.GetBool('want-retro-mode', False):
            rtex = loader.loadTexture('phase_3/maps/avatar_palette_1llla_1_retro.jpg')
            speech3d.model.setTexture(rtex, 1)
            thought3d.model.setTexture(rtex, 1)
            speech2d.model.setTexture(rtex, 1)
            exclaim3d.model.setTexture(loader.loadTexture('phase_3/maps/spikey_bubble_retro.jpg'), 1)
