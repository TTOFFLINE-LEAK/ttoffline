...
class EstateHood(Hood.Hood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_5.5/dna/storage_estate.jazz'
        self.holidayStorageDNADict = {WINTER_DECORATIONS: ['phase_5.5/dna/winter_storage_estate.jazz'], WACKY_WINTER_DECORATIONS: [
                                    'phase_5.5/dna/winter_storage_estate.jazz'], 
           HALLOWEEN_PROPS: [
                           'phase_5.5/dna/halloween_props_storage_estate.jazz'], 
           SPOOKY_PROPS: [
                        'phase_5.5/dna/halloween_props_storage_estate.jazz']}
