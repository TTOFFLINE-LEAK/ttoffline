...
class GZHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_6/dna/storage_GZ.jazz'
        self.holidayStorageDNADict = {HALLOWEEN_PROPS: ['phase_6/dna/halloween_props_storage_GZ.jazz'], SPOOKY_PROPS: [
                        'phase_6/dna/halloween_props_storage_GZ.jazz']}
