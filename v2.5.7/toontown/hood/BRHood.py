...
class BRHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_8/dna/storage_BR.jazz'
        self.holidayStorageDNADict = {WINTER_DECORATIONS: ['phase_8/dna/winter_storage_BR.jazz'], WACKY_WINTER_DECORATIONS: [
                                    'phase_8/dna/winter_storage_BR.jazz'], 
           HALLOWEEN_PROPS: [
                           'phase_8/dna/halloween_props_storage_BR.jazz'], 
           SPOOKY_PROPS: [
                        'phase_8/dna/halloween_props_storage_BR.jazz']}
