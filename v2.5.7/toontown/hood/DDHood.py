...
class DDHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_6/dna/storage_DD.jazz'
        self.holidayStorageDNADict = {WINTER_DECORATIONS: ['phase_6/dna/winter_storage_DD.jazz'], WACKY_WINTER_DECORATIONS: [
                                    'phase_6/dna/winter_storage_DD.jazz'], 
           HALLOWEEN_PROPS: [
                           'phase_6/dna/halloween_props_storage_DD.jazz'], 
           SPOOKY_PROPS: [
                        'phase_6/dna/halloween_props_storage_DD.jazz']}
