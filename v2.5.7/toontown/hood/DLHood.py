...
class DLHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_8/dna/storage_DL.jazz'
        self.holidayStorageDNADict = {WINTER_DECORATIONS: ['phase_8/dna/winter_storage_DL.jazz'], WACKY_WINTER_DECORATIONS: [
                                    'phase_8/dna/winter_storage_DL.jazz'], 
           HALLOWEEN_PROPS: [
                           'phase_8/dna/halloween_props_storage_DL.jazz'], 
           SPOOKY_PROPS: [
                        'phase_8/dna/halloween_props_storage_DL.jazz']}
