...
class DGHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_8/dna/storage_DG.jazz'
        self.holidayStorageDNADict = {WINTER_DECORATIONS: ['phase_8/dna/winter_storage_DG.jazz'], WACKY_WINTER_DECORATIONS: [
                                    'phase_8/dna/winter_storage_DG.jazz'], 
           HALLOWEEN_PROPS: [
                           'phase_8/dna/halloween_props_storage_DG.jazz'], 
           SPOOKY_PROPS: [
                        'phase_8/dna/halloween_props_storage_DG.jazz']}
