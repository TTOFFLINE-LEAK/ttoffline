    ...
    if tutorialDict:
        ...
        if isCogHQZone(zoneId):
            if suffix == 0:
                ...
                where = 'cogHQLobby'
            elif suffix == 200 or getHoodId(zoneId) == SellbotHQ and suffix in (300,
                                                                                400):
                where = 'factoryExterior'
            elif zoneId in ShortWorkZones:
                where = 'factoryExterior'
            elif getHoodId(zoneId) == CashbotHQ and suffix == 800:
                where = 'factoryExterior'
            ...
            elif getHoodId(zoneId) == BossbotHQ and suffix == '800':
                where = 'cogHQExterior'
            elif suffix >= 500:
