...
class OZHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_6/dna/storage_OZ.jazz'
        self.holidayStorageDNADict = {HALLOWEEN_PROPS: ['phase_6/dna/halloween_props_storage_OZ.jazz'], SPOOKY_PROPS: [
                        'phase_6/dna/halloween_props_storage_OZ.jazz']}
