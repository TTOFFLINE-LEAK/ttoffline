...
class GSHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.storageDNAFile = 'phase_6/dna/storage_GS.jazz'
        self.holidayStorageDNADict = {HALLOWEEN_PROPS: ['phase_6/dna/halloween_props_storage_GS.jazz'], SPOOKY_PROPS: [
                        'phase_6/dna/halloween_props_storage_GS.jazz'], 
           CRASHED_LEADERBOARD: [
                               'phase_6/dna/crashed_leaderboard_storage_GS.jazz']}
