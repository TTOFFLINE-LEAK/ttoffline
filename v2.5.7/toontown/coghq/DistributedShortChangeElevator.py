...
class DistributedShortChangeElevator(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setupElevator(self):
        ...
        self.elevatorModel.setPosHpr(0, -25, 0, 180, 0, 0)
    ...
    def getDestName(self):
        return TTLocalizer.lHighriseHallway