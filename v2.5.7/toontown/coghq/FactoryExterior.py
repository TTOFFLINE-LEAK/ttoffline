...
class FactoryExterior(BattlePlace.BattlePlace):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('FactoryExterior', [
         ...
         State.State('trainIn', self.enterTrainIn, self.exitTrainIn, ['teleportIn', 'walk', 'WaitForBattle', 'battle']),
    ...
    def enterTrainIn(self, requestStatus):
        self.fsm.request('teleportIn', [requestStatus])

    def exitTrainIn(self):
        pass
    ...
    def handleElevatorDone(self, doneStatus):
        ...
        if where == 'reject':
            ...
            if where == 'exit':
                ...
                if where == 'factoryInterior' or where == 'swagtoryInterior':
