    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('CogHQExterior', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, ['elevator',
          ...
          'squished',
          'stopped']),
         State.State('stopped', self.enterStopped, self.exitStopped, ['walk', 'teleportOut', 'stickerBook', 'elevator']),
         ...
         State.State('died', self.enterDied, self.exitDied, ['quietZone', 'walk']),
