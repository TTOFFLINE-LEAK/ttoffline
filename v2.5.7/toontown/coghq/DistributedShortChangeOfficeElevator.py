...
class DistributedShortChangeOfficeElevator(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setupElevator(self):
        ...
        self.elevatorModel.setPosHpr(0, 49.25, 0, 0, 0, 0)
    ...
    def enterClosing(self, ts):
        ...
        if self.localToonOnBoard:
            ...
            self.seq = Sequence(self.explosionCard.colorScaleInterval(2, (0, 0, 0,
                                                                          1)), Wait(2.5), self.explosionCard.colorScaleInterval(1, (0,
                                                                                                                                    0,
                                                                                                                                    0,
    ...
    def getDestName(self):
        return TTLocalizer.lShortChangeOffice