...
SecretFriendsInfoPanelText = ['\nThe Open Chat with True Friends Feature\n\nThe Open Chat with True Friends feature enables a member to chat directly with another member within Toontown Offline (the "Service") once the members establish a True Friends connection. Here is a detailed description of the process of creating an Open Chat with True Friends connection between members whom we will call "John" and "Little Cat."\n1. First, John requests a True Friend Code (described below) from within the Service.\n',
...
CRFullDistrictsTryAgain = 'This Mini-Server is currently full. Try again?'
...
CRLoadingGameServicesAstron = 'Loading Astron (1 of 3)'
CRLoadingGameServicesUberdog = 'Loading Uberdog (2 of 3)'
CRLoadingGameServicesAI = 'Loading AI Server (3 of 3)'
CRBootedReasons = {BootedUnexpectedProblem: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.', 
   ...
   BootedConnectionKilled: 'There has been an unexpected problem logging you in. If this issue persists, please contact Toontown Offline support.', 
   ...
   BootedToonIssue: 'A problem has occurred with your Toon.  If this issue persists, please contact Toontown Offline support.', 
   BootedKickedForMaintenance: 'You have been logged out by an administrator working on the servers.', 
   BootedBanned: 'You have been banned from this mini-server. If you have any questions please contact the mini-server host. \n\nReason for ban: \n%(name)s', 
   BootedKicked: "You've been kicked by a moderator.\n\nReason:\n%(name)s", 
...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
   ...
   'mdr': [
         'Speedway Master and Roger Dog, reporting for duty.',
         "Would you like to play 'The Molder Game: An Epic Journey of World Domination'?",
         'The Molders are taking over TOONTOWN CENTRAL!',
         'I think you should talk to the Goofinator.',
         'Some Molder Membership would fit you well.']}
SpeedChatStaticTextCommon = {1: lYes, 2: lNo, 
   3: lOK, 
   4: 'SPEEDCHAT PLUS'}
SpeedChatStaticTextToontown = {100: 'Hi!', 101: 'Hello!', 
   102: 'Hi there!', 
   103: 'Hey!', 
   104: 'Howdy!', 
   105: 'Hi everybody!', 
   ...
   4306: 'Shhhh!', 
   4307: 'Good game!', 
   4400: "Let's play Cog minigolf!", 
   4500: "Let's play 'The Terrifying Two.'", 
   4501: 'That course is too coggy!', 
   ...
   20351: SuitFaceoffTaunts['sf'][0], 
   20352: SuitFaceoffTaunts['sf'][1], 
   20353: SuitFaceoffTaunts['sf'][2], 
   20354: SuitFaceoffTaunts['sf'][3], 
   20355: SuitFaceoffTaunts['sf'][4], 
   20356: SuitFaceoffTaunts['sm'][0], 
   20357: SuitFaceoffTaunts['sm'][1], 
   20358: SuitFaceoffTaunts['sm'][2], 
   20359: SuitFaceoffTaunts['sm'][3], 
   20360: SuitFaceoffTaunts['sm'][4], 
   20361: SuitFaceoffTaunts['mdr'][0], 
   20362: SuitFaceoffTaunts['mdr'][1], 
   20363: SuitFaceoffTaunts['mdr'][2], 
   20364: SuitFaceoffTaunts['mdr'][3], 
   20365: SuitFaceoffTaunts['mdr'][4], 
   21000: 'Here boy!', 
   21001: 'Here girl!', 
   21002: 'Stay.', 
   21003: 'Good boy!', 
...
TextColors = {'red': (1, 0, 0, 1), 
   ...
   'beige': (1, 0.95, 0.7, 1), 
   'amber': (1, 0.75, 0, 1), 
   'amaranth': (0.9, 0.15, 0.3, 1), 
   'androidGreen': (0.65, 0.75, 0.2, 1), 
   'caribbeanGreen': (0, 0.8, 0.6, 1), 
   'azure': (0, 0.5, 1, 1), 
   'cobalt': (0, 0.3, 0.65, 1), 
   'forestGreen': (0.15, 0.8, 0.15, 1)}
DynamicColors = []
DynamicFonts = []
