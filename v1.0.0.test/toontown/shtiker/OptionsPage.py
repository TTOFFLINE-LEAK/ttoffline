...
magicWordActivators = [2400, 2401, 2402, 2403, 2404, 2405]
if not config.GetBool('exec-chat', 0):
    magicWordActivators.append('>')
PageMode = PythonUtil.Enum('Options, ExtraOptions, Codes')
...
class OptionsPage(ShtikerPage.ShtikerPage):
                                                                                                                                                                              ...
                                                                                                                                                                              0.0), image=gui.find('**/tabs/polySurface1'), image_pos=(0.55,
                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                       -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          -90), image_scale=(0.033,
                                                                                                                                                                                                                                                                             0.033,
                                                                                                                                                                                                                                                                             0.035), image_color=normalColor, image1_color=clickColor, image2_color=rolloverColor, image3_color=diabledColor, text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode, extraArgs=[PageMode.Options], pos=(-0.61,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     0.77))
        self.extraOptionsTab = DirectButton(parent=self, relief=None, text=TTLocalizer.ExtraOptionsPageTitle, text_scale=TTLocalizer.OPextraoptionsTab, text_align=TextNode.ALeft, text_pos=(-0.04,
                                                                                                                                                                                             0.0,
                                                                                                                                                                                             0.0), image=gui.find('**/tabs/polySurface1'), image_pos=(0.55,
                                                                                                                                                                                                                                                      1,
                                                                                                                                                                                                                                                      -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         -90), image_scale=(0.033,
                                                                                                                                                                                                                                                                                            0.033,
                                                                                                                                                                                                                                                                                            0.035), image_color=normalColor, image1_color=clickColor, image2_color=rolloverColor, image3_color=diabledColor, text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode, extraArgs=[PageMode.ExtraOptions], pos=(-0.14,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         0.77))
        self.codesTab = DirectButton(parent=self, relief=None, text=TTLocalizer.OptionsPageCodesTab, text_scale=TTLocalizer.OPoptionsTab, text_align=TextNode.ALeft, text_pos=(-0.035,
                                                                                                                                                                               ...
                                                                                                                                                                               0.0), image=gui.find('**/tabs/polySurface2'), image_pos=(0.12,
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                           -90), image_scale=(0.033,
                                                                                                                                                                                                                                                                              0.033,
                                                                                                                                                                                                                                                                              0.035), image_color=normalColor, image1_color=clickColor, image2_color=rolloverColor, image3_color=diabledColor, text_fg=Vec4(0.2, 0.1, 0, 1), command=self.setMode, extraArgs=[PageMode.Codes], pos=(0.33,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    0.77))
        return
    ...
    def unload(self):
        ...
        self.extraOptionsTabPage.unload()
        del self.title
...
class OptionsTabPage(DirectFrame):
    ...
    def load(self):
        ...
        self.DisplaySettingsButton = DirectButton(parent=self, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image3_color=Vec4(0.5, 0.5, 0.5, 0.5), image_scale=button_image_scale, text=TTLocalizer.OptionsPageChange, text3_fg=(0.5,
                                                                                                                                                                                                                                                                                                              0.5,
                                                                                                                                                                                                                                                                                                              0.5,
                                                                                                                                                                                                                                                                                                              0.75), text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - textRowHeight * 5), command=self.__doDisplaySettings)
        self.speedChatStyleLeftArrow = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         ...
         gui.find('**/Horiz_Arrow_UP')), image3_color=Vec4(1, 1, 1, 0.5), scale=(-1.0,
                                                                                 1.0,
                                                                                 1.0), pos=(0.25, 0, buttonbase_ycoord - textRowHeight * 6), command=self.__doSpeedChatStyleLeft)
...
class ExtraOptionsTabPage(DirectFrame):
    ...
    def load(self):
        ...
        options_text_scale = 0.052
        self.speed_chat_scale = 0.055
        self.TextToSpeech_Label = DirectLabel(parent=self, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, pos=(leftMargin, 0, textStartHeight))
        self.TextToSpeechFilePath_Label = DirectLabel(parent=self, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, pos=(
         leftMargin, 0, textStartHeight - textRowHeight + 0.025))
        ...
        self.TextToSpeechFilePath_toggleButton = DirectButton(parent=self, relief=None, image=(
         guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(
         buttonbase_xcoord, 0.0,
         buttonbase_ycoord - textRowHeight + 0.025), command=self.__doToggleTextToSpeechFilePath)
        self.TextToSpeechFilePath_toggleButton.setScale(0.8)
        self.magicWordActivatorLeftArrow = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), image3_color=Vec4(1, 1, 1, 0.5), scale=(-1.0,
                                                                                 1.0,
                                                                                 1.0), pos=(
         0.25, 0, buttonbase_ycoord - textRowHeight * 2), command=self.__doMagicWordActivatorLeft)
        self.magicWordActivatorRightArrow = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), image3_color=Vec4(1, 1, 1, 0.5), pos=(
         0.65, 0, buttonbase_ycoord - textRowHeight * 2), command=self.__doMagicWordActivatorRight)
        self.magicWordActivatorText = SpeedChat.SpeedChat(name='ExtraOptionsPageMagicWordActivator', structure=[2400], backgroundModelName='phase_3/models/gui/ChatPanel', guiModelName='phase_3.5/models/gui/speedChatGui')
    ...
    def enter(self):
        ...
        self.__setTextToSpeechFilePathButton()
    ...
    def unload(self):
        self.TextToSpeech_toggleButton.destroy()
    ...
    def __doToggleTextToSpeech(self):
        messenger.send('wakeup')
        if self.TextToSpeech_Label['text'] == TTLocalizer.ExtraOptionsPageTextToSpeechNotInstalledLabel:
            webbrowser.open(ToontownGlobals.TextToSpeechLink, new=2)
        if base.textToSpeech:
            base.textToSpeech = 0
            base.settings.updateSetting('game', 'text-to-speech', False)
        else:
            base.textToSpeech = 1
            base.settings.updateSetting('game', 'text-to-speech', True)
        self.settingsChanged = 1
        self.__setTextToSpeechButton()

    def __setTextToSpeechButton(self, changedFilePath=False):
        try:
            if platform != 'darwin':
                ...
                nullDevice.close()
            if base.textToSpeech:
                self.TextToSpeech_Label['text'] = TTLocalizer.ExtraOptionsPageTextToSpeechOnLabel
                self.TextToSpeech_toggleButton['text'] = TTLocalizer.OptionsPageToggleOff
            else:
                self.TextToSpeech_Label['text'] = TTLocalizer.ExtraOptionsPageTextToSpeechOffLabel
                self.TextToSpeech_toggleButton['text'] = TTLocalizer.OptionsPageToggleOn
        except:
            self.TextToSpeech_Label['text'] = TTLocalizer.ExtraOptionsPageTextToSpeechNotInstalledLabel
            self.TextToSpeech_toggleButton['text'] = TTLocalizer.ExtraOptionsPageGetEspeak
            if changedFilePath:
                base.textToSpeech = 0
                base.settings.updateSetting('game', 'text-to-speech', False)
                self.settingsChanged = 1

    def __doToggleTextToSpeechFilePath(self):
        messenger.send('wakeup')
        tempdir = tempfile.gettempdir()
        filePath = tempdir + '\\command_line\\espeak'
        self.__setTextToSpeechFilePathButton(tempdir)
        self.__setTextToSpeechButton(True)

    def __setTextToSpeechFilePathButton(self, filePath=None):
        try:
            if platform != 'darwin':
                nullDevice = open(os.devnull, 'wb')
                if base.textToSpeechPath:
            ...
            self.TextToSpeechFilePath_toggleButton['text'] = TTLocalizer.ExtraOptionsPageSetEspeakPath
        except:
            self.TextToSpeechFilePath_Label['text'] = TTLocalizer.ExtraOptionsPageTextToSpeechFilePathUnsetLabel
            self.TextToSpeechFilePath_toggleButton['text'] = TTLocalizer.ExtraOptionsPageSetEspeakPath

        base.settings.updateSetting('game', 'text-to-speech-path', filePath)
        base.textToSpeechPath = filePath
        self.settingsChanged = 1

    def __doMagicWordActivatorLeft(self):
        if self.magicWordActivatorIndex > 0:
            self.magicWordActivatorIndex = self.magicWordActivatorIndex - 1
            self.updateMagicWordActivator()

    def __doMagicWordActivatorRight(self):
        if self.magicWordActivatorIndex < len(magicWordActivators) - 1:
            self.magicWordActivatorIndex = self.magicWordActivatorIndex + 1
            self.updateMagicWordActivator()

    def updateMagicWordActivator(self):
        activatorId = magicWordActivators[self.magicWordActivatorIndex]
        self.magicWordActivatorText.clearMenu()
        activatorId = SCStaticTextTerminal.SCStaticTextTerminal(activatorId)
        self.magicWordActivatorText.append(activatorId)
        self.magicWordActivatorText.finalize()
        self.magicWordActivatorText.setPos(0.445 - self.magicWordActivatorText.getWidth() * self.speed_chat_scale / 2, 0, self.magicWordActivatorText.getPos()[2])
        if self.magicWordActivatorIndex > 0:
            self.magicWordActivatorLeftArrow['state'] = DGG.NORMAL
        else:
            self.magicWordActivatorLeftArrow['state'] = DGG.DISABLED
        if self.magicWordActivatorIndex < len(magicWordActivators) - 1:
            self.magicWordActivatorRightArrow['state'] = DGG.NORMAL
        else:
