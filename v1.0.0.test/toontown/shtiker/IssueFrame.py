...
class IssueFrame(DirectFrame):
    ...
    def createPage(self, section, subsection, fullFilename):
        ...
        pageFrame = DirectFrame(frameColor=(1, 1, 1, 0), frameSize=self.FrameDimensions, image=upsellBackground, image_scale=(imageScaleX, 1, imageScaleY), relief=DGG.FLAT, parent=self, text='', text_scale=0.06, text_pos=(0,
                                                                                                                                                                                                                              -0.4))
