...
class PhotoAlbumPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.pictureCaption = DirectLabel(parent=self, relief=None, text='Caption', text_scale=0.05, text_wordwrap=10, text_align=TextNode.ACenter, pos=(0.45,
                                                                                                                                                         0,
                                                                                                                                                         -0.22))
        self.renameButton = DirectButton(parent=self, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=(1,
                                                                                                                                                                                             ...
                                                                                                                                                                                             1), pos=(0.45,
                                                                                                                                                                                                      0,
                                                                                                                                                                                                      -0.35), text='Caption', text_scale=0.06, text_pos=(0,
                                                                                                                                                                                      ...
                                                                                                                                                                                      'Delete'), text_fg=(1,
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          1), text_shadow=(0,
                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                           1), text_scale=0.1, text_pos=(0,
                                                                                                                                                                                                                                                         -0.1), text_font=ToontownGlobals.getInterfaceFont(), textMayChange=0, relief=None, pos=(0.73,
                                                                                                                                                                                                                                                                                                                                                 0,
        ...
        self.scrollList = DirectScrolledList(parent=self, relief=None, forceHeight=0.07, pos=(-0.5,
         ...
         gui.find('**/FndsLst_ScrollUp')), incButton_relief=None, incButton_scale=(1.3,
                                                                                   ...
                                                                                   -1.3), incButton_pos=(0,
                                                                                                         0,
                                                                                                         -0.51), incButton_image3_color=Vec4(1, 1, 1, 0.2), decButton_image=(gui.find('**/FndsLst_ScrollUp'),
         gui.find('**/FndsLst_ScrollDN'),
         gui.find('**/FndsLst_ScrollUp_Rllvr'),
         gui.find('**/FndsLst_ScrollUp')), decButton_relief=None, decButton_scale=(1.3,
                                                                                   ...
                                                                                   1.3), decButton_pos=(0,
                                                                                                        0,
                                                                                                        0.51), decButton_image3_color=Vec4(1, 1, 1, 0.2), itemFrame_pos=(-0.237,
                                                                                                                                                                         0,
        ...
        self.bCancel = DirectButton(parent=self.renamePanel, image=(buttons.find('**/CloseBtn_UP'), buttons.find('**/CloseBtn_DN'), buttons.find('**/CloseBtn_Rllvr')), relief=None, text='Cancel', text_scale=0.05, text_pos=(0.0,
                                                                                                                                                                                                                               -0.1), pos=(0.0,
                                                                                                                                                                                                                                           0.0,
        ...
        self.deletePanel = DirectFrame(parent=self, relief=None, pos=(0, 0, 0), image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.0,
                                                                                                                                                                              ...
                                                                                                                                                                              0.6), text='Delete Photo?', text_scale=0.06, text_pos=(0.0,
                                                                                                                                                                                                                                     0.13), sortOrder=NO_FADE_SORT_INDEX)
        self.dOk = DirectButton(parent=self.deletePanel, image=(buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr')), relief=None, text='Ok', text_scale=0.05, text_pos=(0.0,
                                                                                                                                                                                                                                -0.1), pos=(-0.1,
                                                                                                                                                                                                                                            0.0,
                                                                                                                                                                                                                                            -0.1), command=self.deleteConfirm)
        self.dCancel = DirectButton(parent=self.deletePanel, image=(buttons.find('**/CloseBtn_UP'), buttons.find('**/CloseBtn_DN'), buttons.find('**/CloseBtn_Rllvr')), relief=None, text='Cancel', text_scale=0.05, text_pos=(0.0,
                                                                                                                                                                                                                               -0.1), pos=(0.1,
                                                                                                                                                                                                                                           0.0,
