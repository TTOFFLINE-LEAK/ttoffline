...
scStructure = [
 ...
 [
  ...
  207],
 [
  OTPLocalizer.SCMenuHappy, {300: 1}, {301: 1}, {302: 1},
  303, {304: 1},
  305,
  306,
  307,
  ...
  309,
  310,
  311, {312: 1}, {313: 1}, {314: 1},
  315],
 [
  OTPLocalizer.SCMenuSad, {400: 2}, {401: 2}, {402: 2},
  403,
  404,
  405,
  406,
...
class TTChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def addBossbotGolfMenu(self):
        if self.bossbotGolfMenu == None:
            menu = TTSCBossbotGolfMenu()
            self.bossbotGolfMenu = SCMenuHolder(OTPLocalizer.SCMenuBossbotGolf, menu=menu)
            self.speedChat[2:2] = [self.bossbotGolfMenu]
        return

    def removeBossbotGolfMenu(self):
        if self.bossbotGolfMenu:
            i = self.speedChat.index(self.bossbotGolfMenu)
            del self.speedChat[i]
            self.bossbotGolfMenu.destroy()
            self.bossbotGolfMenu = None
        return
