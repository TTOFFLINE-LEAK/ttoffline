...
RESISTANCE_MONEY = 2
RESISTANCE_GREEN = 3
resistanceMenu = [RESISTANCE_TOONUP, RESISTANCE_RESTOCK, RESISTANCE_MONEY, RESISTANCE_GREEN]
resistanceDict = {RESISTANCE_TOONUP: {'menuName': TTL.ResistanceToonupMenu, 'itemText': TTL.ResistanceToonupItem, 
   ...
   RESISTANCE_RESTOCK: {'menuName': TTL.ResistanceRestockMenu, 'itemText': TTL.ResistanceRestockItem, 
                        ...
                        'items': [
                                ...
                                6,
                                7]}, 
   RESISTANCE_GREEN: {'menuName': TTL.ResistanceGreenMenu, 'itemText': TTL.ResistanceGreenItem, 
                      'chatText': TTL.ResistanceGreenChat, 
                      'values': [
                               10,
                               20,
                               40,
