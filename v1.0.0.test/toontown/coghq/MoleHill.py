...
class MoleHill(NodePath):
    ...
    def setHillType(self, type):
        if self.isUp and hasattr(self.moleField, 'GameDuration') and (self.hillType == MoleFieldBase.HILL_MOLE and type == MoleFieldBase.HILL_BOMB or self.hillType == MoleFieldBase.HILL_BOMB and type == MoleFieldBase.HILL_MOLE):
            return
        self.hillType = type
