...
class NameShop(StateData.StateData):
    ...
    def checkNamePattern(self):
        ...
        base.cr.gameServicesManager.sendSetNamePattern(self.avId, self.nameIndices[0], self.nameFlags[0], self.nameIndices[1], self.nameFlags[1], self.nameIndices[2], self.nameFlags[2], self.nameIndices[3], self.nameFlags[3], self.handleSetNamePatternResponse)
        self.waitForServer()
