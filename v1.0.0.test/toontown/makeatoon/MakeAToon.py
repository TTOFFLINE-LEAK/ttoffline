...
class MakeAToon(StateData.StateData):
    ...
    def enter(self):
        ...
        base.cr.discordManager.setInfo(base.cr.discordManager.getState(), TTLocalizer.DiscordMakingAToon, ToontownGlobals.DefaultIcon, TTLocalizer.DiscordMakeAToon, None, None)
    ...
    def load(self):
        ...
        self.guiCheckButton = DirectButton(parent=base.a2dBottomRight, relief=None, image=(guiAcceptUp,
         guiAcceptDown,
         guiAcceptUp,
         guiAcceptDown), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, pos=(-0.158333,
                                                                                                                                 0,
                                                                                                                                 0.122), command=self.__handleNext, text=('', TTLocalizer.MakeAToonDone, TTLocalizer.MakeAToonDone), text_font=ToontownGlobals.getInterfaceFont(), text_scale=0.08, text_align=TextNode.ARight, text_pos=(0.13,
                                                                                                                                                                                                                                                                                                                                          0.13), text_fg=(1,
                                                                                                                                                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                                                                                                                                                          1), text_shadow=(0,
        ...
        self.guiCancelButton = DirectButton(parent=base.a2dBottomLeft, relief=None, image=(guiCancelUp,
         guiCancelDown,
         guiCancelUp,
         guiCancelDown), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, pos=(0.164333,
                                                                                                                                 0,
                                                                                                                                 0.129), command=self.__handleCancel, text=('', TTLocalizer.MakeAToonCancel, TTLocalizer.MakeAToonCancel), text_font=ToontownGlobals.getInterfaceFont(), text_scale=TTLocalizer.MATguiCancelButton, text_pos=(0,
                                                                                                                                                                                                                                                                                                                                              0.115), text_fg=(1,
                                                                                                                                                                                                                                                                                                                                                               1,
                                                                                                                                                                                                                                                                                                                                                               1,
                                                                                                                                                                                                                                                                                                                                                               1), text_shadow=(0,
        ...
        self.guiNextButton = DirectButton(parent=base.a2dBottomRight, relief=None, image=(guiNextUp,
         ...
         guiNextDisabled), image_scale=(0.3, 0.3, 0.3), image1_scale=(0.35, 0.35, 0.35), image2_scale=(0.35,
                                                                                                       ...
                                                                                                       0.35), pos=(-0.158333,
                                                                                                                   0,
                                                                                                                   0.122), command=self.__handleNext, text=('',
         ...
         guiNextDown), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), image_scale=(-0.3, 0.3,
                                                                            0.3), image1_scale=(-0.35,
                                                                                                ...
                                                                                                0.35), image2_scale=(-0.35,
                                                                                                                     ...
                                                                                                                     0.35), pos=(-0.498333,
                                                                                                                                 0,
                                                                                                                                 0.122), command=self.__handleLast, text=('',
        ...
        self.roomDropActor.setBlend(frameBlend=base.settings.getBool('game', 'smooth-animations', False))
        ...
        self.roomSquishActor.setBlend(frameBlend=base.settings.getBool('game', 'smooth-animations', False))
        ...
        self.propSquishActor.setBlend(frameBlend=base.settings.getBool('game', 'smooth-animations', False))
        ...
        self.spotlightActor.setBlend(frameBlend=base.settings.getBool('game', 'smooth-animations', False))
