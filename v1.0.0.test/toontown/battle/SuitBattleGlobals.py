...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, 'singularname': TTLocalizer.SuitFlunkyS, 
   ...
   'bw': {'name': TTLocalizer.SuitBigWig, 'singularname': TTLocalizer.SuitBigWigS, 
          ...
          'attacks': (
                    ...
                    ('ThrowBook',
                     ...
                     (50, 50, 50, 50, 50, 50, 50, 50, 50)))}, 
   'sf': {'name': TTLocalizer.SuitSmokinForeman, 'singularname': TTLocalizer.SuitSmokinForemanS, 
          'pluralname': TTLocalizer.SuitSmokinForemanP, 
          'level': 7, 
          'hp': (90, 110, 132, 156, 200, 462, 992, 1722, 2652), 
          'def': (35, 40, 45, 50, 55, 60, 65, 70, 70), 
          'freq': (50, 30, 10, 5, 5), 
          ...
          'attacks': (
                    (
                     'CigarSmoke',
                     (10, 12, 14, 18, 22, 26, 30, 34, 38),
                     (60, 75, 80, 85, 90, 90, 90, 95, 95),
                     (50, 50, 50, 50, 50, 50, 50, 50, 50)),
                    ('ParadigmShift',
                     (12, 15, 18, 21, 24, 27, 30, 33, 36),
                     (60, 70, 75, 80, 90, 90, 90, 95, 95),
   ...
   'mdr': {'name': TTLocalizer.SuitMolder, 'singularname': TTLocalizer.SuitMolderS, 
           ...
           'attacks': (
                     (
                      'PowerTrip',
                      (55, 56, 58, 61, 65, 70, 76, 84, 92),
                      (75, 80, 85, 90, 95, 95, 95, 95, 95, 95),
                      (33, 33, 33, 33, 33, 33, 33, 33, 33)),
                     ('ReOrg',
                      (58, 59, 61, 64, 68, 73, 79, 86, 94),
                      (75, 80, 85, 90, 95, 95, 95, 95, 95),
                      (33, 33, 33, 33, 33, 33, 33, 33, 33)),
                     ('ParadigmShift',
