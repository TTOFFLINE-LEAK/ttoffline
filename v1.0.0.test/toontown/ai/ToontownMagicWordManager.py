                                                                                    ...
                                                                                    if wordIs('~battle_detect_off'):
                                                                                        ...
                                                                                        if wordIs('~battle_detect_on'):
                                                                                            ...
                                                                                            if wordIs('~battles'):
                                                                                                ...
                                                                                                if wordIs('~skipBattleMovie') or wordIs('~sbm'):
                                                                                                                                                                            ...
                                                                                                                                                                            if wordIs('~undead'):
                                                                                                                                                                                ...
                                                                                                                                                                                if wordIs('~resyncGoons'):
                                                                                                                                                                                    ...
                                                                                                                                                                                    if wordIs('~catalog'):
                                                                                                                                                                                        ...
                                                                                                                                                                                        if wordIs('~petCam') and base.wantPets:
                                                                                                                                                                                            ...
                                                                                                                                                                                            if wordIs('~lockPet') and base.wantPets:
                                                                                                                                                                                                petId = base.localAvatar.getPetId()
                                                                                                                                                                                                pet = self.cr.doId2do.get(petId)
                                                                                                                                                                                                if pet:
                                                                                                                                                                                                ...
                                                                                                                                                                                                if wordIs('~unlockPet') and base.wantPets:
                                                                                                                                                                                                    petId = base.localAvatar.getPetId()
                                                                                                                                                                                                    pet = self.cr.doId2do.get(petId)
                                                                                                                                                                                                    if pet:
                                                                                                                                                                                                        if pet.isLockedDown():
