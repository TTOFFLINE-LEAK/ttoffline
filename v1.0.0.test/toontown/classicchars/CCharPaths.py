...
__betaMickeyPaths = {'a': (Point3(46.296, 37.707, 0.009), ('b', )), 'b': (
       Point3(-1.223, 48.456, 0.009), ('c', )), 
   'c': (
       Point3(-43.359, 11.42, 0.009), ('d', )), 
   'd': (
       Point3(-3.902, -55.605, 0.013), ('e', )), 
   'e': (
       Point3(3.509, -21.404, 0.009), ('f', )), 
   'f': (
       Point3(21.272, -3.079, 0.009), ('g', )), 
   'g': (
       Point3(-0.947, -0.13, 3.227), ('h', )), 
   'h': (
       Point3(-23.994, 3.095, 0.009), ('a', ))}
__betaMickeyWaypoints = ()
startNode = 'a'
...
def __getWaypointList(paths):
    ...
    if paths == __betaMickeyPaths:
        return __betaMickeyWaypoints
