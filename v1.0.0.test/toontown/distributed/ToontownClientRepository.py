...
class ToontownClientRepository(OTPClientRepository.OTPClientRepository):
    ...
    def __handleCongrats(self, avatarChoice):
        ...
        self.gameServicesManager.sendAcknowledgeAvatarName(avatarChoice.id, lambda : self.loginFSM.request('waitForSetAvatarResponse', [avatarChoice]))
    ...
    def enterChooseAvatar(self, avList):
        ...
        self.discordManager.setInfo(self.discordManager.getState(), None, ToontownGlobals.DefaultIcon, TTLocalizer.DiscordPickAToon, None, None)
    ...
    def enterPlayingGame(self, *args, **kArgs):
        ...
        if base.settings.getBool('game', 'mini-server', False) and not self.serverIcon:
            self.serverIcon = MiniserverIcon.MiniserverIcon(self.serverName, self.serverIconPath)
        return
