...
class DistributedButterfly(DistributedObject.DistributedObject):
    ...
    def generate(self):
        ...
        self.butterfly.loadAnims({'flutter': 'phase_4/models/props/SZ_butterfly-flutter.bam', 'glide': 'phase_4/models/props/SZ_butterfly-glide.bam', 
        ...
        self.butterfly.setBlend(frameBlend=base.settings.getBool('game', 'smooth-animations', False))
        self.butterfly2.setBlend(frameBlend=base.settings.getBool('game', 'smooth-animations', False))
