...
class Playground(Place.Place):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Playground', [
         ...
         State.State('tunnelIn', self.enterTunnelIn, self.exitTunnelIn, [
          'walk']),
         State.State('skipTunnelIn', self.enterSkipTunnelIn, self.exitSkipTunnelIn, [
          'walk',
          'stopped']),
         ...
         State.State('portalIn', self.enterPortalIn, self.exitPortalIn, [
          'walk',
          'popup']),
         State.State('portalOut', self.enterPortalOut, self.exitPortalOut, [
          'portalIn']),
    ...
    def enterPortalOut(self, requestStatus):
        Place.Place.enterPortalOut(self, requestStatus, self.__portalOutDone)
    ...
    def exitPortalOut(self):
        Place.Place.exitPortalOut(self)
    ...
    def enterPortalIn(self, requestStatus):
        ...
        base.localAvatar.detachNode()
        base.localAvatar.setPosHpr(render, x, y, z, h, p, r)
        Place.Place.enterPortalIn(self, requestStatus)
