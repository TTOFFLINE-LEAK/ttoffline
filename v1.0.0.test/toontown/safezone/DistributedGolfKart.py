...
class DistributedGolfKart(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.cogKartModelPath = 'phase_12/models/bossbotHQ/Coggolf_cart3'
    ...
    def generate(self):
        ...
        if base.localAvatar.zoneId == ToontownGlobals.BossbotHQ:
            modelPath = self.cogKartModelPath
        else:
            modelPath = self.kartModelPath
        self.kart = loader.loadModel(modelPath)
