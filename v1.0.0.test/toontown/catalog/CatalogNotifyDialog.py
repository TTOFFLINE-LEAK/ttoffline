...
class CatalogNotifyDialog:
    ...
    def __init__(self, message):
        ...
        self.frame = DirectFrame(parent=base.a2dTopRight, relief=None, sortOrder=DGG.BACKGROUND_SORT_INDEX - 2, image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.2,
                                                                                                                                                                                                              1.0,
