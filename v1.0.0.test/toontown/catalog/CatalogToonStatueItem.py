...
class CatalogToonStatueItem(CatalogGardenItem.CatalogGardenItem):
    ...
    def makeNewItem(self, itemIndex=105, count=1, tagCode=1, endPoseIndex=109):
    ...
    def getPicture(self, avatar):
        ...
        if self.gardenIndex == 109:
            toonStatuary.setupToonHead()
            model, ival = self.makeFrameModel(toonStatuary.model, 1)
        else:
