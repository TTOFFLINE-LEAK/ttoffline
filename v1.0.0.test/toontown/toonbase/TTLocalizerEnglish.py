...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'), 1000: (
   ...
   11200: (
         'to the', 'in the', 'Sellbot Factory Outskirts'), 
   11500: (
...
SpecialHood = ('to', 'in', lSpecialHood)
ToontownCentralBeta = ('to', 'in', lToontownCentralBeta)
DaisyGardensBeta = ('to', 'in', lDaisyGardensBeta)
Factory = 'Factory'
...
QuestDialogDict = {160: {GREETING: '', QUEST: "Ok, now I think you are ready for something more rewarding.\x07If you can defeat 3 Bossbots I'll give you a little bonus.", 
   ...
   1054: {QUEST: '_toNpcName_ needs some help with his clown cars._where_'}, 1055: {QUEST: "Yowza!  I can't find the tires to this here clown car anywhere!\x07Do ya think you could help me out?\x07I think Loopy Bob may have tossed them in the pond in the " + lToontownCentral + ' playground.\x07If you stand on one of the docks there you can try and fish out the tires for me.', GREETING: 'Woohoo!', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Are you having trouble fishing out all 4 tires?'}, 
   1056: {QUEST: 'Fan-flying-tastic!  Now I can get this old clown car on the road again!\x07Hey, I thought I had an air pump around here to inflate these tires...\x07Maybe _toNpcName_ borrowed it?\x07Could you go ask for it back for me?_where_', LEAVING: ''}, 
   1057: {QUEST: "Hi there.\x07A tire pump you say?\x07I'll tell you what - you help clean up the streets of some of those high level Cogs for me...\x07And I'll let you have the tire pump.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Is that the best you can do?'}, 
   1058: {QUEST: "Good job - I knew you could do it.\x07Here's the pump.  I'm sure _toNpcName_ will be glad to get it back.", LEAVING: '', 
          GREETING: '', 
   ...
   1092: {QUEST: "Mmm, let me see that receipt.\x07...Ah Yes, it says that 1 goldfish was sold to a Short Change.\x07It doesn't seem to mention what happened to the other 4 fish.\x07Maybe you should try and find that Short Change.", LEAVING: '', 
          INCOMPLETE_PROGRESS: "I don't think there's anything else I can help you with.\x07Why don't you try and find that goldfish?"}, 
   1080: {QUEST: "Oh thank heavens!  You found Oscar - he's my favorite.\x07What's that, Oscar?  Uh huh... they did? ... they are?\x07Oscar says the other 4 escaped into the pond in the playground.\x07Could you go round them up for me?\x07Just fish them out of the pond.", LEAVING: '', 
   ...
   1081: {QUEST: '_toNpcName_ appears to be in a sticky situation. He sure could use a hand._where_'}, 1082: {QUEST: "I spilled quick dry glue and I'm stuck - stuck cold!\x07If there were a way out, I sure would be sold.\x07That gives me an idea, if you are feeling loyal.\x07Defeat some Sellbots and bring back some oil.", LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: 'Can you help me get un-stuck?'}, 
   1083: {QUEST: "Well, oil helped a little, but I still cannot budge,\x07What else would help?  It's hard to judge.\x07That gives me an idea; it's worth a try at least.\x07Defeat some Lawbots and bring back some grease.", LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: 'Can you help me get un-stuck?'}, 
   1084: {QUEST: "Nope, that didn't help.  This is really not funny.\x07I put the grease right there on the money,\x07That gives me an idea, before I forget it.\x07Defeat some Cashbots; bring back water to wet it.", LEAVING: '', 
          GREETING: '', 
   ...
   1089: {QUEST: "Okay, let's take a look.  These are excellent specimens!\x07Mmmm...\x07Okay, here's my report.  Take this back to Toon Headquarters right away.", INCOMPLETE: 'Have you delivered my report to Headquarters?', 
          COMPLETE: "Good work _avName_, we'll take this one from here.", 
          LEAVING: ''}, 
   1090: {QUEST: '_toNpcName_ has some useful information for you._where_'}, 1091: {QUEST: 'I hear that Toon Headquarters is working on a sort of Cog Radar.\x07It will let you see where the Cogs are so that it will be easier to find them.\x07That Cog Page in your Shticker Book is the key.\x07By defeating enough Cogs, you can tune in to their signals and actually track where they are.\x07Keep defeating Cogs, so you will be ready.', COMPLETE: 'Good work!  You could probably use this...', 
          LEAVING: ''}, 
...
ChatGarblerChicken = ['bock', 'cluck', 'bakahk']
ChatGarblerScrooge = ['quack', 'quackity', 'money']
...
KongHealJokes = [
 [
  'What is the funniest joke in the world?', 'ops me me'],
 [
  'Who is the swetiest of them all?', 'The one and only Swetie Bunny.'],
 [
  'ops', 'me me'],
 [
  'Physics.', 'Logic.'],
 [
  'A pig once walks up to a group and said, "Everyone oink."', "Like yes, Because I'd totally SPEAK PIG!"],
 [
  'spotlight, cd, house colors,', 'bubble it lol? WHAT DO THEY EVEN MEAN!?!?'],
 [
  'Am I recording you ask?  No.  Of course not.', 'OOPS!'],
 [
  'When will I run for Toon Council Presidency?', "Oh, I'll be running in the 90's, that's for sure!"]]
...
MusicPartySpNbrhood = 'Toontown Outskirts'
MusicPartySpActivity = 'The Fun Houses'
MusicTtOffTheme = 'The Offline Theme'
MusicTtOffThemeHalloween = 'The Spooktown Theme'
...
MusicBathroom = 'Something Slippery!'
MusicMayday = 'Mayday'
MusicItsLove = "It's Love"
MusicChiptune = 'Chiptune'
MusicWorldWar = 'Win a War'
MusicBeOkay = 'Be Okay'
JukeboxAddSong = 'Add\nSong'
...
PartyActivityNameDict = {0: {'generic': 'Jukebox\n20 songs', 'invite': 'a 20 song Jukebox', 
   ...
   8: {'generic': 'Jukebox\n40 songs', 'invite': 'a 40 song jukebox', 
       'editor': 'Jukebox - 40', 
...
ServerTabTitle = 'Current'
ServerPageMiniserverInfo = 'You are currently in: %s'
ServerPageMiniserverDescription = 'Description: '
ServerPageMiniserverInfoIP = 'IP Address: '
ServerPageMiniserverInfoMode = 'Game Mode: '
...
ServerPageConnectDialogExt = 'Are you sure you would like to connect to this mini-server?\n\nNOTE: Leaving "Username" or "IP Address" blank will use the info that you\'re currently using.'
ServerPageMoreInfoDialog = 'This will open your browser to show you more info about this mini-server.\nWould you like to continue?'
...
ClothesShopNude = 'Streak'
ClothesShopClothe = 'Clothe'
...
NameUnintendedError = 'Whoops!  Something wrong has occurred with your name!  Contact the Toontown Offline staff if you see this message.\n\nThe game will now close. (because Ryno was lazy)'
...
QuestScriptTutorialBlocker_7 = "It's called the Chat button. You can use it to type out messages to other Toons."
...
ResistanceGreenChat = 'Toons of the World, Go Sad!'
...
DayNamesAbbrev = ('MON',
 ...
 'SAT',
 'SUN')
HolidayNamesInCalendar = {1: ('Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'), 2: (
   ...
   35: (
      'Sellbot Surprise 3', 'Sellbot Surprise! Stop the Gladhander Cogs from invading Toontown!'), 
   36: (
      'Sellbot Surprise 4', 'Sellbot Surprise! Stop the Mover & Shaker Cogs from invading Toontown!'), 
   37: (
      'A Cashbot Conundrum 1', 'A Cashbot Conundrum. Stop the Short Change Cogs from invading Toontown!'), 
   38: (
      'A Cashbot Conundrum 2', 'A Cashbot Conundrum. Stop the Penny Pincher Cogs from invading Toontown!'), 
   39: (
      'A Cashbot Conundrum 3', 'A Cashbot Conundrum. Stop the Bean Counter Cogs from invading Toontown!'), 
   40: (
      'A Cashbot Conundrum 4', 'A Cashbot Conundrum. Stop the Number Cruncher Cogs from invading Toontown!'), 
   41: (
      'The Lawbot Gambit 1', 'The Lawbot Gambit. Stop the Bottomfeeder Cogs from invading Toontown!'), 
   42: (
      'The Lawbot Gambit 2', 'The Lawbot Gambit. Stop the Double Talker Cogs from invading Toontown!'), 
   43: (
      'The Lawbot Gambit 3', 'The Lawbot Gambit. Stop the Ambulance Chaser Cogs from invading Toontown!'), 
   44: (
      'The Lawbot Gambit 4', 'The Lawbot Gambit. Stop the Backstabber Cogs from invading Toontown!'), 
   45: (
      'The Trouble With Bossbots 1', 'The Trouble with Bossbots. Stop the Flunky Cogs from invading Toontown!'), 
   46: (
   ...
   48: (
      'The Trouble With Bossbots 4', 'The Trouble with Bossbots. Stop the Downsizer Cogs from invading Toontown!'), 
   49: (
   ...
   86: (
      'Down Sizer Invasion', 'Stop the Down Sizer Cogs from invading Toontown!'), 
   87: (
...
PropEditorTitles = ['Info', 'Settings', 'Position', 'Rotation', 'Scale', 'Color Scale', 'Reparent']
PropEditorPage1 = ['X - Coordinate', 'Y - Coordinate', 'Z - Coordinate']
PropEditorPage2 = ['H - Coordinate', 'P - Coordinate', 'R - Coordinate']
PropEditorPage3 = ['X - Scale', 'Y - Scale', 'Z - Scale']
PropEditorPage4 = ['Red', 'Green', 'Blue']
PropEditorPage4Toffle = 'Toggle'
PropEditorPage5 = ['Reparent', 'WrtReparent', 'Reset', 'GoTo']
...
PropGeneratorGenerator = 'Generator'
PropGeneratorDump = 'Save Props'
PropGeneratorDeleteAllProps = 'Delete All'
PropGeneratorLockProps = 'Toggle Lock'
PropGeneratorZone = 'This Zone'
PropGeneratorGlobal = 'Global'
PropGeneratorTotalCount = '%s / %s Props'
PropMessages = [
 'The prop limit has been hit! Please delete some props and try again.',
 'Prop spawning has been disabled in this District.',
 'Prop spawning has been disabled in this Zone.',
 'Prop spawning has been re-enabled for this District.',
 'Prop spawning has been re-enabled for this Zone.',
...
KongQuotes = [
 ...
 'Extreme cases... of pig racism!',
 "And now it's time for JOEY AROUND THE WORLD!",
 "Pretty nice interior, pretty nice building. I'd give it 5/5. But seriously? Let's go in now, fight some cogs, yeah?",
 'As the sun sets on another Toontown day, we say goodbye to the toon who has helped us through this difficult day of tasks...',
 "You guys have responded so positively to this content, with comments such as: 'go die!'",
 "'plz friends' Uh.. yeah, I suddenly have a meeting to go to.. Su.. Gotta... Gotta go guys, important meeti-",
 "Jesse Schell, if you're watching this, I just want you to know that I love you. I love you, Jesse Schell. Yup. I love you. I said it.",
 'THEN WHAT WAS THIS?! YOU USING A *BIKE HORN* ON THREE. LURED. COGS!',
 "It's all fine, guys! He was just kidding! He didn't mean it when he CRUSHED MY SELF-ESTEEM!",
 "And what is wrong with Justin? He's suffering from 'Small Head Syndrome'",
 "Take it easy, take it slow, you don't want to RUSH INTO THESE RELATIONSHIPS, DO YOU, HQ OFFICER DUCK?!",
 'You are the reason that this channel is THRIVING, Savry Life... thank you...',
 'THE TOONTOWN MONIES!',
 'WHY WOULD YOU JUST VOLUNTARILY WALK OFF A MOVING PLATFORM?! YOU STUPID MOUSE..... WHY DID YOU JUST DO IT AGAIN?!',
 "I'M CHAD. KONG IS KONG. CHAD IS CHAD. WHY IS THAT SO HARD TO UNDERSTAND?",
 "Hello, children! Duke Monty Thundergoose has arrived in town! He'll be taking... your LUNCH MONEY!",
 'That guy waves to a TREE... THE TREE.. CANNOT BE YOUR FRIEND!',
 "HOLY MOLY MOTHER OF MARY, THAT'S A BIG CHEESE!",
 'RAGE. ANGER. FURY. SHOCK.',
 'Kong, what you have to understand is that swag does not equal success!',
 "'I have no customers'... You never have customers, you STUPID CAT!",
 "It's Joey o'clock!",
 "I BEAR-ly missed him! Ohhh, haha! Do you GET the JOKE? Because there's... it's a... 'cause it's a... it's a bear...",
 'Welcome to The Church of Joey...',
 "Don't you dare Pick Pocket me, that's like illegal or something",
 'The STYLE! Look at the STYLE!',
 "'What makes you stand out from all the other Toontown servers that are opening right now?' And the answer to that is: we don't know!",
 "'Tunnel ahead.' Thanks for informing me, I would never have noticed the GIANT TUNNEL right in front of my face!"]
...
TextToSpeechWarning = "Warning! Your eSpeak directory may have changed. Look in the 'Extra Options' page of your Shtickerbook to resolve this error."
...
DistrictMiniserverDefault = 'A Toontown Offline Mini-Server'
MiniserverLegit = 'Legit Mode'
MiniserverCheats = 'Normal Mode'
InfoPanelTitles = ['Game Info', 'Toon Info', 'Battle Info']
InfoPanelGameEffects = ['Username', 'Access Level', 'Connection Type', 'IP Address']
InfoPanelToonEffects = ['Name', 'Species', 'Color', 'Eyes/Muzzle', 'Scale', 'Speed', 'Cheesy Effect ID', 'Cog Index', 'Goon Index', 'Boss Index', 'Doodle Index']
InfoPanelBattleEffects = ['Immortal Mode', 'Instakill Mode', 'Unlimited Gags Mode']
InfoPanelMiniserverMode = 'Mini-Server Mode'
InfoPanelScale = 'x%s'
...
ServerShutdownMessage = 'This server is going down for %s. Be back soon!'
ServerShutdownAnnouncement = 'TOON HQ: The server will be shutting down for {0} in {1} seconds.'
