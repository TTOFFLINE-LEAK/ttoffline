...
import tempfile, atexit, shutil, platform
...
class ToonBase(OTPBase.OTPBase):
    ...
    def __init__(self):
        ...
        self.screenshotSfx = base.loader.loadSfx('phase_4/audio/sfx/Photo_shutter.ogg')
        ...
        if self.gamemode > 2 or self.gamemode < 0:
            self.gamemode = 0
        self.classicVisuals = self.settings.getInt('game', 'classic-visuals', 0)
    ...
    def initNametagGlobals(self):
        ...
        exclaim3d = ChatBalloon(loader.loadModel('phase_3/models/props/chatbox_exclaim_cutout').node())
        ...
        self.leftCells = [mm.addGridCell(0, 1, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dTopLeft, (0.222222,
                                                                                 0,
                                                                                 -1.5)), mm.addGridCell(0, 2, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dTopLeft, (0.222222,
                                                                                 0,
                                                                                 -1.16667)), mm.addGridCell(0, 3, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dTopLeft, (0.222222,
                                                                                 0,
                                                                                 -0.833333))]
        self.bottomCells = [mm.addGridCell(0.5, 0, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dBottomCenter, (-0.888889,
                                                                                        0,
                                                                                        0.166667)),
         mm.addGridCell(1.5, 0, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dBottomCenter, (-0.444444,
                                                                                        0,
                                                                                        0.166667)),
         mm.addGridCell(2.5, 0, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dBottomCenter, (0,
                                                                                        0,
                                                                                        0.166667)),
         mm.addGridCell(3.5, 0, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dBottomCenter, (0.444444,
                                                                                        0,
                                                                                        0.166667)),
         mm.addGridCell(4.5, 0, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dBottomCenter, (0.888889,
                                                                                        0,
                                                                                        0.166667))]
        self.rightCells = [mm.addGridCell(5, 2, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dTopRight, (-0.222222,
                                                                                  0,
                                                                                  -1.16667)), mm.addGridCell(5, 1, -1.33333333333, 1.33333333333, -1.0, 1.0, base.a2dTopRight, (-0.222222,
                                                                                  0,
                                                                                  -1.5))]
    ...
    def loadFromSettings(self):
        if not config.GetInt('ignore-user-options', 0):
            ...
            textToSpeech = self.settings.getBool('game', 'text-to-speech', False)
            if sys.platform == 'win32':
                if platform.machine().endswith('64'):
                    programFiles = os.environ['PROGRAMFILES(x86)']
                else:
    ...
    def resetTextToSpeech(self):
        self.textToSpeech = 0
        self.settings.updateSetting('game', 'text-to-speech', False)
        if sys.platform == 'win32':
            if platform.machine().endswith('64'):
                programFiles = os.environ['PROGRAMFILES(x86)']
            else:
