...
Sleeves = [
 ...
 'phase_4/maps/tt_t_chr_avt_shirtSleeve_cashbotCrusher.jpg',
 'phase_4/maps/tt_t_chr_avt_shirtSleeve_lawbotCrusher.jpg',
 'phase_4/maps/tt_t_chr_avt_shirtSleeve_bossbotCrusher.jpg',
 'phase_4/maps/tt_t_chr_avt_shirtSleeve_betaSleeve.jpg',
 'phase_4/maps/gyro-sleeve.jpg',
 'phase_4/maps/scrooge-sleeve.jpg']
BoyShorts = ['phase_3/maps/desat_shorts_1.jpg',
 ...
 'phase_4/maps/tt_t_chr_avt_shorts_cashbotCrusher.jpg',
 'phase_4/maps/tt_t_chr_avt_shorts_lawbotCrusher.jpg',
 'phase_4/maps/tt_t_chr_avt_shorts_bossbotCrusher.jpg',
 'phase_4/maps/tt_t_chr_avt_shorts_betaShorts.jpg',
 'phase_4/maps/gyro-shorts.jpg',
 'phase_4/maps/scrooge-shorts.jpg']
SHORTS = 0
SKIRT = 1
GirlBottoms = [('phase_3/maps/desat_skirt_1.jpg', SKIRT),
 ...
 (
  'phase_4/maps/tt_t_chr_avt_shorts_cashbotCrusher.jpg', SHORTS),
 (
  'phase_4/maps/tt_t_chr_avt_shorts_lawbotCrusher.jpg', SHORTS),
 (
  'phase_4/maps/tt_t_chr_avt_shorts_bossbotCrusher.jpg', SHORTS),
 (
  'phase_4/maps/tt_t_chr_avt_shorts_betaShorts.jpg', SHORTS),
 (
  'phase_4/maps/gyro-shorts.jpg', SHORTS),
 (
  'phase_4/maps/scrooge-shorts.jpg', SHORTS)]
...
MakeAToonGirlSkirts = []
MakeAToonGirlShorts = []
for tailor in [LONGJOHN_LEROY, TAILOR_HARMONY, BONNIE_BLOSSOM, WARREN_BUNDLES, WORNOUT_WAYLON]:
    for boyShirt in TailorCollections[tailor][0]:
        TailorCollections[MAKE_A_TOON][0].append(boyShirt)

    for girlShirt in TailorCollections[tailor][1]:
        TailorCollections[MAKE_A_TOON][1].append(girlShirt)

    for boyPant in TailorCollections[tailor][2]:
        TailorCollections[MAKE_A_TOON][2].append(boyPant)

    for girlPant in TailorCollections[tailor][3]:
        TailorCollections[MAKE_A_TOON][3].append(girlPant)
...
class ToonDNA(AvatarDNA.AvatarDNA):
    ...
    def isValidNetString(self, string):
        colorInfo = json.loads(simbase.air.moddingManager.getColors())
        self.loadColors(colorInfo)
    ...
    def loadColors(self, colorInfo=None):
        if not colorInfo:
            colorsLoaded = base.cr.moddingManager.colorsLoaded
            colors = base.cr.moddingManager.colors['colors']
        else:
            colorsLoaded = False
            colors = colorInfo['colors']
        if not colorsLoaded:
            if not colorInfo:
                base.cr.moddingManager.colorsLoaded = True
