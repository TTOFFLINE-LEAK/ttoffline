...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        CamPos = [
         (-3.0, 25.0, 29.5), (83.81, 69.0, 15.0), (37.14, 67.8, 19.09)]
        ...
        bossSeq = Sequence(Func(self.loop, 'neutral'), self.posInterval(5, (-3.0, 89.0,
                                                                            21), (-3.0,
                                                                                  140,
                                                                                  21)), Wait(2.5), self.posInterval(5, (-3.0,
                                                                                                                        89.0,
                                                                                                                        0)), Wait(1), self.posInterval(9, (-3.0,
                                                                                                                                                           15,
                                                                                                                                                           0)))
        bossSeq2 = Sequence(Func(self.loop, 'Ff_neutral'), Wait(3), ActorInterval(self, 'Ff_speech'), ActorInterval(self, 'Ff_speech'), ActorInterval(self, 'Ff_lookLt', duration=2.9), ActorInterval(self, 'Ff_lookLt', startTime=2.9, endTime=0), ActorInterval(self, 'Ff_speech', duration=10.15, loop=1), ActorInterval(self, 'Ff_lookRt', endTime=2.9), ActorInterval(self, 'Ff_lookRt', startTime=2.9, endTime=0), Func(self.loop, 'Ff_neutral'))
        treadSeq = Sequence(Func(self.treadWheels, self, 5), Wait(13.5), Func(self.treadWheels, self, 9))
                                                                                                                   ...
                                                                                                                   -32.0), (0.0,
                                                                                                                            ...
                                                                                                                            0))), Parallel(upperDoor.posInterval(3, (0.5,
                                                                                                                                                                     ...
                                                                                                                                                                     0)), lowerDoor.posInterval(3, (0,
                                                                                                                                                                                                    0,
                                                                                                                                                                                                    0))))
        PodiumSeq = Sequence(Wait(7.5), upperPodium.posInterval(5, (
         self.podium.getX(), self.podium.getY(), self.podium.getZ() - 20.9)))
