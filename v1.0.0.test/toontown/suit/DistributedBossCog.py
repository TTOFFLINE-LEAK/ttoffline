...
class DistributedBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
    ...
    def announceGenerate(self):
        ...
        self.bubbleF.stash()
        zoneId = ZoneUtil.getHoodId(ToontownGlobals.Dept2Zone.get(self.style.dept))
        base.cr.discordManager.setInfo(base.cr.discordManager.getState(), TTLocalizer.DiscordBossFight % TTLocalizer.DiscordDept2Boss[self.style.dept], ToontownGlobals.Zone2String.get(zoneId), None, None, None, zoneId)
        return
