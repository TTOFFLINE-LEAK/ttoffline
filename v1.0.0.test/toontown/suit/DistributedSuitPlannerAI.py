...
from toontown.building import HQBuildingAI, LighthouseBuildingAI, TutorialBuildingAI
...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    SuitHoodInfo = [
     [
      2100, 5, 15, 0, 5, 20, 3, (1, 5, 10, 40, 60, 80), (25, 25, 25, 25), (100, 0, 0, 0, 0), (1, 2, 3), []], [2200, 3, 10, 0, 5, 15, 3, (1, 5, 10, 40, 60, 80), (10, 70, 10, 10), (100, 0, 0, 0, 0), (1, 2, 3), []], [2300, 3, 10, 0, 5, 15, 3, (1, 5, 10, 40, 60, 80), (10, 10, 40, 40), (100, 0, 0, 0, 0), (1, 2, 3), []], [1100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (90, 10, 0, 0), (100, 0, 0, 0, 0), (2, 3, 4), []], [1200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 90, 10), (100, 0, 0, 0, 0), (3, 4, 5, 6), []], [1300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (40, 40, 10, 10), (100, 0, 0, 0, 0), (3, 4, 5, 6), []], [3100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (90, 10, 0, 0), (100, 0, 0, 0, 0), (5, 6, 7), []], [3200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (10, 20, 30, 40), (100, 0, 0, 0, 0), (5, 6, 7), []], [3300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 85, 5, 5), (100, 0, 0, 0, 0), (7, 8, 9), []], [4100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 50, 50), (100, 0, 0, 0, 0), (2, 3, 4), []], [4200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 90, 10), (100, 0, 0, 0, 0), (3, 4, 5, 6), []], [4300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 50, 0, 0), (100, 0, 0, 0, 0), (3, 4, 5, 6), []], [5100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 20, 10, 70), (100, 0, 0, 0, 0), (2, 3, 4), []], [5200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (10, 70, 0, 20), (100, 0, 0, 0, 0), (3, 4, 5, 6), []], [5300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 5, 85), (100, 0, 0, 0, 0), (3, 4, 5, 6), []], [9100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (25, 25, 25, 25), (100, 0, 0, 0, 0), (6, 7, 8, 9), []], [9200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 85, 5), (100, 0, 0, 0, 0), (6, 7, 8, 9), []], [11000, 3, 15, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100), (100, 0, 0, 0, 0), (4, 5, 6), []], [11200, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100), (100, 0, 0, 0, 0), (4, 5, 6), []], [12000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 100, 0), (100, 0, 0, 0, 0), (7, 8, 9), []], [13000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0), (100, 0, 0, 0, 0), (8, 9, 10), []], [19200, 1, 1, 0, 1, 20, 3, (1, 5, 10, 40, 60, 80), (100, 0, 0, 0), (100, 0, 0, 0, 0), (1,), []]]
    ...
    SUIT_HOOD_INFO_SPECIALS = 9
    SUIT_HOOD_INFO_LVL = 10
    ...
    def __init__(self, air, zoneId):
        ...
        if self.buildingMgr:
            blocks, hqBlocks, gagshopBlocks, petshopBlocks, kartshopBlocks, animBldgBlocks, lighthouseBlocks, tutorialBlocks = self.buildingMgr.getDNABlockLists()
    ...
    def initBuildingsAndPoints(self):
        ...
        for bldg in self.buildingMgr.getBuildings():
            if isinstance(bldg, HQBuildingAI.HQBuildingAI):
                continue
            if isinstance(bldg, LighthouseBuildingAI.LighthouseBuildingAI):
                continue
            if isinstance(bldg, TutorialBuildingAI.TutorialBuildingAI):
                continue
    ...
    def pickLevelTypeAndTrack(self, level=None, type=None, track=None):
        for c in SuitDNA.spawnableExtras:
            if type == SuitDNA.suitHeadTypes.index(c):
                extraSuit = True
                break
            else:
                extraSuit = False
