...
class DistributedTutorialInterior(DistributedObject.DistributedObject):
    ...
    def setup(self):
        ...
        base.cr.discordManager.setInfo(base.cr.discordManager.getState(), TTLocalizer.DiscordTutorial, ToontownGlobals.Zone2String.get(ToontownGlobals.ToontownCentral), None, None, None, ToontownGlobals.ToontownCentral)
        return
    ...
    def createSuit(self):
        if self.zoneId != ToontownGlobals.TutorialInterior:
            self.suit = Suit.Suit()
