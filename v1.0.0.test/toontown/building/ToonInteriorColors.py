...
colors = {DonaldsDock: {'TI_wainscotting': wainscottingBase, 'TI_wallpaper': wallpaperBase, 
   ...
   Tutorial: {'TI_wainscotting': wainscottingBase, 'TI_wallpaper': wallpaperBase, 
              ...
              'TI_floor': floorBase}, 
   MyEstate: baseScheme, 
   ToontownOutskirts: {'TI_wainscotting': wainscottingBase, 'TI_wallpaper': wallpaperBase, 
                       'TI_wallpaper_border': wallpaperBorderBase, 
                       'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)], 
                       'TI_floor': floorBase}, 
   ToontownCentralBeta: {'TI_wainscotting': wainscottingBase, 'TI_wallpaper': wallpaperBase, 
                         'TI_wallpaper_border': wallpaperBorderBase, 
                         'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)], 
                         'TI_floor': floorBase}, 
   DaisyGardensBeta: baseScheme}