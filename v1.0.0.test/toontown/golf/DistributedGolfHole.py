...
class DistributedGolfHole(DistributedPhysicsWorld.DistributedPhysicsWorld, FSM, GolfHoleBase.GolfHoleBase):
    ...
    def loadLevel(self):
        ...
        if self.holeId in (36, 37):
            self.pumpk = Actor.Actor('phase_6/models/golf/pump_zero', {'dance': 'phase_6/models/golf/pump_dance'})
            self.pumpk.reparentTo(render)
            self.pumpk.loop('dance')
            self.pumpk1 = Actor.Actor('phase_6/models/golf/pump_zero_1', {'dance2': 'phase_6/models/golf/pump_dance_1'})
            self.pumpk1.reparentTo(render)
            self.pumpk1.loop('dance2')
        if self.holeId == 36:
            self.pumpk1.setPosHpr(95.822, 15.2, -1.5, -90, 0, 0)
        else:
            if self.holeId == 37:
                self.pumpk1.setPosHpr(90.822, -15.2, -1.5, -90, 0, 0)
