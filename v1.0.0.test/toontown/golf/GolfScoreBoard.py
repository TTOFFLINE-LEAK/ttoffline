...
class GolfScoreBoard:
    ...
    def setup(self):
        ...
        self.maximizeB = DirectButton(parent=base.a2dBottomRight, pos=(-0.133, 0, 0.15), relief=None, state=DGG.NORMAL, image=(guiModel.find('**/score_card_icon'), guiModel.find('**/score_card_icon_rollover'), guiModel.find('**/score_card_icon_rollover')), image_scale=(0.2,
                                                                                                                                                                                                                                                                              1,
