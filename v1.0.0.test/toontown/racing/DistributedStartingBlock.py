        ...
        def getToonJumpTrack(av, kart):
            ...
            if av.isDisguised:
                if av.suit.style.body == 'b':
                    ...
                    wait = 0
            toonJumpTrack = Parallel(ActorInterval(av, 'jump'), Sequence(Wait(wait), Parallel(LerpHprInterval(av, hpr=getJumpHpr, duration=0.9), ProjectileInterval(av, endPos=getJumpDest, duration=0.9))))
