...
class DistributedRace(DistributedObject.DistributedObject):
    ...
    def announceGenerate(self):
        ...
        base.cr.discordManager.setInfo(base.cr.discordManager.getState(), TTLocalizer.KartRace_TrackNames[self.trackId], ToontownGlobals.Zone2String.get(ToontownGlobals.GoofySpeedway), None, None, None, ToontownGlobals.GoofySpeedway)
        return
