...
class ObjectManager(NodePath, DirectObject):
    ...
    def createMainControls(self, guiModels):
        ...
        self.furnitureGui = DirectFrame(relief=None, parent=base.a2dTopLeft, pos=(0.143333,
                                                                                  1,
                                                                                  -0.67), scale=0.04, image=attic)
        ...
        if self.verifyFrame == None:
            ...
            self.verifyFrame = DirectFrame(pos=(-0.4, 0.1, 0.3), scale=0.75, relief=None, image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.2,
                                                                                                                                                                                        ...
                                                                                                                                                                                        1.3), text='', text_wordwrap=19, text_scale=0.06, text_pos=(0,
                                                                                                                                                                                                                                                    0.5), textMayChange=1, sortOrder=DGG.NO_FADE_SORT_INDEX)
