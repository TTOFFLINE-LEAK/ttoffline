...
class DistributedToonStatuary(DistributedStatuary.DistributedStatuary):
    ...
    def setupToonHead(self):
        self.toon = self.getToonHeadModel().getPart('head', '1000')
        self.toon.setZ(0.5)
        self.toon.setP(10)
        if self.model:
            self.toon.reparentTo(self.model)
    ...
    def deleteToonHead(self):
        self.notify.debug('entering deleteToonHead')
