...
class Estate(Place.Place):
    ...
    def __init__(self, loader, avId, zoneId, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Estate', [
         ...
         State.State('final', self.enterFinal, self.exitFinal, ['teleportIn', 'died']),
    ...
    def startAprilFoolsControls(self):
        if isinstance(base.localAvatar.controlManager.currentControls, GravityWalker):
            base.localAvatar.controlManager.currentControls.setGravity(24.130499999999998)

    def stopAprilFoolsControls(self):
        if isinstance(base.localAvatar.controlManager.currentControls, GravityWalker):
            base.localAvatar.controlManager.currentControls.setGravity(64.348)
