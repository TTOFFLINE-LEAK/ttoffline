...
class EstateLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def enter(self, requestStatus):
        ...
        base.cr.discordManager.setInfo(base.cr.discordManager.getState(), TTLocalizer.DiscordEstate % base.localAvatar.getName(), Zone2String.get(MyEstate), TTLocalizer.DiscordEstate % base.localAvatar.getName(), None, None, MyEstate)
