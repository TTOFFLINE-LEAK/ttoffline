...
class TrunkGUI(StateData.StateData):
    ...
    def load(self):
        ...
        self.parentFrame = DirectFrame(parent=base.a2dTopRight, relief=DGG.RAISED, pos=(-0.353333,
                                                                                        0,
                                                                                        -0.584), frameColor=(1,
                                                                                                             0,
                                                                                                             0,
        ...
        if self.isOwner:
            ...
            self.trashPanel = DirectFrame(parent=base.a2dTopLeft, image=DGG.getDefaultDialogGeom(), image_color=(1,
                                                                                                                 1,
                                                                                                                 0.75,
