...
class DistributedTrunkAI(DistributedClosetAI):
    ...
    def enterAvatar(self):
        ...
        self.d_setState(ClosetGlobals.OPEN, avId, self.ownerId, self.gender, self.hatList, self.glassesList, self.backpackList, self.shoesList)
    ...
    def __handleOwnerQuery(self, dclass, fields):
        ...
        self.d_setState(ClosetGlobals.OPEN, self.customerId, self.ownerId, self.gender, self.hatList, self.glassesList, self.backpackList, self.shoesList)
    ...
    def __handleClosetTimeout(self, avId):
        ...
        self.d_setState(ClosetGlobals.CLOSED, avId, self.ownerId, self.gender, self.hatList, self.glassesList, self.backpackList, self.shoesList)
