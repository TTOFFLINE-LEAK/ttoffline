...
FLOWER_WHITE = 6
FLOWER_GREEN = 7
ToonStatuaryTypeIndices = xrange(205, 210)
...
PlantAttributes = {49: {'name': TTLocalizer.FlowerSpeciesNames[49], 'plantType': FLOWER_TYPE, 
   ...
   208: {'name': TTLocalizer.StatuaryToonThinking, 'plantType': STATUARY_TYPE, 
         ...
         'varieties': ((1008, 1, 0), ), 
         'pinballScore': (500, 1)}, 
   209: {'name': TTLocalizer.StatuaryToonHead, 'plantType': STATUARY_TYPE, 
         'model': 'phase_5.5/models/estate/dirt_mound', 
         'worldScale': 0.5, 
         'varieties': ((1036, 1, 0), ), 
         'pinballScore': (500, 1)}, 
...
Recipes = {0: {'beans': 'RRR', 'special': -1}, 
   ...
   1036: {'beans': 'SRSRSRSR', 'special': 109}, 
...
Specials = {0: {'subtype': MAGIC_BEAN_SUBTYPE, 'gagbonus': 1, 
   ...
   108: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/garden_pedestal', 
         ...
         'beanCost': 5000, 
         'minSkill': 639}, 
   109: {'subtype': GARDEN_ITEM_SUBTYPE, 'photoModel': 'phase_5.5/models/estate/dirt_mound', 
         'photoScale': 1.0, 
         'photoPos': (0, 0, -1.05), 
         'photoName': TTLocalizer.StatuaryToonHead, 
         'description': TTLocalizer.GardenSpecialDiscription, 
         'isCatalog': True, 
         'beanCost': 5000, 
         'minSkill': 639}, 
