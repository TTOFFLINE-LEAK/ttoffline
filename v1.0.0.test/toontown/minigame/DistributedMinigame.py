...
class DistributedMinigame(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.acceptOnce('minigameAbort', self.d_requestExit, extraArgs=[0])
        self.acceptOnce('minigameVictory', self.d_requestExit, extraArgs=[2])
    ...
    def d_requestExit(self, normalExit=0):
        self.notify.debug('BASE: Sending requestExit')
        self.sendUpdate('requestExit', [normalExit])
