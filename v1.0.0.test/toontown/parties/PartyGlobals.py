...
PhaseToMusicData40 = {3.5: {'encntr_general_bg.ogg': [TTLocalizer.MusicEncntrGeneralBg, 30], 'TC_SZ.ogg': [
   ...
   4: {'minigame_race.ogg': [TTLocalizer.MusicMinigameRace, 77], 'TC_nbrhood.ogg': [
       ...
       'FF_safezone.ogg': [
                         TTLocalizer.MusicFfSafezone, 47]}, 
   6: {'DD_SZ.ogg': [TTLocalizer.MusicDdSz, 33], 'GZ_PlayGolf.ogg': [
   ...
   7: {'encntr_general_bg_indoor.ogg': [TTLocalizer.MusicEncntrGeneralBgIndoor, 31], 'encntr_suit_winning_indoor.ogg': [
                                        TTLocalizer.MusicEncntrGeneralSuitWinningIndoor, 36]}, 
   8: {'DL_nbrhood.ogg': [TTLocalizer.MusicDlNbrhood, 30], 'DG_SZ.ogg': [
                   TTLocalizer.MusicDgSz, 48], 
       'DL_SZ.ogg': [
                   TTLocalizer.MusicDlSz, 33], 
       'TB_SZ.ogg': [
                   TTLocalizer.MusicTbSz, 54]}, 
   9: {'encntr_hall_of_fame.ogg': [TTLocalizer.MusicEncntrHallOfFame, 51], 'CHQ_FACT_bg.ogg': [
   ...
   12: {'Bossbot_Factory_v1.ogg': [TTLocalizer.MusicBossbotFactoryV1, 30], 'BossBot_CEO_v1.ogg': [
   ...
   13: {'party_original_theme.ogg': [TTLocalizer.MusicPartyOriginalTheme, 56], 'party_polka_dance.ogg': [
        ...
        'party_generic_theme_jazzy.ogg': [
                                        TTLocalizer.MusicPartyGenericThemeJazzy, 64]}}
PhaseToMusicData60 = {3.5: {'encntr_general_bg.ogg': [TTLocalizer.MusicEncntrGeneralBg, 30], 'TC_SZ.ogg': [
                     TTLocalizer.MusicTcSz, 57]}, 
   3: {'create_a_toon.ogg': [TTLocalizer.MusicCreateAToon, 175], 'tt_theme.ogg': [
                      TTLocalizer.MusicTtTheme, 51], 
       'ttoff_theme.ogg': [
                         TTLocalizer.MusicTtOffTheme, 66], 
       'ttoff_halloween_theme.ogg': [
                                   TTLocalizer.MusicTtOffThemeHalloween, 54]}, 
   4: {'minigame_race.ogg': [TTLocalizer.MusicMinigameRace, 77], 'TC_nbrhood.ogg': [
                        TTLocalizer.MusicTcNbrhood, 59], 
       'TC_battle.ogg': [
                       TTLocalizer.MusicTcBattle, 30], 
       'MG_TwoDGame.ogg': [
                         TTLocalizer.MusicMgTwodgame, 60], 
       'MG_CogThief.ogg': [
                         TTLocalizer.MusicMgCogthief, 61], 
       ...
       'FF_safezone.ogg': [
                         TTLocalizer.MusicFfSafezone, 47]}, 
   5.5: {'estate_SZ.ogg': [TTLocalizer.MusicEstate, 63]}, 6: {'DD_SZ.ogg': [TTLocalizer.MusicDdSz, 33], 'GZ_PlayGolf.ogg': [
                         TTLocalizer.MusicGzPlaygolf, 61], 
       'GS_SZ.ogg': [
                   TTLocalizer.MusicGsSz, 60], 
       'OZ_SZ.ogg': [
       ...
       'MM_SZ.ogg': [
                   TTLocalizer.MusicMmSz, 76], 
       'MM_battle.ogg': [
                       TTLocalizer.MusicMmBattle, 40], 
       'DD_nbrhood.ogg': [
                        TTLocalizer.MusicDdNbrhood, 67], 
       'DD_battle.ogg': [
                       TTLocalizer.MusicDdBattle, 30], 
       'GS_KartShop.ogg': [
                         TTLocalizer.MusicGsKartshop, 32]}, 
   7: {'encntr_general_bg_indoor.ogg': [TTLocalizer.MusicEncntrGeneralBgIndoor, 31], 'encntr_suit_winning_indoor.ogg': [
                                        TTLocalizer.MusicEncntrGeneralSuitWinningIndoor, 36]}, 
   8: {'DL_nbrhood.ogg': [TTLocalizer.MusicDlNbrhood, 30], 'DG_SZ.ogg': [
                   TTLocalizer.MusicDgSz, 48], 
       'DG_battle.ogg': [
                       TTLocalizer.MusicDgBattle, 30], 
       'DL_SZ.ogg': [
                   TTLocalizer.MusicDlSz, 33], 
       'DL_battle.ogg': [
                       TTLocalizer.MusicDlBattle, 38], 
       'TB_SZ.ogg': [
                   TTLocalizer.MusicTbSz, 54], 
       'TB_battle.ogg': [
                       TTLocalizer.MusicTbBattle, 36]}, 
   9: {'encntr_hall_of_fame.ogg': [TTLocalizer.MusicEncntrHallOfFame, 51], 'CHQ_FACT_bg.ogg': [
                         TTLocalizer.MusicChqFactBg, 50], 
       'encntr_suit_winning.ogg': [
                                 TTLocalizer.MusicEncntrSuitWinning, 31], 
   ...
   13: {'party_original_theme.ogg': [TTLocalizer.MusicPartyOriginalTheme, 56], 'party_polka_dance.ogg': [
        ...
        'party_generic_theme_jazzy.ogg': [
                                        TTLocalizer.MusicPartyGenericThemeJazzy, 64]}, 
   14.5: {'SP_nbrhood.ogg': [TTLocalizer.MusicPartySpNbrhood, 54], 'SP_SZ_activity.ogg': [
                               TTLocalizer.MusicPartySpActivity, 66], 
          'DB_nbrhood.ogg': [
                           TTLocalizer.MusicDuckberg, 35], 
          'LAB_activate.ogg': [
                             TTLocalizer.MusicChairmanActivation, 152], 
          'CBHQ_bar.ogg': [
                         TTLocalizer.MusicCogBar, 28], 
          'CBHQ_bathroom.ogg': [
                              TTLocalizer.MusicBathroom, 57], 
          'mpg/mpg_yolw_howtowinaworldwarsomewhere.ogg': [
                                                        TTLocalizer.MusicWorldWar, 158], 
          'mpg/mpg_yolw_itslove.ogg': [
                                     TTLocalizer.MusicItsLove, 217], 
          'mpg/mpg_yolw_iwroteyouachiptune.ogg': [
                                                TTLocalizer.MusicChiptune, 154], 
          'mpg/mpg_yolw_mayday.ogg': [
                                    TTLocalizer.MusicMayday, 105], 
          'mpg/mpg_yolw_onedayeverythingwillbeokay.ogg': [
                                                        TTLocalizer.MusicBeOkay, 134]}}
