...
_exclaim_balloon_2d = None

def setExclaimBalloon2d(exclaim_balloon_2d):
    global _exclaim_balloon_2d
    _exclaim_balloon_2d = exclaim_balloon_2d


def getExclaimBalloon2d():
    return _exclaim_balloon_2d
...
_exclaim_balloon_3d = None

def setExclaimBalloon3d(exclaim_balloon_3d):
    global _exclaim_balloon_3d
    _exclaim_balloon_3d = exclaim_balloon_3d


def getExclaimBalloon3d():
    return _exclaim_balloon_3d
