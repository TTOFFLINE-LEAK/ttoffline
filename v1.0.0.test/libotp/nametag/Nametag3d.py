...
class Nametag3d(Nametag, PandaNode):
    ...
    def updateContents(self):
        ...
        if self.isGroupManaged():
            ...
            elif self.m_chat_contents & 8:
                self.m_scale_adj = 1.25
                self.generateChat(NametagGlobals._exclaim_balloon_3d)
    ...
    def generateName(self):
        ...
        if base.classicVisuals == 2:
            v56 = Vec4(NametagGlobals.getNameFg(self.m_group.getColorCode(), v4, True))
    ...
    def adjustToCamera(self, np, sort):
        if self.m_is_3d:
            ...
            v30 = max(v122, 0.1)
            v31 = v30 * 0.02
            v121 = v31 ** 0.5 * (NametagGlobals.getGlobalNametagScale() * self.m_scale_adj) * 0.56
            if self.m_billboard_offset == 0.0:
                ...
                v177_3_1 = v125 * v127
                v42 = v126
            v205 = Mat4(v177[0][0] * v121, v177[0][1] * v121, v177[0][2] * v121, v177[0][3] * v121, v177[1][0] * v121, v177[1][1] * v121, v177[1][2] * v121, v177[1][3] * v121, v177[2][0] * v121, v177[2][1] * v121, v177[2][2] * v121, v177[2][3] * v121, v177_3_0, v177_3_1, v42, v177[3][3])
            self.m_np_top.setMat(v205)
            v51 = 0
            if self.displayAsActive():
                if not self.m_chat_contents & 6:
                    v51 = 1
