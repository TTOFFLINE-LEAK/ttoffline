...
class Nametag2d(Nametag, MarginPopup):
    ...
    def considerVisible(self):
        ...
        if NametagGlobals._onscreen_chat_forced and self.m_chat_contents & (Nametag.CSpeech | Nametag.CThought | Nametag.CExclaim):
            result = 1
    ...
    def updateContents(self):
        ...
        if not NametagGlobals._master_arrows_on:
            self.m_chat_contents = self.m_chat_contents & -2
        if self.m_visible and self.isGroupManaged():
            ...
            elif v10 & Nametag.CExclaim:
                self.generateChat(NametagGlobals._exclaim_balloon_2d)
    ...
    def generateName(self):
        ...
        if base.classicVisuals == 2:
            v84 = Vec4(NametagGlobals.getNameFg(self.m_group.getColorCode(), v4, True))
        ...
        v69 = Mat4(v17, 0, 0, 0, 0, v17, 0, 0, 0, 0, v17, 0, 0, 0, v18 * v17, 1.0)
        a3 = v69
        if v75[3] != 0.0:
            card = CardMaker('nametag')
            card.setFrame(self.m_group.m_name_frame[0] - NametagGlobals._card_pad[0], self.m_group.m_name_frame[1] + NametagGlobals._card_pad[1], v68, v67)
            card.setColor(v75)
            if NametagGlobals._nametag_card:
                card.setSourceGeometry(NametagGlobals._nametag_card.node(), NametagGlobals._nametag_card_frame)
        ...
        if NametagGlobals._arrow_model:
            ...
            if base.classicVisuals == 2:
                color = Vec4(NametagGlobals.getArrowColor(self.m_group.getColorCode(), True))
    ...
    def generateChat(self, balloon):
        ...
        v118 = Mat4(a6, 0, 0, 0, 0, a6, 0, 0, 0, 0, a6, 0, v113 * a6, 0, v51 * a6, 1.0)
